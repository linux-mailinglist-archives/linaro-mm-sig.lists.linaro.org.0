...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mPcYFlj+4GnzoAAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:20:56 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id EAD1B4108FF
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:20:55 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 09268409FF
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 15:20:55 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.10])
	by lists.linaro.org (Postfix) with ESMTPS id 8180A3F99C
	for <linaro-mm-sig@lists.linaro.org>; Wed, 19 Nov 2025 00:01:42 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=K7lTtISw;
	spf=pass (lists.linaro.org: domain of kevin.tian@intel.com designates 198.175.65.10 as permitted sender) smtp.mailfrom=kevin.tian@intel.com;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=K7lTtISwsrnEskfFbw/LwSg1Lsql3lbnEuAQsFMLaillzsNb7HRWh5yg
   ...
   A==;
X-CSE-ConnectionGUID: bcw9qHFeQnyjcCdi3AU3Aw==
X-CSE-MsgGUID: 9OfgyEccSsO08kPppCXkiA==
X-IronPort-AV: E=McAfee;i="6800,10657,11617"; a="82935802"
X-IronPort-AV: E=Sophos;i="6.19,314,1754982000";
   d="scan'208";a="82935802"
...
Message-ID-Hash: 7YMHCTEZL5VZQGAWTOYBFP3STD5ZP32X
X-Message-ID-Hash: 7YMHCTEZL5VZQGAWTOYBFP3STD5ZP32X
X-Mailman-Approved-At: Thu, 16 Apr 2026 15:00:48 +0000
CC: Leon Romanovsky <leon@kernel.org>, Bjorn Helgaas <bhelgaas@google.com>, Logan Gunthorpe <logang@deltatee.com>, Jens Axboe <axboe@kernel.dk>, Robin Murphy <robin.murphy@arm.com>, Joerg Roedel <joro@8bytes.org>, Will Deacon <will@kernel.org>, Jason Gunthorpe <jgg@ziepe.ca>, Andrew Morton <akpm@linux-foundation.org>, Jonathan Corbet <corbet@lwn.net>, Sumit Semwal <sumit.semwal@linaro.org>, =?iso-8859-1?Q?Christian_K=F6nig?= <christian.koenig@amd.com>, Kees Cook <kees@kernel.org>, "Gustavo A. R. Silva" <gustavoars@kernel.org>, Ankit Agrawal <ankita@nvidia.com>, Yishai Hadas <yishaih@nvidia.com>, Shameer Kolothum <skolothumtho@nvidia.com>, Krishnakant Jaju <kjaju@nvidia.com>, Matt Ochs <mochs@nvidia.com>, "linux-pci@vger.kernel.org" <linux-pci@vger.kernel.org>, "linux-kernel@vger.kernel.org" <linux-kernel@vger.kernel.org>, "linux-block@vger.kernel.org" <linux-block@vger.kernel.org>, "iommu@lists.linux.dev" <iommu@lists.linux.dev>, "linux-mm@kvack.org" <linux-mm@kvack.org>, "linux-doc@
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/7YMHCTEZL5VZQGAWTOYBFP3STD5ZP32X/>
...
X-Spamd-Result: default: False [2.59 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[lists.linaro.org:helo,lists.linaro.org:rdns,intel.com:email,BN9PR11MB5276.namprd11.prod.outlook.com:mid,linaro.org:email,nvidia.com:email,shazbot.org:email];
