...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CJunMq+UfWnQSgIAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Sat, 31 Jan 2026 06:35:43 +0100
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 68E1CC0D40
	for <lists+linaro-mm-sig@lfdr.de>; Sat, 31 Jan 2026 06:35:43 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 910DC401D9
	for <lists+linaro-mm-sig@lfdr.de>; Sat, 31 Jan 2026 05:35:42 +0000 (UTC)
Received: from tor.source.kernel.org (tor.source.kernel.org [172.105.4.254])
	by lists.linaro.org (Postfix) with ESMTPS id E0393401E1
	for <linaro-mm-sig@lists.linaro.org>; Sat, 31 Jan 2026 05:34:47 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=kernel.org header.s=k20201202 header.b="oJ7crLi/";
	spf=pass (lists.linaro.org: domain of leon@kernel.org designates 172.105.4.254 as permitted sender) smtp.mailfrom=leon@kernel.org;
	dmarc=pass (policy=quarantine) header.from=kernel.org
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by tor.source.kernel.org (Postfix) with ESMTP id 9F86E60134;
...
X-Spamd-Bar: ----
Message-ID-Hash: 26PVF5BL2JBDTWKQNXMWC5RJTHJ6JEAB
X-Message-ID-Hash: 26PVF5BL2JBDTWKQNXMWC5RJTHJ6JEAB
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v7 2/8] dma-buf: Rename dma_buf_move_notify() to dma_buf_invalidate_mappings()
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/26PVF5BL2JBDTWKQNXMWC5RJTHJ6JEAB/>
...
X-Spamd-Result: default: False [2.09 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[lists.linaro.org:helo,lists.linaro.org:rdns,amd.com:email,linaro.org:email,nvidia.com:mid,nvidia.com:email]
X-Rspamd-Queue-Id: 68E1CC0D40
