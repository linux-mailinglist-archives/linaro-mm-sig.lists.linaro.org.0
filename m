...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 95FD5AA89E6
	for <lists+linaro-mm-sig@lfdr.de>; Mon,  5 May 2025 00:43:57 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id ACC1845948
	for <lists+linaro-mm-sig@lfdr.de>; Sun,  4 May 2025 22:43:56 +0000 (UTC)
Received: from mail-pf1-f201.google.com (mail-pf1-f201.google.com [209.85.210.201])
	by lists.linaro.org (Postfix) with ESMTPS id E77B2460AA
	for <linaro-mm-sig@lists.linaro.org>; Sun,  4 May 2025 22:42:49 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=google.com header.s=20230601 header.b=0A7udhQg;
	dmarc=pass (policy=reject) header.from=google.com;
	spf=pass (lists.linaro.org: domain of 3aO0XaAkKDekeUXPcNTPcRZZRWP.NZXWTYLcZ-XX-dTRWTded.WTYLcZ.ZcR@flex--tjmercier.bounces.google.com designates 209.85.210.201 as permitted sender) smtp.mailfrom=3aO0XaAkKDekeUXPcNTPcRZZRWP.NZXWTYLcZ-XX-dTRWTded.WTYLcZ.ZcR@flex--tjmercier.bounces.google.com
Received: by mail-pf1-f201.google.com with SMTP id d2e1a72fcca58-736c0306242so5192188b3a.1
        for <linaro-mm-sig@lists.linaro.org>; Sun, 04 May 2025 15:42:49 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1746398569; x=1747003369; darn=lists.linaro.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=YBA2Kzgyk4bRaSZtyL60XM7M/J6C1GLiTyhJYY1riEQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=YBA2Kzgyk4bRaSZtyL60XM7M/J6C1GLiTyhJYY1riEQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXsSsaehWUmg0rMQ4ESs8je0yxHokdQDHUwJcfWcQ4AxsV5Np1JDONG9DwjP6k9excYES59oaAZ7EE5cgtg@lists.linaro.org
X-Gm-Message-State: AOJu0YwUawaU3VTOK3wSYsQw2K3HOATGm8fKypOzrXT4a2GuHFgXwqJg
	ZoHWjMLiZVaMoyrAoEBw4xJFyzfJI0xi4k3BMXo1UDatTLstBTaKo7xdPhnv7dpqNSHVjWb187u
	ZNyZxTVB3PBz7Pw==
...
X-Spamd-Result: default: False [-4.80 / 15.00];
	...
	MV_CASE(0.50)[];
	FORGED_SENDER(0.30)[tjmercier@google.com,3aO0XaAkKDekeUXPcNTPcRZZRWP.NZXWTYLcZ-XX-dTRWTded.WTYLcZ.ZcR@flex--tjmercier.bounces.google.com];
	...
	FROM_NEQ_ENVFROM(0.00)[tjmercier@google.com,3aO0XaAkKDekeUXPcNTPcRZZRWP.NZXWTYLcZ-XX-dTRWTded.WTYLcZ.ZcR@flex--tjmercier.bounces.google.com];
...
Message-ID-Hash: INLVIVMC2F7F5TZRPH5FXVMDEPSKHOKC
X-Message-ID-Hash: INLVIVMC2F7F5TZRPH5FXVMDEPSKHOKC
X-MailFrom: 3aO0XaAkKDekeUXPcNTPcRZZRWP.NZXWTYLcZ-XX-dTRWTded.WTYLcZ.ZcR@flex--tjmercier.bounces.google.com
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v2 5/6] selftests/bpf: Add test for open coded dmabuf_iter
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/INLVIVMC2F7F5TZRPH5FXVMDEPSKHOKC/>
