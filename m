...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id DD535C7AA48
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 21 Nov 2025 16:52:46 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 106DA3F9AF
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 21 Nov 2025 15:52:46 +0000 (UTC)
Received: from DM5PR21CU001.outbound.protection.outlook.com (mail-centralusazon11011059.outbound.protection.outlook.com [52.101.62.59])
	by lists.linaro.org (Postfix) with ESMTPS id 04B803F99B
	for <linaro-mm-sig@lists.linaro.org>; Fri, 21 Nov 2025 15:51:16 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=Rj7AJZqn;
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 52.101.62.59 as permitted sender) smtp.mailfrom=jgg@nvidia.com;
...
X-Spamd-Result: default: False [-3.50 / 15.00];
	...
	RWL_MAILSPIKE_POSSIBLE(0.00)[52.101.62.59:from];
	FROM_EQ_ENVFROM(0.00)[];
	NEURAL_HAM(-0.00)[-1.000];
	DNSWL_BLOCKED(0.00)[52.101.62.59:from,2603:10b6:208:c1::17:received];
	RCVD_COUNT_TWO(0.00)[2];
	RCVD_TLS_LAST(0.00)[];
	TO_DN_SOME(0.00)[];
	URIBL_BLOCKED(0.00)[mail-centralusazon11011059.outbound.protection.outlook.com:rdns,nvidia.com:from_mime,nvidia.com:mid,nvidia.com:from_smtp,nvidia.com:email,alibaba.com:email,intel.com:email,DM5PR21CU001.outbound.protection.outlook.com:helo,Nvidia.com:dkim];
	DKIM_TRACE(0.00)[Nvidia.com:+]
X-Rspamd-Server: lists.linaro.org
X-Rspamd-Queue-Id: 04B803F99B
X-Spamd-Bar: ---
Message-ID-Hash: 3ADL57FA2P6ZTB46WJXY5UXHQDM2SDYD
X-Message-ID-Hash: 3ADL57FA2P6ZTB46WJXY5UXHQDM2SDYD
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v2 7/9] iommufd: Have iopt_map_file_pages convert the fd to a file
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/3ADL57FA2P6ZTB46WJXY5UXHQDM2SDYD/>
