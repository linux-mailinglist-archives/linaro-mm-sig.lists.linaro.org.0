...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 5023177606D
	for <lists+linaro-mm-sig@lfdr.de>; Wed,  9 Aug 2023 15:17:47 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 42C5E43F1F
	for <lists+linaro-mm-sig@lfdr.de>; Wed,  9 Aug 2023 13:17:46 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.24])
	by lists.linaro.org (Postfix) with ESMTPS id 38B203EF0D
	for <linaro-mm-sig@lists.linaro.org>; Wed,  9 Aug 2023 13:17:40 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=LhEZtqMz;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=LhEZtqMzhIQPzEe3MHI+alsztIzGFfGIyr8oEsX7apSCq656SF8gqtVC
   ...
   PMH7m4I1rLljby57Dv301c+0xCFPAMrD5TgvLotlG3/8FANOpvWbvi3CD
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10795"; a="373899909"
X-IronPort-AV: E=Sophos;i="6.01,159,1684825200";
   d="scan'208";a="373899909"
...
X-Rspamd-Queue-Id: 38B203EF0D
X-Spamd-Bar: --------------
X-Spamd-Result: default: False [-14.30 / 15.00];
	REPLY(-4.00)[];
	...
	RCVD_IN_DNSWL_MED(-0.20)[134.134.136.24:from];
	...
	RCVD_TLS_LAST(0.00)[];
	FREEMAIL_CC(0.00)[lists.linux.dev,kernel.org,suse.de,gmail.com,ffwll.ch,linaro.org,amd.com,lists.freedesktop.org,vger.kernel.org,lists.linaro.org,linux.alibaba.com];
	...
	ARC_NA(0.00)[]
Message-ID-Hash: M3FZJM5FIPYLHAJFRQ3HW2FQ2U3YFSXD
X-Message-ID-Hash: M3FZJM5FIPYLHAJFRQ3HW2FQ2U3YFSXD
X-MailFrom: lkp@intel.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
CC: llvm@lists.linux.dev, oe-kbuild-all@lists.linux.dev, mripard@kernel.org, tzimmermann@suse.de, daniel@ffwll.ch, sumit.semwal@linaro.org, christian.koenig@amd.com, dri-devel@lists.freedesktop.org, linux-kernel@vger.kernel.org, linux-media@vger.kernel.org, linaro-mm-sig@lists.linaro.org, Jiapeng Chong <jiapeng.chong@linux.alibaba.com>, Abaci Robot <abaci@linux.alibaba.com>
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH] drm: manager: Remove the unused variable prev
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/M3FZJM5FIPYLHAJFRQ3HW2FQ2U3YFSXD/>
