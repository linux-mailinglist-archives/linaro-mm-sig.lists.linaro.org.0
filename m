...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B076C7AA20
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 21 Nov 2025 16:52:00 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 686B23F99F
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 21 Nov 2025 15:51:59 +0000 (UTC)
Received: from DM5PR21CU001.outbound.protection.outlook.com (mail-centralusazon11011016.outbound.protection.outlook.com [52.101.62.16])
	by lists.linaro.org (Postfix) with ESMTPS id 9A2BD3F962
	for <linaro-mm-sig@lists.linaro.org>; Fri, 21 Nov 2025 15:51:14 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=kcqJE2a5;
...
X-Spamd-Result: default: False [-3.50 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	TO_DN_SOME(0.00)[];
	URIBL_BLOCKED(0.00)[nvidia.com:from_mime,nvidia.com:mid,nvidia.com:from_smtp,nvidia.com:email,alibaba.com:email,intel.com:email,DM5PR21CU001.outbound.protection.outlook.com:helo,Nvidia.com:dkim];
	DKIM_TRACE(0.00)[Nvidia.com:+]
X-Rspamd-Server: lists.linaro.org
X-Rspamd-Queue-Id: 9A2BD3F962
X-Spamd-Bar: ---
Message-ID-Hash: FWLDVA6VFWAUGIGS45HYGASQFVUB6PUN
X-Message-ID-Hash: FWLDVA6VFWAUGIGS45HYGASQFVUB6PUN
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v2 5/9] iommufd: Allow MMIO pages in a batch
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/FWLDVA6VFWAUGIGS45HYGASQFVUB6PUN/>
