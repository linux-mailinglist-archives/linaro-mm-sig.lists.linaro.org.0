...
Received: from lists.linaro.org (lists.linaro.org [107.22.173.205])
	by mail.lfdr.de (Postfix) with ESMTPS id B275B399D24
	for <lists+linaro-mm-sig@lfdr.de>; Thu,  3 Jun 2021 10:51:58 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id DC47060561
	for <lists+linaro-mm-sig@lfdr.de>; Thu,  3 Jun 2021 08:51:55 +0000 (UTC)
Received: by lists.linaro.org (Postfix, from userid 109)
	id 617D560C34; Thu,  3 Jun 2021 08:51:53 +0000 (UTC)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id B7CFF609C0;
	Thu,  3 Jun 2021 08:51:50 +0000 (UTC)
X-Original-To: linaro-mm-sig@lists.linaro.org
Delivered-To: linaro-mm-sig@lists.linaro.org
Received: from lists.linaro.org (localhost [127.0.0.1])
 by lists.linaro.org (Postfix) with ESMTP id 5D7E26051A
 for <linaro-mm-sig@lists.linaro.org>; Thu,  3 Jun 2021 08:51:49 +0000 (UTC)
Received: by lists.linaro.org (Postfix, from userid 109)
 id 4F9EF609C0; Thu,  3 Jun 2021 08:51:49 +0000 (UTC)
Received: from mail-ej1-f41.google.com (mail-ej1-f41.google.com
 [209.85.218.41])
 by lists.linaro.org (Postfix) with ESMTPS id 3B6B96051A
 for <linaro-mm-sig@lists.linaro.org>; Thu,  3 Jun 2021 08:51:47 +0000 (UTC)
Received: by mail-ej1-f41.google.com with SMTP id b9so8014585ejc.13
 for <linaro-mm-sig@lists.linaro.org>; Thu, 03 Jun 2021 01:51:47 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 b=
X-Gm-Message-State: AOAM5320NnOuEe/Aw6PNM/2FmG3I+IT86olfHv6KqC8LFAw1zRZYKA2b
 kHflisUGH3wAhXObXrZwbYPvkg==
...
> +procfs and sysfs can be used to gather DMA-BUF statistics on production =
systems.
> +
> +The ``/proc/<pid>/fdinfo/<fd>`` files in procfs can be used to gather in=
formation
> +about DMA-BUF fds. Detailed documentation about the interface is present=
 in
> +Documentation/filesystems/proc.rst.
> +Unfortunately, the existing procfs interfaces can only provide informati=
on about
> +the DMA-BUFs for which processes hold fds or have the buffers mmapped in=
to their
> +address space. This necessitated the creation of the DMA-BUF sysfs stati=
stics
> +interface to provide per-buffer information on production systems.
> +
> +The interface at ``/sys/kernel/dma-buf/buffers`` exposes information abo=
ut
...
> +* ``/sys/kernel/dmabuf/buffers/<inode_number>/exporter_name``
> +* ``/sys/kernel/dmabuf/buffers/<inode_number>/size``
> +* ``/sys/kernel/dmabuf/buffers/<inode_number>/attachments/<attach_uid>/d=
evice``
> +* ``/sys/kernel/dmabuf/buffers/<inode_number>/attachments/<attach_uid>/m=
ap_counter``
> +
...
> +DMA-BUF usage. It can also be collected periodically by telemetry to mon=
itor
> +various metrics.
> +
