...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id OEMhE8EM4WnoogAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 18:22:25 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id D6D51411A4B
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 18:22:24 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id EB4E1409FF
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 16:22:23 +0000 (UTC)
Received: from SJ2PR03CU001.outbound.protection.outlook.com (mail-westusazon11012031.outbound.protection.outlook.com [52.101.43.31])
	by lists.linaro.org (Postfix) with ESMTPS id 34DBB4015F
	for <linaro-mm-sig@lists.linaro.org>; Wed, 21 Jan 2026 21:42:49 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=hIjZlAoY;
	spf=pass (lists.linaro.org: domain of edwards@nvidia.com designates 52.101.43.31 as permitted sender) smtp.mailfrom=edwards@nvidia.com;
...
Message-ID-Hash: HYDATCJGMEGRZPMJ4M2ST4QAG2E52CBO
X-Message-ID-Hash: HYDATCJGMEGRZPMJ4M2ST4QAG2E52CBO
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH rdma-next v2 0/3] RDMA: Add support for exporting dma-buf file descriptors
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/HYDATCJGMEGRZPMJ4M2ST4QAG2E52CBO/>
