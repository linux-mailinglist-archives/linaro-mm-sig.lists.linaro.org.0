...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AAFC7EAE83
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 14 Nov 2023 12:00:10 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 856144111A
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 14 Nov 2023 11:00:09 +0000 (UTC)
Received: from mail-yw1-f171.google.com (mail-yw1-f171.google.com [209.85.128.171])
	by lists.linaro.org (Postfix) with ESMTPS id CFB193F0D8
	for <linaro-mm-sig@lists.linaro.org>; Tue, 14 Nov 2023 10:59:51 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=linaro.org header.s=google header.b=PhV70ak2;
	dmarc=pass (policy=none) header.from=linaro.org;
	spf=pass (lists.linaro.org: domain of dmitry.baryshkov@linaro.org designates 209.85.128.171 as permitted sender) smtp.mailfrom=dmitry.baryshkov@linaro.org
Received: by mail-yw1-f171.google.com with SMTP id 00721157ae682-5bf58914bacso60669507b3.3
        for <linaro-mm-sig@lists.linaro.org>; Tue, 14 Nov 2023 02:59:51 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1699959591; x=1700564391; darn=lists.linaro.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=7I21wC1iNMQnEDTKIYSmEkIpp8xcXXLDRh/lfLrGnLo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=7I21wC1iNMQnEDTKIYSmEkIpp8xcXXLDRh/lfLrGnLo=;
        b=
X-Gm-Message-State: AOJu0YyPaqIGnOldqOxXMPWmSi45R87AFnOcbsGlJJn+KsBR6pkruruZ
	X7bi1e9X2r96n7Jbb3Fy7yTkewuFPPugBYeLhf1f5HWW
...
X-Spamd-Result: default: False [-6.50 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	ARC_NA(0.00)[];
	DNSWL_BLOCKED(0.00)[209.85.128.171:from];
...
Message-ID-Hash: SL5HTKQCOFF7VK46CPGY2RB6BXHUUYVG
X-Message-ID-Hash: SL5HTKQCOFF7VK46CPGY2RB6BXHUUYVG
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/SL5HTKQCOFF7VK46CPGY2RB6BXHUUYVG/>
