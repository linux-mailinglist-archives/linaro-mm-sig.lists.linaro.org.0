...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id A7DD890C5BA
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 18 Jun 2024 12:03:31 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id B6DB4447A5
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 18 Jun 2024 10:03:30 +0000 (UTC)
Received: from aposti.net (aposti.net [89.234.176.197])
	by lists.linaro.org (Postfix) with ESMTPS id C51EB447AE
	for <linaro-mm-sig@lists.linaro.org>; Tue, 18 Jun 2024 10:03:16 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=crapouillou.net header.s=mail header.b=JN3FcudL;
...
Message-ID-Hash: XHW6IHIOTUFTSLO4XEYW4JTMNL3PPRYA
X-Message-ID-Hash: XHW6IHIOTUFTSLO4XEYW4JTMNL3PPRYA
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v11 1/7] dmaengine: Add API function dmaengine_prep_peripheral_dma_vec()
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/XHW6IHIOTUFTSLO4XEYW4JTMNL3PPRYA/>
