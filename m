...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E3AB60C34A
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 25 Oct 2022 07:33:28 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 22CE83F8DC
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 25 Oct 2022 05:33:27 +0000 (UTC)
Received: from NAM02-DM3-obe.outbound.protection.outlook.com (mail-dm3nam02on2050.outbound.protection.outlook.com [40.107.95.50])
	by lists.linaro.org (Postfix) with ESMTPS id 7884C3EBFD
	for <linaro-mm-sig@lists.linaro.org>; Tue, 27 Sep 2022 17:24:47 +0000 (UTC)
...
X-Spamd-Result: default: False [-3.50 / 15.00];
	...
	TO_DN_SOME(0.00)[];
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.95.50:from]
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=UCqZvusC;
	spf=pass (lists.linaro.org: domain of Arvind.Yadav@amd.com designates 40.107.95.50 as permitted sender) smtp.mailfrom=Arvind.Yadav@amd.com;
	arc=pass ("microsoft.com:s=arcselector9901:i=1");
	dmarc=pass (policy=quarantine) header.from=amd.com
X-MailFrom: Arvind.Yadav@amd.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
Message-ID-Hash: OR32ZIXVBZCCC5D3C4XSOPIMVGBO2Y2S
X-Message-ID-Hash: OR32ZIXVBZCCC5D3C4XSOPIMVGBO2Y2S
X-Mailman-Approved-At: Tue, 25 Oct 2022 05:31:24 +0000
CC: Arvind Yadav <Arvind.Yadav@amd.com>
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] [PATCH 1/3] dma-buf: Remove the signaled bit status check
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/OR32ZIXVBZCCC5D3C4XSOPIMVGBO2Y2S/>
