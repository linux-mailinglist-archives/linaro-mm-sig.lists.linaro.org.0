...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B67779A8CF
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 11 Sep 2023 16:43:54 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 874423F52D
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 11 Sep 2023 14:43:53 +0000 (UTC)
Received: from mail-yw1-f201.google.com (mail-yw1-f201.google.com [209.85.128.201])
	by lists.linaro.org (Postfix) with ESMTPS id 146603EBCF
	for <linaro-mm-sig@lists.linaro.org>; Mon, 10 Jul 2023 22:34:16 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=google.com header.s=20221208 header.b=Xc1Br1GD;
	spf=pass (lists.linaro.org: domain of 3Z4esZAsKDVQw78wEDK849w2AA270.yA8749wDA-88-E4274EFE.749wDA.AD2@flex--almasrymina.bounces.google.com designates 209.85.128.201 as permitted sender) smtp.mailfrom=3Z4esZAsKDVQw78wEDK849w2AA270.yA8749wDA-88-E4274EFE.749wDA.AD2@flex--almasrymina.bounces.google.com;
	dmarc=pass (policy=reject) header.from=google.com
Received: by mail-yw1-f201.google.com with SMTP id 00721157ae682-57320c10635so57589797b3.3
        for <linaro-mm-sig@lists.linaro.org>; Mon, 10 Jul 2023 15:34:16 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=oKO6sogguZyjcmLGJ/hPDJOveqN84Swf5N5/pg86eqs=;
        b=
X-Gm-Message-State: ABy/qLYGNUJugS9X7ea3lC2fr45d5dc+dMRm94+duUUYEOJLEvO8ggPV
	W92ubHqz+jCnT5rmEVA69zYLcZT8jojUaZuDeQ==
...
X-Spamd-Result: default: False [-0.70 / 15.00];
	...
	FORGED_SENDER(0.30)[almasrymina@google.com,3Z4esZAsKDVQw78wEDK849w2AA270.yA8749wDA-88-E4274EFE.749wDA.AD2@flex--almasrymina.bounces.google.com];
	...
	FROM_HAS_DN(0.00)[];
	FROM_NEQ_ENVFROM(0.00)[almasrymina@google.com,3Z4esZAsKDVQw78wEDK849w2AA270.yA8749wDA-88-E4274EFE.749wDA.AD2@flex--almasrymina.bounces.google.com];
...
X-Rspamd-Queue-Id: 146603EBCF
X-Spamd-Bar: /
X-MailFrom: 3Z4esZAsKDVQw78wEDK849w2AA270.yA8749wDA-88-E4274EFE.749wDA.AD2@flex--almasrymina.bounces.google.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
Message-ID-Hash: UJUK7TP6V6OTURDSTWXJJ76WNTRWVDI3
X-Message-ID-Hash: UJUK7TP6V6OTURDSTWXJJ76WNTRWVDI3
...
Precedence: list
Subject: [Linaro-mm-sig] [RFC PATCH 08/10] selftests: add ncdevmem, netcat for devmem TCP
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/UJUK7TP6V6OTURDSTWXJJ76WNTRWVDI3/>
