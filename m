...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id BDF60C4CD3C
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 11 Nov 2025 10:59:32 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id E82523F77E
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 11 Nov 2025 09:59:31 +0000 (UTC)
Received: from sea.source.kernel.org (sea.source.kernel.org [172.234.252.31])
	by lists.linaro.org (Postfix) with ESMTPS id 583913F77E
	for <linaro-mm-sig@lists.linaro.org>; Tue, 11 Nov 2025 09:58:25 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=kernel.org header.s=k20201202 header.b=GNYvuyw8;
	dmarc=pass (policy=quarantine) header.from=kernel.org;
	spf=pass (lists.linaro.org: domain of leon@kernel.org designates 172.234.252.31 as permitted sender) smtp.mailfrom=leon@kernel.org
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by sea.source.kernel.org (Postfix) with ESMTP id CFB9F40846;
...
X-Spamd-Result: default: False [-4.00 / 15.00];
	...
	URIBL_BLOCKED(0.00)[fb.com:email,nvidia.com:email,nvidia.com:mid,sea.source.kernel.org:rdns,sea.source.kernel.org:helo];
	TO_DN_SOME(0.00)[];
	RCVD_COUNT_TWO(0.00)[2];
	DKIM_TRACE(0.00)[kernel.org:+]
X-Rspamd-Action: no action
Message-ID-Hash: SRQSSOLRDNKDLXEDXWGCHP4XFUW3BPRF
X-Message-ID-Hash: SRQSSOLRDNKDLXEDXWGCHP4XFUW3BPRF
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v8 07/11] vfio: Export vfio device get and put registration helpers
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/SRQSSOLRDNKDLXEDXWGCHP4XFUW3BPRF/>
