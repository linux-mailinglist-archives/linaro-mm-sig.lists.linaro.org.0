...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C0705FE92F
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 14 Oct 2022 09:03:52 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 072423F5A2
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 14 Oct 2022 07:03:51 +0000 (UTC)
Received: from NAM12-DM6-obe.outbound.protection.outlook.com (mail-dm6nam12on2082.outbound.protection.outlook.com [40.107.243.82])
	by lists.linaro.org (Postfix) with ESMTPS id 41F743F067
	for <linaro-mm-sig@lists.linaro.org>; Fri, 14 Oct 2022 07:03:32 +0000 (UTC)
...
X-MS-Exchange-AntiSpam-MessageData-0: 
	=?utf-8?B?NUM1UUQxZElBM1lEZk9PeGIrY2Y0akQ4N0xoOEJjODdXYkU0aUV6Y0hJUFZE?=
...
X-Spamd-Bar: -----------
X-Rspamd-Queue-Id: 41F743F067
X-Spamd-Result: default: False [-11.00 / 15.00];
	REPLY(-4.00)[];
	BAYES_HAM(-3.00)[100.00%];
	ARC_ALLOW(-1.00)[microsoft.com:s=arcselector9901:i=1];
	RCVD_IN_DNSWL_HI(-1.00)[40.107.243.82:from,2603:10b6:408:43::13:received];
	...
	MIME_TRACE(0.00)[0:+];
	FREEMAIL_TO(0.00)[gmail.com,amd.com,ffwll.ch,kernel.org,linaro.org,suse.com,roeck-us.net,chromium.org,lists.freedesktop.org,vger.kernel.org,lists.linaro.org];
	RCVD_TLS_LAST(0.00)[];
	NEURAL_HAM(-0.00)[-0.990];
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.243.82:from];
	TO_DN_SOME(0.00)[];
...
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=JoHifG1J;
	spf=pass (lists.linaro.org: domain of Christian.Koenig@amd.com designates 40.107.243.82 as permitted sender) smtp.mailfrom=Christian.Koenig@amd.com;
	arc=pass ("microsoft.com:s=arcselector9901:i=1");
	dmarc=pass (policy=quarantine) header.from=amd.com
Message-ID-Hash: A7A7OCDBLSVF5AUZD6VC5XXUCIPQM4YX
X-Message-ID-Hash: A7A7OCDBLSVF5AUZD6VC5XXUCIPQM4YX
X-MailFrom: Christian.Koenig@amd.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
CC: "Venkataramanan, Anirudh" <anirudh.venkataramanan@intel.com>, Ira Weiny <ira.weiny@intel.com>
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH] drm/radeon: Replace kmap() with kmap_local_page()
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/A7A7OCDBLSVF5AUZD6VC5XXUCIPQM4YX/>
...

