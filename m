...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id A8FC47D692D
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 25 Oct 2023 12:42:30 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id B8A1140BB1
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 25 Oct 2023 10:42:29 +0000 (UTC)
Received: from ex01.ufhost.com (ex01.ufhost.com [61.152.239.75])
	by lists.linaro.org (Postfix) with ESMTP id 60FF240BB3
...
X-Spamd-Result: default: False [-0.20 / 15.00];
	...
	URIBL_BLOCKED(0.00)[ex01.ufhost.com:rdns,ex01.ufhost.com:helo,display.id:url];
...
Message-ID-Hash: DXORIBB74V7J5TQW3OHT6OVIDVCFI6T3
X-Message-ID-Hash: DXORIBB74V7J5TQW3OHT6OVIDVCFI6T3
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v2 5/6] drm/vs: Add KMS crtc&plane
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/DXORIBB74V7J5TQW3OHT6OVIDVCFI6T3/>
