...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 6939DAB3197
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 12 May 2025 10:27:52 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 84B8B450AE
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 12 May 2025 08:27:51 +0000 (UTC)
Received: from NAM12-BN8-obe.outbound.protection.outlook.com (mail-bn8nam12on2069.outbound.protection.outlook.com [40.107.237.69])
	by lists.linaro.org (Postfix) with ESMTPS id 698EE43C33
	for <linaro-mm-sig@lists.linaro.org>; Mon, 12 May 2025 08:27:38 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=RjtJuVIK;
	dmarc=pass (policy=quarantine) header.from=amd.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of Christian.Koenig@amd.com designates 40.107.237.69 as permitted sender) smtp.mailfrom=Christian.Koenig@amd.com
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	TO_DN_SOME(0.00)[];
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.237.69:from];
	DWL_DNSWL_BLOCKED(0.00)[amd.com:dkim];
	MID_RHS_MATCH_FROM(0.00)[];
	FROM_EQ_ENVFROM(0.00)[];
	FROM_HAS_DN(0.00)[];
	RCVD_IN_DNSWL_NONE(0.00)[40.107.237.69:from];
...
Message-ID-Hash: Z442SMA3CNPQPXV3423I3R5OEZRGFUPS
X-Message-ID-Hash: Z442SMA3CNPQPXV3423I3R5OEZRGFUPS
...
Precedence: list
Subject: [Linaro-mm-sig] Re: [RFC v2 08/13] drm/amdgpu: Use dma-fence driver and timeline name helpers
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/Z442SMA3CNPQPXV3423I3R5OEZRGFUPS/>
