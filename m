...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id B7D478FC9CC
	for <lists+linaro-mm-sig@lfdr.de>; Wed,  5 Jun 2024 13:10:00 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id CBF2044625
	for <lists+linaro-mm-sig@lfdr.de>; Wed,  5 Jun 2024 11:09:59 +0000 (UTC)
Received: from aposti.net (aposti.net [89.234.176.197])
	by lists.linaro.org (Postfix) with ESMTPS id 49CCA453B9
	for <linaro-mm-sig@lists.linaro.org>; Wed,  5 Jun 2024 11:09:12 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=crapouillou.net header.s=mail header.b=Tj8ZZwCv;
...
Message-ID-Hash: FSEQ3LP5SPHGYC5GJPIOA4VUNJKOKWNG
X-Message-ID-Hash: FSEQ3LP5SPHGYC5GJPIOA4VUNJKOKWNG
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v10 2/6] dmaengine: dma-axi-dmac: Implement device_prep_peripheral_dma_vec
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/FSEQ3LP5SPHGYC5GJPIOA4VUNJKOKWNG/>
