...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 861F3A9F3BF
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 28 Apr 2025 16:46:18 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 9583C3F66E
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 28 Apr 2025 14:46:17 +0000 (UTC)
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (mail-mw2nam12on2072.outbound.protection.outlook.com [40.107.244.72])
	by lists.linaro.org (Postfix) with ESMTPS id 6A5543F66E
	for <linaro-mm-sig@lists.linaro.org>; Mon, 28 Apr 2025 14:46:04 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=Gs5Y1npP;
	dmarc=pass (policy=quarantine) header.from=amd.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of Christian.Koenig@amd.com designates 40.107.244.72 as permitted sender) smtp.mailfrom=Christian.Koenig@amd.com
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	FROM_HAS_DN(0.00)[];
	RBL_SENDERSCORE_REPUT_BLOCKED(0.00)[40.107.244.72:from];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	DNSWL_BLOCKED(0.00)[2603:10b6:510:13c::22:received,40.107.244.72:from];
	NEURAL_HAM(-0.00)[-1.000];
	DKIM_TRACE(0.00)[amd.com:+]
X-Rspamd-Action: no action
Message-ID-Hash: ROUUTEBCFRT3KVGUZZD3KDD6NCLISGBS
X-Message-ID-Hash: ROUUTEBCFRT3KVGUZZD3KDD6NCLISGBS
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/ROUUTEBCFRT3KVGUZZD3KDD6NCLISGBS/>
