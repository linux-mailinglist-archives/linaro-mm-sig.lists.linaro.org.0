...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 47363BE8899
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 17 Oct 2025 14:16:21 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 5ED5F4431C
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 17 Oct 2025 12:16:20 +0000 (UTC)
Received: from CO1PR03CU002.outbound.protection.outlook.com (mail-westus2azon11010026.outbound.protection.outlook.com [52.101.46.26])
	by lists.linaro.org (Postfix) with ESMTPS id D8C804575C
	for <linaro-mm-sig@lists.linaro.org>; Fri, 17 Oct 2025 12:16:16 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=Pzfc7b8J;
	dmarc=pass (policy=reject) header.from=nvidia.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 52.101.46.26 as permitted sender) smtp.mailfrom=jgg@nvidia.com
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	RWL_MAILSPIKE_POSSIBLE(0.00)[52.101.46.26:from];
	...
	DNSWL_BLOCKED(0.00)[2603:10b6:208:c1::17:received,52.101.46.26:from];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	DKIM_TRACE(0.00)[Nvidia.com:+]
X-Rspamd-Action: no action
X-Rspamd-Server: lists.linaro.org
Message-ID-Hash: CIFV73IXNIDE3ODB66P7GQPOHH3SR2PX
X-Message-ID-Hash: CIFV73IXNIDE3ODB66P7GQPOHH3SR2PX
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/CIFV73IXNIDE3ODB66P7GQPOHH3SR2PX/>
