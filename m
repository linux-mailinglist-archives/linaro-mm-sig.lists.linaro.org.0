...
Received: from lists.linaro.org (lists.linaro.org [107.22.173.205])
	by mail.lfdr.de (Postfix) with ESMTPS id 30FDC40AF0F
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 14 Sep 2021 15:39:08 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 5DB29629CD
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 14 Sep 2021 13:39:06 +0000 (UTC)
Received: by lists.linaro.org (Postfix, from userid 109)
	id 552D3619C1; Tue, 14 Sep 2021 13:39:05 +0000 (UTC)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 819416100C;
	Tue, 14 Sep 2021 13:39:02 +0000 (UTC)
X-Original-To: linaro-mm-sig@lists.linaro.org
Delivered-To: linaro-mm-sig@lists.linaro.org
Received: from lists.linaro.org (localhost [127.0.0.1])
 by lists.linaro.org (Postfix) with ESMTP id 3C1BF60628
 for <linaro-mm-sig@lists.linaro.org>; Tue, 14 Sep 2021 13:39:00 +0000 (UTC)
Received: by lists.linaro.org (Postfix, from userid 109)
 id 0F1166100C; Tue, 14 Sep 2021 13:39:00 +0000 (UTC)
Received: from mail-wm1-f48.google.com (mail-wm1-f48.google.com
 [209.85.128.48])
 by lists.linaro.org (Postfix) with ESMTPS id F208260628
 for <linaro-mm-sig@lists.linaro.org>; Tue, 14 Sep 2021 13:38:57 +0000 (UTC)
Received: by mail-wm1-f48.google.com with SMTP id 140so5886681wma.0
 for <linaro-mm-sig@lists.linaro.org>; Tue, 14 Sep 2021 06:38:57 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 b=
X-Gm-Message-State: AOAM532f1o4e6ATAT3h6mvpQeerKshfgjDTQiEx8SakNj0HRXkaUCRBk
 lMGvSu3Ue0YpaQKPOtrTV15DJg==
...
On Thu, Sep 09, 2021 at 08:22:59AM +0200, Christian K=F6nig wrote:
...
> > > @@ -152,6 +177,15 @@ struct drm_sched_fence *to_drm_sched_fence(struc=
t dma_fence *f)
> > >   }
...
> > lockless here. Having a spinlock just to set the parent is a bit annoyi=
ng
> =

> Well previously we didn't needed the spinlock to set the parent because t=
he
...
> > > +}
> > > +
> > >   struct drm_sched_fence *drm_sched_fence_alloc(struct drm_sched_enti=
ty *entity,
> > >   					      void *owner)
> > >   {
...
> > > @@ -505,6 +511,8 @@ void drm_sched_entity_set_priority(struct drm_sch=
ed_entity *entity,
