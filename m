...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 41C89675F9E
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 20 Jan 2023 22:25:47 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 0EB3B3ECBD
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 20 Jan 2023 21:25:46 +0000 (UTC)
Received: from mail-pj1-f50.google.com (mail-pj1-f50.google.com [209.85.216.50])
	by lists.linaro.org (Postfix) with ESMTPS id 348603E823
	for <linaro-mm-sig@lists.linaro.org>; Fri, 20 Jan 2023 21:25:42 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=google.com header.s=20210112 header.b=ZNqm4HSb;
	spf=pass (lists.linaro.org: domain of cmllamas@google.com designates 209.85.216.50 as permitted sender) smtp.mailfrom=cmllamas@google.com;
	dmarc=pass (policy=reject) header.from=google.com
Received: by mail-pj1-f50.google.com with SMTP id k10-20020a17090a590a00b0022ba875a1a4so3263113pji.3
        for <linaro-mm-sig@lists.linaro.org>; Fri, 20 Jan 2023 13:25:42 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=lx7Bv+SVM/w6kHv4tQh6+Mruz9/kiECXW3eC6e0xGg0=;
        b=
X-Gm-Message-State: AFqh2krftNaCk5gs1ukui8sWYPN/8wdc67vDbH+YLUa460jnZjSPcsUg
	FLaHaauKweVcXudYrX678hHWtg==
...
X-Spamd-Result: default: False [-9.10 / 15.00];
	...
	RCVD_IN_DNSWL_HI(-0.50)[35.185.214.157:received];
...
X-Rspamd-Queue-Id: 348603E823
X-Spamd-Bar: ---------
Message-ID-Hash: GWZORFELEFDV6AGAQBSTYQSDZRDVYSIX
X-Message-ID-Hash: GWZORFELEFDV6AGAQBSTYQSDZRDVYSIX
X-MailFrom: cmllamas@google.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
CC: Tejun Heo <tj@kernel.org>, Zefan Li <lizefan.x@bytedance.com>, Johannes Weiner <hannes@cmpxchg.org>, Jonathan Corbet <corbet@lwn.net>, Greg Kroah-Hartman <gregkh@linuxfoundation.org>, Arve =?iso-8859-1?B?SGr4bm5lduVn?= <arve@android.com>, Todd Kjos <tkjos@android.com>, Martijn Coenen <maco@android.com>, Joel Fernandes <joel@joelfernandes.org>, Christian Brauner <brauner@kernel.org>, Suren Baghdasaryan <surenb@google.com>, Sumit Semwal <sumit.semwal@linaro.org>, Christian =?iso-8859-1?Q?K=F6nig?= <christian.koenig@amd.com>, android-mm@google.com, jstultz@google.com, Hridya Valsaraju <hridya@google.com>, cgroups@vger.kernel.org, linux-doc@vger.kernel.org, linux-kernel@vger.kernel.org, linux-media@vger.kernel.org, dri-devel@lists.freedesktop.org, linaro-mm-sig@lists.linaro.org
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH 3/4] binder: Add flags to relinquish ownership of fds
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/GWZORFELEFDV6AGAQBSTYQSDZRDVYSIX/>
