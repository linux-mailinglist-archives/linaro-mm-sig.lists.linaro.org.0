...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 87D26AB6CCA
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 14 May 2025 15:33:35 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 8087C454F3
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 14 May 2025 13:33:34 +0000 (UTC)
Received: from NAM04-BN8-obe.outbound.protection.outlook.com (mail-bn8nam04on2069.outbound.protection.outlook.com [40.107.100.69])
	by lists.linaro.org (Postfix) with ESMTPS id 521BA42B42
	for <linaro-mm-sig@lists.linaro.org>; Wed, 14 May 2025 13:33:19 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=GBB5ONMz;
	dmarc=pass (policy=quarantine) header.from=amd.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of Christian.Koenig@amd.com designates 40.107.100.69 as permitted sender) smtp.mailfrom=Christian.Koenig@amd.com
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.100.69:from];
	RCVD_IN_DNSWL_NONE(0.00)[40.107.100.69:from];
	TO_DN_SOME(0.00)[];
...
Message-ID-Hash: PFVHOKPU6SJDYJC2IZQSTGWN6O7OJTCE
X-Message-ID-Hash: PFVHOKPU6SJDYJC2IZQSTGWN6O7OJTCE
...
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH] dma-buf: insert memory barrier before updating num_fences
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/PFVHOKPU6SJDYJC2IZQSTGWN6O7OJTCE/>
