...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id EBDE07EC809
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 15 Nov 2023 17:00:45 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id BBF4441205
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 15 Nov 2023 16:00:44 +0000 (UTC)
Received: from mail-yb1-f182.google.com (mail-yb1-f182.google.com [209.85.219.182])
	by lists.linaro.org (Postfix) with ESMTPS id D906B40D46
	for <linaro-mm-sig@lists.linaro.org>; Wed, 15 Nov 2023 16:00:25 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=linaro.org header.s=google header.b=HG61K6Bb;
	dmarc=pass (policy=none) header.from=linaro.org;
	spf=pass (lists.linaro.org: domain of dmitry.baryshkov@linaro.org designates 209.85.219.182 as permitted sender) smtp.mailfrom=dmitry.baryshkov@linaro.org
Received: by mail-yb1-f182.google.com with SMTP id 3f1490d57ef6-d852b28ec3bso7518425276.2
        for <linaro-mm-sig@lists.linaro.org>; Wed, 15 Nov 2023 08:00:25 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1700064025; x=1700668825; darn=lists.linaro.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=2saDbyHxjODfWF9JCHAE6d3IjsRBAEN9a6Xrszmv96o=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=2saDbyHxjODfWF9JCHAE6d3IjsRBAEN9a6Xrszmv96o=;
        b=
X-Gm-Message-State: AOJu0YzVdy/tuhqIq8Rp5SZ81NKS4/B45LKOCIkcjh2tfulCkf4wCKDi
	HVFrI/RqmDwXHk3090UJiTK4MIqH7ExQfniFmkxL6lUS
...
X-Spamd-Result: default: False [-6.50 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	FROM_HAS_DN(0.00)[];
	FREEMAIL_CC(0.00)[esmil.dk,lists.freedesktop.org,linaro.org,lists.infradead.org,starfivetech.com,vger.kernel.org,kernel.org,eecs.berkeley.edu,edgeble.ai,lists.linaro.org,hotmail.com,sifive.com,amd.com,dabbelt.com,suse.de];
	TO_DN_SOME(0.00)[];
...
Message-ID-Hash: 4ZGEGBQKGSCZ4VPC3WPEJO5FOMCVMU35
X-Message-ID-Hash: 4ZGEGBQKGSCZ4VPC3WPEJO5FOMCVMU35
X-MailFrom: dmitry.baryshkov@linaro.org
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
CC: Emil Renner Berthing <kernel@esmil.dk>, "dri-devel@lists.freedesktop.org" <dri-devel@lists.freedesktop.org>, Krzysztof Kozlowski <krzysztof.kozlowski+dt@linaro.org>, "linux-riscv@lists.infradead.org" <linux-riscv@lists.infradead.org>, Sumit Semwal <sumit.semwal@linaro.org>, Shengyang Chen <shengyang.chen@starfivetech.com>, "linux-media@vger.kernel.org" <linux-media@vger.kernel.org>, "devicetree@vger.kernel.org" <devicetree@vger.kernel.org>, Conor Dooley <conor+dt@kernel.org>, Albert Ou <aou@eecs.berkeley.edu>, Maxime Ripard <mripard@kernel.org>, Jagan Teki <jagan@edgeble.ai>, "linaro-mm-sig@lists.linaro.org" <linaro-mm-sig@lists.linaro.org>, Rob Herring <robh+dt@kernel.org>, Chris Morgan <macromorgan@hotmail.com>, Paul Walmsley <paul.walmsley@sifive.com>, Bjorn Andersson <andersson@kernel.org>, "linux-kernel@vger.kernel.org" <linux-kernel@vger.kernel.org>, "christian.koenig@amd.com" <christian.koenig@amd.com>, Jack Zhu <jack.zhu@starfivetech.com>, Palmer Dabbelt <palmer@dabbelt.c
 om>, Thomas Zimmermann <tzimmermann@suse.de>, Shawn Guo <shawnguo@kernel.org>, Changhuang Liang <changhuang.liang@starfivetech.com>
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH v2 5/6] drm/vs: Add KMS crtc&plane
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/4ZGEGBQKGSCZ4VPC3WPEJO5FOMCVMU35/>
