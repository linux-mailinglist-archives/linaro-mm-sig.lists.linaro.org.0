...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id UDwNDJH64GnZnwAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:04:49 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id BCE76410252
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:04:48 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id CB9224050C
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 15:04:47 +0000 (UTC)
Received: from CH4PR04CU002.outbound.protection.outlook.com (mail-northcentralusazon11013066.outbound.protection.outlook.com [40.107.201.66])
	by lists.linaro.org (Postfix) with ESMTPS id 913983F795
	for <linaro-mm-sig@lists.linaro.org>; Tue, 11 Nov 2025 10:15:42 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=ti.com header.s=selector1 header.b=wxj83rRx;
	dmarc=pass (policy=quarantine) header.from=ti.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of m-malladi@ti.com designates 40.107.201.66 as permitted sender) smtp.mailfrom=m-malladi@ti.com
...
Message-ID-Hash: HFH2PZDIK4BV3TOFQG43O4IFHUOVSEAK
X-Message-ID-Hash: HFH2PZDIK4BV3TOFQG43O4IFHUOVSEAK
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH net-next v5 1/6] net: ti: icssg-prueth: Add functions to create and destroy Rx/Tx queues
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/HFH2PZDIK4BV3TOFQG43O4IFHUOVSEAK/>
