...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id uDp4AygGlWmmKAIAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 01:22:00 +0100
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A6CC15239B
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 01:21:59 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id A3B37402B7
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 00:21:58 +0000 (UTC)
Received: from CY7PR03CU001.outbound.protection.outlook.com (mail-westcentralusazon11010037.outbound.protection.outlook.com [40.93.198.37])
	by lists.linaro.org (Postfix) with ESMTPS id CA8633F7F9
	for <linaro-mm-sig@lists.linaro.org>; Wed, 18 Feb 2026 00:21:43 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=gB3nRKNh;
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 40.93.198.37 as permitted sender) smtp.mailfrom=jgg@nvidia.com;
...
X-Spamd-Bar: ---
Message-ID-Hash: ZTR4AO6GF7H23FXCSPU6VTIE2YXRY5VI
X-Message-ID-Hash: ZTR4AO6GF7H23FXCSPU6VTIE2YXRY5VI
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH RFC 21/26] dma-buf: Add the Physical Address List DMA mapping type
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/ZTR4AO6GF7H23FXCSPU6VTIE2YXRY5VI/>
