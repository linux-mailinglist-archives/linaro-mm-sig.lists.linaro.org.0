...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 28971BE8880
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 17 Oct 2025 14:14:57 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 9A2AA4573C
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 17 Oct 2025 12:14:55 +0000 (UTC)
Received: from CH5PR02CU005.outbound.protection.outlook.com (mail-northcentralusazon11012024.outbound.protection.outlook.com [40.107.200.24])
	by lists.linaro.org (Postfix) with ESMTPS id 91CE64431C
	for <linaro-mm-sig@lists.linaro.org>; Fri, 17 Oct 2025 12:14:52 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=U8Ssj8e7;
	dmarc=pass (policy=reject) header.from=nvidia.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 40.107.200.24 as permitted sender) smtp.mailfrom=jgg@nvidia.com
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.200.24:from];
	...
	DNSWL_BLOCKED(0.00)[2603:10b6:208:c1::17:received,40.107.200.24:from];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	DKIM_TRACE(0.00)[Nvidia.com:+]
X-Rspamd-Action: no action
X-Rspamd-Server: lists.linaro.org
Message-ID-Hash: JAOBKRZMYX3VQI2AF5ZXCSB35SJ7TK7K
X-Message-ID-Hash: JAOBKRZMYX3VQI2AF5ZXCSB35SJ7TK7K
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/JAOBKRZMYX3VQI2AF5ZXCSB35SJ7TK7K/>
