...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id aBfSNWEQ4WnoogAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 18:37:53 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 89035411C67
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 18:37:53 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id A781C44AE1
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 16:37:52 +0000 (UTC)
Received: from BL2PR02CU003.outbound.protection.outlook.com (mail-eastusazon11011012.outbound.protection.outlook.com [52.101.52.12])
	by lists.linaro.org (Postfix) with ESMTPS id CFAED3F84B
	for <linaro-mm-sig@lists.linaro.org>; Sun,  1 Feb 2026 14:35:19 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=nXr2bkhH;
	spf=pass (lists.linaro.org: domain of edwards@nvidia.com designates 52.101.52.12 as permitted sender) smtp.mailfrom=edwards@nvidia.com;
...
Message-ID-Hash: NE6K6WEIUWBRSY2ZMPWHPO3XLJ5ZX2IK
X-Message-ID-Hash: NE6K6WEIUWBRSY2ZMPWHPO3XLJ5ZX2IK
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH rdma-next v3 0/3] RDMA: Add support for exporting dma-buf file descriptors
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/NE6K6WEIUWBRSY2ZMPWHPO3XLJ5ZX2IK/>
