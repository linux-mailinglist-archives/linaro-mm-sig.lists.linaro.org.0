...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 46C864B6F9D
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 15 Feb 2022 16:16:48 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 7F4C73EEC6
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 15 Feb 2022 15:16:47 +0000 (UTC)
Received: from aposti.net (aposti.net [89.234.176.197])
	by lists.linaro.org (Postfix) with ESMTPS id ED2AC3EE45
	for <linaro-mm-sig@lists.linaro.org>; Mon,  7 Feb 2022 13:00:29 +0000 (UTC)
...
Message-ID-Hash: PCDUGUECHKO2JSYXXYIMGMMRUOU7DYNW
X-Message-ID-Hash: PCDUGUECHKO2JSYXXYIMGMMRUOU7DYNW
X-Mailman-Approved-At: Tue, 15 Feb 2022 15:15:56 +0000
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v2 08/12] iio: buffer-dma: Implement new DMABUF based userspace API
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/PCDUGUECHKO2JSYXXYIMGMMRUOU7DYNW/>
