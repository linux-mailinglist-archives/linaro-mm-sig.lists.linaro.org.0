...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id D9B52C0FAE1
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 27 Oct 2025 18:33:59 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id E5D8E3F7B4
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 27 Oct 2025 17:33:58 +0000 (UTC)
Received: from CY3PR05CU001.outbound.protection.outlook.com (mail-westcentralusazon11013026.outbound.protection.outlook.com [40.93.201.26])
	by lists.linaro.org (Postfix) with ESMTPS id 9F7FD3F79F
	for <linaro-mm-sig@lists.linaro.org>; Mon, 27 Oct 2025 17:33:35 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=QHXJ8Y51;
	dmarc=pass (policy=reject) header.from=nvidia.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 40.93.201.26 as permitted sender) smtp.mailfrom=jgg@nvidia.com
...
X-Spamd-Result: default: False [-4.50 / 15.00];
	...
	MISSING_XM_UA(0.00)[];
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.93.201.26:from];
	...
	DNSWL_BLOCKED(0.00)[2603:10b6:208:c1::17:received,40.93.201.26:from];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	DKIM_TRACE(0.00)[Nvidia.com:+]
X-Rspamd-Action: no action
Message-ID-Hash: Y5R4SR252ACAHUHOMRQNS2EU4HEMNGEW
X-Message-ID-Hash: Y5R4SR252ACAHUHOMRQNS2EU4HEMNGEW
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH 3/8] iommufd: Allow a DMABUF to be revoked
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/Y5R4SR252ACAHUHOMRQNS2EU4HEMNGEW/>
