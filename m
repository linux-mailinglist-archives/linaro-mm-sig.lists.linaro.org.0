...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 0757978269B
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 21 Aug 2023 11:56:07 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id AE67A3F358
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 21 Aug 2023 09:56:05 +0000 (UTC)
Received: from NAM10-BN7-obe.outbound.protection.outlook.com (mail-bn7nam10on2043.outbound.protection.outlook.com [40.107.92.43])
	by lists.linaro.org (Postfix) with ESMTPS id 33FE03EC03
	for <linaro-mm-sig@lists.linaro.org>; Mon, 21 Aug 2023 09:56:01 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Synaptics.onmicrosoft.com header.s=selector2-Synaptics-onmicrosoft-com header.b="IQ+/wfbF";
	spf=pass (lists.linaro.org: domain of Randy.Li@synaptics.com designates 40.107.92.43 as permitted sender) smtp.mailfrom=Randy.Li@synaptics.com;
	dmarc=pass (policy=none) header.from=synaptics.com;
...
X-MS-Exchange-AntiSpam-MessageData-0: 
	=?utf-8?B?T0kxK0VyeUFwci9QbTRLZDhCSmNQSGtiWWhtSTJOaEkzQzZFVTZPYWh5ZVlo?=
...
X-Spamd-Result: default: False [-10.50 / 15.00];
	...
	RCVD_IN_DNSWL_HI(-1.00)[40.107.92.43:from,2603:10b6:5:24a::19:received];
	DMARC_POLICY_ALLOW(-0.50)[synaptics.com,none];
	R_SPF_ALLOW(-0.20)[+ip4:40.107.0.0/16];
	R_DKIM_ALLOW(-0.20)[Synaptics.onmicrosoft.com:s=selector2-Synaptics-onmicrosoft-com];
	MIME_GOOD(-0.10)[text/plain];
	TO_DN_SOME(0.00)[];
	MIME_TRACE(0.00)[0:+];
	ASN(0.00)[asn:8075, ipnet:40.104.0.0/14, country:US];
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.92.43:from];
	...
	URIBL_BLOCKED(0.00)[Synaptics.onmicrosoft.com:dkim,mail-bn7nam10on2043.outbound.protection.outlook.com:rdns];
	DKIM_TRACE(0.00)[Synaptics.onmicrosoft.com:+]
X-Rspamd-Action: no action
X-Rspamd-Server: lists.linaro.org
Message-ID-Hash: AJ4AG33N46IU6HLONHQT2QUBDQK34ZYD
X-Message-ID-Hash: AJ4AG33N46IU6HLONHQT2QUBDQK34ZYD
X-MailFrom: Randy.Li@synaptics.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
CC: sumit.semwal@linaro.org, Benjamin Gaignard <benjamin.gaignard@collabora.com>, Brian.Starkey@arm.com, jstultz@google.com, tjmercier@google.com, christian.koenig@amd.com, Linux Media Mailing List <linux-media@vger.kernel.org>, dri-devel@lists.freedesktop.org, linux-kernel@vger.kernel.org
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] [PATCH] dma-buf/heaps: map CMA all pages for user
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/AJ4AG33N46IU6HLONHQT2QUBDQK34ZYD/>
