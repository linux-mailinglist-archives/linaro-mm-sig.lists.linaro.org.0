...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id B18D6C6A2B0
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 18 Nov 2025 16:00:10 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id C60363F8F9
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 18 Nov 2025 15:00:09 +0000 (UTC)
Received: from CO1PR03CU002.outbound.protection.outlook.com (mail-westus2azon11010017.outbound.protection.outlook.com [52.101.46.17])
	by lists.linaro.org (Postfix) with ESMTPS id C35073F903
	for <linaro-mm-sig@lists.linaro.org>; Tue, 18 Nov 2025 14:59:48 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=V9ZNRNQt;
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 52.101.46.17 as permitted sender) smtp.mailfrom=jgg@nvidia.com;
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	RWL_MAILSPIKE_POSSIBLE(0.00)[52.101.46.17:from];
	...
	URIBL_BLOCKED(0.00)[intel.com:email,Nvidia.com:dkim,nvidia.com:from_smtp,nvidia.com:mid,nvidia.com:from_mime,gitlab.freedesktop.org:url];
	DKIM_TRACE(0.00)[Nvidia.com:+]
X-Rspamd-Server: lists.linaro.org
X-Rspamd-Queue-Id: C35073F903
X-Spamd-Bar: ----
Message-ID-Hash: EIKTOUGHBRKBFSK6CTXORTLDX77FAANE
X-Message-ID-Hash: EIKTOUGHBRKBFSK6CTXORTLDX77FAANE
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/EIKTOUGHBRKBFSK6CTXORTLDX77FAANE/>
