...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id AB2DDB2D4D9
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 20 Aug 2025 09:28:16 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 6EBA044789
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 20 Aug 2025 07:28:15 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
	by lists.linaro.org (Postfix) with ESMTPS id 8692544789
	for <linaro-mm-sig@lists.linaro.org>; Wed, 20 Aug 2025 07:28:03 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=A64imgfl;
	spf=pass (lists.linaro.org: domain of oliver.sang@intel.com designates 198.175.65.12 as permitted sender) smtp.mailfrom=oliver.sang@intel.com;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=A64imgflvdrB8cg4gG/HnZ4T5urK2982iq6yXfrfV1th4514GLImja3L
   ...
   A==;
X-CSE-ConnectionGUID: x/N4ACEpQlKa25YfHOpkzw==
X-CSE-MsgGUID: 9jJ3GDMvTlu8nid37tIqFQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11527"; a="69382068"
X-IronPort-AV: E=Sophos;i="6.17,302,1747724400";
   d="scan'208";a="69382068"
...
X-Spamd-Result: default: False [-6.50 / 15.00];
	...
	TO_DN_SOME(0.00)[];
	FROM_HAS_DN(0.00)[];
	FREEMAIL_CC(0.00)[lists.linux.dev,intel.com,vger.kernel.org,lists.freedesktop.org,lists.linaro.org,lists.linux.it,ffwll.ch,igalia.com,mailbox.org,gmail.com,kernel.org,linaro.org];
	DKIM_TRACE(0.00)[intel.com:+];
	DNSWL_BLOCKED(0.00)[198.175.65.12:from,2603:10b6:408:1b6::9:received];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	FROM_EQ_ENVFROM(0.00)[];
	RCVD_IN_DNSWL_NONE(0.00)[40.107.96.80:received];
...
Message-ID-Hash: ZJ2JFN4FS45OO7FXDD7D33Q6AK6JMGXV
X-Message-ID-Hash: ZJ2JFN4FS45OO7FXDD7D33Q6AK6JMGXV
X-MailFrom: oliver.sang@intel.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
CC: oe-lkp@lists.linux.dev, lkp@intel.com, linux-media@vger.kernel.org, dri-devel@lists.freedesktop.org, linaro-mm-sig@lists.linaro.org, ltp@lists.linux.it, simona.vetter@ffwll.ch, tvrtko.ursulin@igalia.com, phasta@mailbox.org, dakr@kernel.org, sumit.semwal@linaro.org, oliver.sang@intel.com
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH 2/2] dma-buf: add warning when dma_fence is signaled from IOCTL
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/ZJ2JFN4FS45OO7FXDD7D33Q6AK6JMGXV/>
