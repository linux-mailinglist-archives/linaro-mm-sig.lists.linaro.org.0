...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id WJ3WM5z64GnZnwAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:05:00 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B1FC410267
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:05:00 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 2AAE94050C
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 15:04:59 +0000 (UTC)
Received: from CH4PR04CU002.outbound.protection.outlook.com (mail-northcentralusazon11013034.outbound.protection.outlook.com [40.107.201.34])
	by lists.linaro.org (Postfix) with ESMTPS id 2F0843F795
	for <linaro-mm-sig@lists.linaro.org>; Tue, 11 Nov 2025 10:15:49 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=ti.com header.s=selector1 header.b=kEpDCiPo;
	dmarc=pass (policy=quarantine) header.from=ti.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of m-malladi@ti.com designates 40.107.201.34 as permitted sender) smtp.mailfrom=m-malladi@ti.com
...
Message-ID-Hash: UJFUUORYV3OWWSNA75XAKYIAJCGOZ34N
X-Message-ID-Hash: UJFUUORYV3OWWSNA75XAKYIAJCGOZ34N
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH net-next v5 4/6] net: ti: icssg-prueth: Make emac_run_xdp function independent of page
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/UJFUUORYV3OWWSNA75XAKYIAJCGOZ34N/>
...
X-Spamd-Result: default: False [6.49 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[ti.com:mid,ti.com:email,linaro.org:email,lists.linaro.org:helo,lists.linaro.org:rdns,intel.com:email,xdp.data:url];
