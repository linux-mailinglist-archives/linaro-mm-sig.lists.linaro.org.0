...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 156519DBA3A
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 28 Nov 2024 16:10:45 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 27F2D44B3B
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 28 Nov 2024 15:10:44 +0000 (UTC)
Received: from mail-ej1-f41.google.com (mail-ej1-f41.google.com [209.85.218.41])
	by lists.linaro.org (Postfix) with ESMTPS id 527C644A5E
	for <linaro-mm-sig@lists.linaro.org>; Thu, 28 Nov 2024 15:09:45 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=linaro.org header.s=google header.b=QQZ7cNGh;
...
Received: by mail-ej1-f41.google.com with SMTP id a640c23a62f3a-aa51b8c5f4dso119333066b.2
        for <linaro-mm-sig@lists.linaro.org>; Thu, 28 Nov 2024 07:09:45 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1732806584; x=1733411384; darn=lists.linaro.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=nSDQWd9UZqV/STl4BJjbppPEGE1hH0ufO/G2aXdmVa4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=nSDQWd9UZqV/STl4BJjbppPEGE1hH0ufO/G2aXdmVa4=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXSR7ZDdeYFZ9clBLhHuVFb97LG6aHQ+IkIdhliJcspMQFE5VtIaCRQWyRDGgejPH/pKrHApviNxeblUW08@lists.linaro.org
X-Gm-Message-State: AOJu0YyY4BY/N11VmezFMywBFYjiIZKxd1ZSPo+EPFNRAR553fIr2PnX
	qzj5MNkbCoES8kXXrdrRlRj4pqOMUge1WtGo5UAaqJxd1Ei4f0N0dNsBg0g8+kv99A==
X-Gm-Gg: 
	vcVCti27Pl4RCgkPyt69jeV2
...
MIME-Version: 1.0
X-Rspamd-Queue-Id: 527C644A5E
X-Spamd-Bar: ------
X-Spamd-Result: default: False [-6.10 / 15.00];
	REPLY(-4.00)[];
	BAYES_HAM(-3.00)[100.00%];
	SUSPICIOUS_RECIPS(1.50)[];
	RBL_SENDERSCORE_REPUT_9(-1.00)[209.85.218.41:from];
...
Message-ID-Hash: XXKWGIODVOAWDGXLO3OMHNHK72J5AK6S
X-Message-ID-Hash: XXKWGIODVOAWDGXLO3OMHNHK72J5AK6S
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v3 3/4] optee: sync secure world ABI headers
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/XXKWGIODVOAWDGXLO3OMHNHK72J5AK6S/>
