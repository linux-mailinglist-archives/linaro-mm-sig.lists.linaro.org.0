...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 83C7590C5BE
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 18 Jun 2024 12:03:49 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 94A59446DB
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 18 Jun 2024 10:03:48 +0000 (UTC)
Received: from aposti.net (aposti.net [89.234.176.197])
	by lists.linaro.org (Postfix) with ESMTPS id 973B044783
	for <linaro-mm-sig@lists.linaro.org>; Tue, 18 Jun 2024 10:03:23 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=crapouillou.net header.s=mail header.b=EESD9ly6;
...
Message-ID-Hash: A3IIQAAEUVTYCASPRT6AVGPV454DB5EK
X-Message-ID-Hash: A3IIQAAEUVTYCASPRT6AVGPV454DB5EK
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v11 2/7] dmaengine: dma-axi-dmac: Implement device_prep_peripheral_dma_vec
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/A3IIQAAEUVTYCASPRT6AVGPV454DB5EK/>
