...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id GASSHxH34GmInwAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 16:49:53 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 06F9F40FCD4
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 16:49:53 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 1F6C7404EA
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 14:49:52 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
	by lists.linaro.org (Postfix) with ESMTPS id 8FFC93F754
	for <linaro-mm-sig@lists.linaro.org>; Fri, 24 Oct 2025 00:57:05 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=KAKR88fM;
	dmarc=pass (policy=none) header.from=intel.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of jacob.e.keller@intel.com designates 198.175.65.12 as permitted sender) smtp.mailfrom=jacob.e.keller@intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1761267426; x=1792803426;
  h=message-id:date:subject:to:cc:references:from:
   in-reply-to:mime-version;
  bh=FdoVHGIkAcYZuJ/mRiQchegDVcqibYl2CM2b/T45Jws=;
  b=KAKR88fMaD3Rf1U4C94kojmHmZsQjkunBxVzkpiT7Sd9LZZDknDwvPwk
   pZwMnpqMgfWKgq8IN7T0k6R06tcOou17HVWslVRHU0Hs8iX6a3KAIqEj+
   GCTWqEH2Rft+5BO9swrNwNmUlUIU9IkHtVW4M+SHJGtsm1jA8Hvh3Y+Wa
   zaLYSy78kC0zqYs46KpLv4KGMVXjPK4qU2qrkDGHd1SFH8XaG9S4LpdmP
   cLoOPNHWL8kJldzFPutaY1lc056eqICFKx89Y/G0r9TObL4X1tXddp8iB
   3n4hJgLGHoFy20j2J/SbPlHXnpkW1LAvlGdWcYFsa1TrXPH/pCh3K630c
   g==;
X-CSE-ConnectionGUID: AKWuEC9KRRiU4QBYZxSzoQ==
X-CSE-MsgGUID: hhG0w6MlQyi75k+2OpNepQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11586"; a="74888273"
X-IronPort-AV: E=Sophos;i="6.19,251,1754982000";
   d="asc'?scan'208";a="74888273"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
  by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Oct 2025 17:57:04 -0700
...
Message-ID-Hash: OE7LL44UKGSZO7AMLWONGWQJ2PAU6GSZ
X-Message-ID-Hash: OE7LL44UKGSZO7AMLWONGWQJ2PAU6GSZ
X-Mailman-Approved-At: Thu, 16 Apr 2026 14:48:20 +0000
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/OE7LL44UKGSZO7AMLWONGWQJ2PAU6GSZ/>
...
Content-Type: multipart/mixed; boundary="===============8982030379913800081=="
X-Spamd-Result: default: False [1.99 / 15.00];
	SIGNED_PGP(-2.00)[];
	SUSPICIOUS_RECIPS(1.50)[];
	ARC_REJECT(1.00)[signature check failed: fail, {[1] = sig:microsoft.com:reject}];
	DATE_IN_PAST(1.00)[4189];
	...
	RCVD_TLS_LAST(0.00)[];
	FREEMAIL_TO(0.00)[ti.com,kernel.org,linutronix.de,linux.dev,amd.com,linaro.org,fomichev.me,gmail.com,iogearbox.net,redhat.com,google.com,davemloft.net,lunn.ch];
	FORGED_SENDER_MAILLIST(0.00)[];
	DKIM_TRACE(0.00)[intel.com:-];
	RCPT_COUNT_TWELVE(0.00)[27];
	MIME_TRACE(0.00)[0:+,1:+,2:+,3:+,4:~,5:+];
	DBL_BLOCKED_OPENRESOLVER(0.00)[lists.linaro.org:helo,lists.linaro.org:rdns,linaro.org:email,intel.com:mid,intel.com:email];
	HAS_ATTACHMENT(0.00)[];
	FORGED_RECIPIENTS_MAILLIST(0.00)[];
	FROM_NEQ_ENVFROM(0.00)[jacob.e.keller@intel.com,linaro-mm-sig-bounces@lists.linaro.org];
	FROM_HAS_DN(0.00)[];
	TO_DN_SOME(0.00)[];
