...
Received: from mail.lfdr.de
	...
	id 6KKrHg2NMmrH1wUAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 17 Jun 2026 14:03:25 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 08F9A69972E
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 17 Jun 2026 14:03:25 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=none;
	dmarc=fail reason="SPF not aligned (relaxed), No valid DKIM" header.from=gmail.com (policy=none);
	spf=pass (mail.lfdr.de: domain of "linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org" designates 44.210.186.118 as permitted sender) smtp.mailfrom="linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org"
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 1E2AC40A56
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 17 Jun 2026 12:03:24 +0000 (UTC)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id E87CF44327
...
Message-ID: <178169632795.662463.9103588520336702393@lists.linaro.org>
User-Agent: HyperKitty on http://lists.linaro.org/
Message-ID-Hash: QFPLPZDTTGGDYYQ5LOIVYZVNVHFNFWMS
X-Message-ID-Hash: QFPLPZDTTGGDYYQ5LOIVYZVNVHFNFWMS
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/QFPLPZDTTGGDYYQ5LOIVYZVNVHFNFWMS/>
...
X-Spamd-Result: default: False [8.69 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[rushmynewpassport.com:url,buyrealcurrency.com:url,linaro.org:email,globaltraveldocs.com:url,lists.linaro.org:mid,lists.linaro.org:helo,lists.linaro.org:rdns,lists.linaro.org:from_smtp]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: 08F9A69972E
X-Spam: Yes
