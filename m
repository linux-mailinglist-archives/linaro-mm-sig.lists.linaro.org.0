...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id E857964524F
	for <lists+linaro-mm-sig@lfdr.de>; Wed,  7 Dec 2022 03:53:48 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 8E95D3EF42
	for <lists+linaro-mm-sig@lfdr.de>; Wed,  7 Dec 2022 02:53:47 +0000 (UTC)
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
	by lists.linaro.org (Postfix) with ESMTPS id 89CDA3EC78
	for <linaro-mm-sig@lists.linaro.org>; Wed,  7 Dec 2022 02:53:36 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=cSVibQl0;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  t=1670381616; x=1701917616;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=dF6RqspkzAtQLJmX03TbLO0APamILkuCWjpuxvM8PJs=;
  b=cSVibQl0vdZDfVIPbVD5QNOqdendE8Z7uYKi4pYeRERToS+2d+IooCUJ
   Fg2atMRX82K2UmLg+fE7Emgnz6SH7T4icJV10PdIQl8E+dy2q5ciyhyae
   uIKOJLKVWolr1b3WGe+EuCK0UGi42Pz6cungmOoU2ZPe/lH1EUdvL3kG5
   +B0V3LonlvxtIjwkXuCcv1m4Ehf5YpTPAquXKak9FFQwMNxDKGrzYtnsj
   kREhyo1TX2dPN70/braRia2E70LHKBkUuODVT+79YucNOplpkEaHf/rtP
   BAiUg0kGMcxnWNpN3mE346tbttUoLDoSC2JtbMSrq/E/sFMUMoEiUhAHq
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10553"; a="403060660"
X-IronPort-AV: E=Sophos;i="5.96,223,1665471600";
   d="scan'208";a="403060660"
...
X-Spamd-Result: default: False [-5.20 / 15.00];
	...
	RCVD_IN_DNSWL_MED(-0.20)[192.55.52.43:from];
...
Message-ID-Hash: TGYRAOD6P7ZOVV6XQCKELTXTW3QBCBFS
X-Message-ID-Hash: TGYRAOD6P7ZOVV6XQCKELTXTW3QBCBFS
X-MailFrom: lkp@intel.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
CC: oe-kbuild-all@lists.linux.dev, linaro-mm-sig@lists.linaro.org, dri-devel@lists.freedesktop.org, linux-media@vger.kernel.org
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH] dma-buf: fix dma_buf_export init order
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/TGYRAOD6P7ZOVV6XQCKELTXTW3QBCBFS/>
