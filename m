...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id B78146C463E
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 22 Mar 2023 10:22:44 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id C55B63F330
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 22 Mar 2023 09:22:43 +0000 (UTC)
Received: from aposti.net (aposti.net [89.234.176.197])
	by lists.linaro.org (Postfix) with ESMTPS id C6B40447BD
	for <linaro-mm-sig@lists.linaro.org>; Wed, 22 Mar 2023 09:21:45 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=crapouillou.net header.s=mail header.b=wthtQQZt;
...
X-Spamd-Result: default: False [-6.50 / 15.00];
	...
	ARC_NA(0.00)[]
Message-ID-Hash: FHB3IFCFJ4UYQLSGTTCBZB2P5HSDQLBE
X-Message-ID-Hash: FHB3IFCFJ4UYQLSGTTCBZB2P5HSDQLBE
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v2 3/3] usb: gadget: functionfs: Add DMABUF import interface
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/FHB3IFCFJ4UYQLSGTTCBZB2P5HSDQLBE/>
