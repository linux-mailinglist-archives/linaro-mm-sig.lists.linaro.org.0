...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id GNB7Mu/NcGkOaAAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 21 Jan 2026 14:00:31 +0100
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 72E0E5742B
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 21 Jan 2026 14:00:31 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 8C6AA401B1
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 21 Jan 2026 13:00:30 +0000 (UTC)
Received: from tor.source.kernel.org (tor.source.kernel.org [172.105.4.254])
	by lists.linaro.org (Postfix) with ESMTPS id AD81D40150
	for <linaro-mm-sig@lists.linaro.org>; Wed, 21 Jan 2026 12:59:43 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=kernel.org header.s=k20201202 header.b=HM6a6IQ+;
	spf=pass (lists.linaro.org: domain of leon@kernel.org designates 172.105.4.254 as permitted sender) smtp.mailfrom=leon@kernel.org;
	dmarc=pass (policy=quarantine) header.from=kernel.org
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by tor.source.kernel.org (Postfix) with ESMTP id 6C02D600AA;
...
X-Spamd-Bar: ----
Message-ID-Hash: Z2OUNASPF2KBLY3MWHGZ2YFHNKAC6L2P
X-Message-ID-Hash: Z2OUNASPF2KBLY3MWHGZ2YFHNKAC6L2P
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v4 4/8] dma-buf: Make .invalidate_mapping() truly optional
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/Z2OUNASPF2KBLY3MWHGZ2YFHNKAC6L2P/>
