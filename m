...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id AFIILbD94GnzoAAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:18:08 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E4FD4107AC
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:18:08 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 3EBE6409B8
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 15:18:07 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.13])
	by lists.linaro.org (Postfix) with ESMTPS id 1A4F83F81E
	for <linaro-mm-sig@lists.linaro.org>; Tue, 18 Nov 2025 05:38:08 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=kgMwf+Q4;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=kgMwf+Q4IVMSeY/b847lqq+j8hbSQjFZ2wtmyr/ojqe/D655/JBOh8w7
   ...
   A==;
X-CSE-ConnectionGUID: nVja44E5RaaiRLQFHDie+w==
X-CSE-MsgGUID: 2QBXf1QxTqesQIyGT9iZmg==
X-IronPort-AV: E=McAfee;i="6800,10657,11616"; a="68060656"
X-IronPort-AV: E=Sophos;i="6.19,314,1754982000";
   d="scan'208";a="68060656"
...
Message-ID-Hash: CVRIKLHHYEPVQ4MHZSHIYHPWUBYYL653
X-Message-ID-Hash: CVRIKLHHYEPVQ4MHZSHIYHPWUBYYL653
X-Mailman-Approved-At: Thu, 16 Apr 2026 14:57:06 +0000
CC: Alex Williamson <alex@shazbot.org>, =?iso-8859-1?Q?Christian_K=F6nig?= <christian.koenig@amd.com>, "dri-devel@lists.freedesktop.org" <dri-devel@lists.freedesktop.org>, "iommu@lists.linux.dev" <iommu@lists.linux.dev>, Joerg Roedel <joro@8bytes.org>, "Tian, Kevin" <kevin.tian@intel.com>, "kvm@vger.kernel.org" <kvm@vger.kernel.org>, "linaro-mm-sig@lists.linaro.org" <linaro-mm-sig@lists.linaro.org>, "linux-kselftest@vger.kernel.org" <linux-kselftest@vger.kernel.org>, "linux-media@vger.kernel.org" <linux-media@vger.kernel.org>, Robin Murphy <robin.murphy@arm.com>, Shuah Khan <shuah@kernel.org>, Sumit Semwal <sumit.semwal@linaro.org>, Will Deacon <will@kernel.org>, Krishnakant Jaju <kjaju@nvidia.com>, Leon Romanovsky <leon@kernel.org>, Matt Ochs <mochs@nvidia.com>, Nicolin Chen <nicolinc@nvidia.com>, "patches@lists.linux.dev" <patches@lists.linux.dev>, Simona Vetter <simona.vetter@ffwll.ch>, Xu Yilun <yilun.xu@linux.intel.com>
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH 0/9] Initial DMABUF support for iommufd
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/CVRIKLHHYEPVQ4MHZSHIYHPWUBYYL653/>
...
X-Spamd-Result: default: False [2.59 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[IA0PR11MB7185.namprd11.prod.outlook.com:mid,intel.com:email,linaro.org:email,lists.linaro.org:helo,lists.linaro.org:rdns,gitlab.freedesktop.org:url];
