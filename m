...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 72AF6625A31
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 11 Nov 2022 13:06:13 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 428473F5F7
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 11 Nov 2022 12:06:12 +0000 (UTC)
Received: from NAM02-SN1-obe.outbound.protection.outlook.com (mail-sn1anam02on2072.outbound.protection.outlook.com [40.107.96.72])
	by lists.linaro.org (Postfix) with ESMTPS id 283333F5DF
	for <linaro-mm-sig@lists.linaro.org>; Fri, 11 Nov 2022 12:05:55 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=o9zWL8+Y;
	spf=pass (lists.linaro.org: domain of Christian.Koenig@amd.com designates 40.107.96.72 as permitted sender) smtp.mailfrom=Christian.Koenig@amd.com;
...
X-MS-Exchange-AntiSpam-MessageData-0: 
	=?utf-8?B?N1FqeHVCdVNjbTlFaWl6NW56V1h5RFFHdGNKT1BnYnpISmFGVHc4S3VNcU5X?=
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	FREEMAIL_TO(0.00)[googlemail.com,redhat.com,collabora.com];
	RCVD_IN_DNSWL_NONE(0.00)[40.107.96.72:from];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	TAGGED_RCPT(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[NAM02-SN1-obe.outbound.protection.outlook.com:helo];
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.96.72:from];
	...
	DWL_DNSWL_FAIL(0.00)[amd.com:server fail];
	ASN(0.00)[asn:8075, ipnet:40.104.0.0/14, country:US];
	DKIM_TRACE(0.00)[amd.com:+];
	MID_RHS_MATCH_FROM(0.00)[];
	TO_DN_SOME(0.00)[];
	RECEIVED_SPAMHAUS_BLOCKED_OPENRESOLVER(0.00)[2603:10b6:408:43::13:received]
Message-ID-Hash: AGTDZ7BMAGJIVJQ3OSQB2SNEJP6PKGIX
X-Message-ID-Hash: AGTDZ7BMAGJIVJQ3OSQB2SNEJP6PKGIX
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/AGTDZ7BMAGJIVJQ3OSQB2SNEJP6PKGIX/>
