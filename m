...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 3936BAA6ED5
	for <lists+linaro-mm-sig@lfdr.de>; Fri,  2 May 2025 12:05:31 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 511923F935
	for <lists+linaro-mm-sig@lfdr.de>; Fri,  2 May 2025 10:05:30 +0000 (UTC)
Received: from mail-ej1-f51.google.com (mail-ej1-f51.google.com [209.85.218.51])
	by lists.linaro.org (Postfix) with ESMTPS id C21AD46086
	for <linaro-mm-sig@lists.linaro.org>; Fri,  2 May 2025 10:01:18 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=linaro.org header.s=google header.b=Vzbh8yEh;
...
Received: by mail-ej1-f51.google.com with SMTP id a640c23a62f3a-ac2af2f15d1so227665966b.1
        for <linaro-mm-sig@lists.linaro.org>; Fri, 02 May 2025 03:01:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1746180078; x=1746784878; darn=lists.linaro.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=CvUXav+GQi4h/Z/+dGorWUhrj+YXnlklNArIvigL5rg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=CvUXav+GQi4h/Z/+dGorWUhrj+YXnlklNArIvigL5rg=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXRD77L9llRLvCcsgX61XuCSbICaxeDID63fNUWtSqFUowKxHaF/rQt6LtLfbG3TW3mPB/YLio8URFNBhB3@lists.linaro.org
X-Gm-Message-State: AOJu0YxNalUL4uwLQ1PELoBP60sJaD/Plt23iIkbdCY45fyLwXRcM/Kg
	yvpSDuwhnia6R0JNlgrU+LRCY1ymMzsXT4SNPrxglUPP2n3RggMDr6fI/wa235HXFA==
X-Gm-Gg: 
	PrcwATBjJpW7vGwbmAyKVjL2zasmu
...
X-Spamd-Result: default: False [-5.10 / 15.00];
	...
	ARC_NA(0.00)[];
	URIBL_BLOCKED(0.00)[linaro.org:dkim,linaro.org:mid,linaro.org:email,mail-ej1-f51.google.com:helo,mail-ej1-f51.google.com:rdns];
...
Message-ID-Hash: JPSQV3KUSVFL33RZ4M45FIXTC7RKBHHD
X-Message-ID-Hash: JPSQV3KUSVFL33RZ4M45FIXTC7RKBHHD
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v8 13/14] optee: FF-A: dynamic protected memory allocation
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/JPSQV3KUSVFL33RZ4M45FIXTC7RKBHHD/>
