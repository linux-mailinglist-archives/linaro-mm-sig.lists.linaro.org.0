...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 21FF76B9285
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 14 Mar 2023 13:02:21 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 277F43F52A
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 14 Mar 2023 12:02:20 +0000 (UTC)
Received: from NAM04-BN8-obe.outbound.protection.outlook.com (mail-bn8nam04on2080.outbound.protection.outlook.com [40.107.100.80])
	by lists.linaro.org (Postfix) with ESMTPS id C74713EA31
	for <linaro-mm-sig@lists.linaro.org>; Tue, 14 Mar 2023 12:02:00 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=ks2gIPzT;
	spf=pass (lists.linaro.org: domain of Christian.Koenig@amd.com designates 40.107.100.80 as permitted sender) smtp.mailfrom=Christian.Koenig@amd.com;
...
X-MS-Exchange-AntiSpam-MessageData-0: 
	=?utf-8?B?d2pKaGFHZlE2cVlWSXJnZi9HcjN2ckVsYmxVdHVsWHZ4TFBEVWprNStzdjhr?=
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.100.80:from];
	RCVD_COUNT_THREE(0.00)[3];
	FROM_HAS_DN(0.00)[];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	DKIM_TRACE(0.00)[amd.com:+];
	TO_DN_SOME(0.00)[]
Message-ID-Hash: K2EZ5IIMBCLR2EPSSOZ2L4UZZ6XSOZ6J
X-Message-ID-Hash: K2EZ5IIMBCLR2EPSSOZ2L4UZZ6XSOZ6J
...
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH 0/2] usb: gadget: functionfs: DMABUF import interface
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/K2EZ5IIMBCLR2EPSSOZ2L4UZZ6XSOZ6J/>
