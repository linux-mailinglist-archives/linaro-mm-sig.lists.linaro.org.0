...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 5DB2AA691A9
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 19 Mar 2025 15:56:30 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 74EFA44629
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 19 Mar 2025 14:56:29 +0000 (UTC)
Received: from mail-pl1-f169.google.com (mail-pl1-f169.google.com [209.85.214.169])
	by lists.linaro.org (Postfix) with ESMTPS id CEFD63F38E
	for <linaro-mm-sig@lists.linaro.org>; Wed, 19 Mar 2025 14:55:42 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=gmail.com header.s=20230601 header.b=jV3nusV8;
...
Received: by mail-pl1-f169.google.com with SMTP id d9443c01a7336-2235189adaeso17193955ad.0
        for <linaro-mm-sig@lists.linaro.org>; Wed, 19 Mar 2025 07:55:42 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1742396142; x=1743000942; darn=lists.linaro.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=8XT8DN3ZleGCofMlQ1mMQjy7k/r/T2YXHUe97y9PZGo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=8XT8DN3ZleGCofMlQ1mMQjy7k/r/T2YXHUe97y9PZGo=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWRjEq4+pOGbs+hgymmkLx3mlVRfJKslgRbpkoQQYLmHpqbfY3Q8uQpVAWjdQoLXz4tQhjoO5SUd3DhOMEJ@lists.linaro.org
X-Gm-Message-State: AOJu0YxGtY+IYs681lm3YV+QXglV33OnASWQzLVZXONeSOJMN4cyJibQ
	p/to2hdyXK2FZtzt/M+6tcn2YLwvtcOhNo7Msr0jb+E/BLgjyK9a
X-Gm-Gg: 
...
X-Spamd-Result: default: False [-6.60 / 15.00];
	...
	RBL_SENDERSCORE_REPUT_8(0.00)[209.85.214.169:from];
	ASN(0.00)[asn:15169, ipnet:209.85.128.0/17, country:US];
	FROM_HAS_DN(0.00)[]
Message-ID-Hash: GBXW3GVD2J6EKD7WHQFQZKDINT64XG3G
X-Message-ID-Hash: GBXW3GVD2J6EKD7WHQFQZKDINT64XG3G
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v2 18/34] drm/msm: Add VM_BIND submitqueue
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/GBXW3GVD2J6EKD7WHQFQZKDINT64XG3G/>
