...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 24A1076B093
	for <lists+linaro-mm-sig@lfdr.de>; Tue,  1 Aug 2023 12:12:49 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 3735943F26
	for <lists+linaro-mm-sig@lfdr.de>; Tue,  1 Aug 2023 10:12:48 +0000 (UTC)
Received: from ex01.ufhost.com (ex01.ufhost.com [61.152.239.75])
	by lists.linaro.org (Postfix) with ESMTP id 397634416C
	for <linaro-mm-sig@lists.linaro.org>; Tue,  1 Aug 2023 10:10:43 +0000 (UTC)
...
X-Spamd-Result: default: False [-0.20 / 15.00];
	...
	ARC_NA(0.00)[]
Message-ID-Hash: GZMYAN6WWNZEWSRP7KBGNTRTH2BC64RD
X-Message-ID-Hash: GZMYAN6WWNZEWSRP7KBGNTRTH2BC64RD
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v1 v1 7/7] drm/vs: Add hdmi
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/GZMYAN6WWNZEWSRP7KBGNTRTH2BC64RD/>
