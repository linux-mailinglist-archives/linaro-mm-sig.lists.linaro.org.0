...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 98C468C72A1
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 May 2024 10:17:38 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id AA12440D22
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 May 2024 08:17:37 +0000 (UTC)
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (mail-mw2nam12on2044.outbound.protection.outlook.com [40.107.244.44])
	by lists.linaro.org (Postfix) with ESMTPS id 020433F672
	for <linaro-mm-sig@lists.linaro.org>; Thu, 16 May 2024 08:17:27 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=Dvn7rcxv;
	spf=pass (lists.linaro.org: domain of Christian.Koenig@amd.com designates 40.107.244.44 as permitted sender) smtp.mailfrom=Christian.Koenig@amd.com;
...
X-Spamd-Result: default: False [-7.49 / 15.00];
	...
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.244.44:from];
	RCPT_COUNT_TWELVE(0.00)[32];
	TAGGED_RCPT(0.00)[dt];
	MIME_TRACE(0.00)[0:+];
	ASN(0.00)[asn:8075, ipnet:40.104.0.0/14, country:US];
	FREEMAIL_TO(0.00)[mediatek.com,kernel.org,gmail.com,linaro.org,linux-foundation.org];
	RCVD_TLS_LAST(0.00)[];
	TO_DN_SOME(0.00)[];
	FROM_HAS_DN(0.00)[];
...
Message-ID-Hash: RMZN7NXEL2BV4QL6B3JSCESLYVGHS6GP
X-Message-ID-Hash: RMZN7NXEL2BV4QL6B3JSCESLYVGHS6GP
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/RMZN7NXEL2BV4QL6B3JSCESLYVGHS6GP/>
