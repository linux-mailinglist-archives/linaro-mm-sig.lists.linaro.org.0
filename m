...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 7397F9449B1
	for <lists+linaro-mm-sig@lfdr.de>; Thu,  1 Aug 2024 12:51:21 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 63AB14473D
	for <lists+linaro-mm-sig@lfdr.de>; Thu,  1 Aug 2024 10:51:20 +0000 (UTC)
Received: from NAM11-BN8-obe.outbound.protection.outlook.com (mail-bn8nam11on2043.outbound.protection.outlook.com [40.107.236.43])
	by lists.linaro.org (Postfix) with ESMTPS id A5B6C40090
	for <linaro-mm-sig@lists.linaro.org>; Thu,  1 Aug 2024 10:51:02 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=Jg4z1PRL;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of Christian.Koenig@amd.com designates 40.107.236.43 as permitted sender) smtp.mailfrom=Christian.Koenig@amd.com;
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.236.43:from];
	RCPT_COUNT_SEVEN(0.00)[8];
	ASN(0.00)[asn:8075, ipnet:40.104.0.0/14, country:US];
	MID_RHS_MATCH_FROM(0.00)[];
	NEURAL_HAM(-0.00)[-0.997];
	URIBL_BLOCKED(0.00)[vivo.com:email,amd.com:dkim,amd.com:mid];
...
Message-ID-Hash: NKQ3EMK2KZGR6XQ4GUF25EXICW4ARCAO
X-Message-ID-Hash: NKQ3EMK2KZGR6XQ4GUF25EXICW4ARCAO
X-MailFrom: Christian.Koenig@amd.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
CC: opensource.kernel@vivo.com
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH 1/5] udmabuf: cancel mmap page fault, direct map it
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/NKQ3EMK2KZGR6XQ4GUF25EXICW4ARCAO/>
