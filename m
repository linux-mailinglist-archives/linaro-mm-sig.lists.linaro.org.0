...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 97D34C0FA67
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 27 Oct 2025 18:31:56 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 0B3DE3F7C8
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 27 Oct 2025 17:31:27 +0000 (UTC)
Received: from SN4PR2101CU001.outbound.protection.outlook.com (mail-southcentralusazon11012012.outbound.protection.outlook.com [40.93.195.12])
	by lists.linaro.org (Postfix) with ESMTPS id 0C3B83F788
	for <linaro-mm-sig@lists.linaro.org>; Mon, 27 Oct 2025 17:31:13 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=GmXlYQy+;
	dmarc=pass (policy=reject) header.from=nvidia.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 40.93.195.12 as permitted sender) smtp.mailfrom=jgg@nvidia.com
...
X-Spamd-Result: default: False [-4.50 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	MISSING_XM_UA(0.00)[];
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.93.195.12:from];
	...
	DNSWL_BLOCKED(0.00)[40.93.195.12:from,2603:10b6:208:c1::17:received];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	DKIM_TRACE(0.00)[Nvidia.com:+]
X-Rspamd-Action: no action
Message-ID-Hash: C33OS3XRJAOLIANEG4DT2NPYVH423GCP
X-Message-ID-Hash: C33OS3XRJAOLIANEG4DT2NPYVH423GCP
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH 5/8] iommufd: Have pfn_reader process DMABUF iopt_pages
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/C33OS3XRJAOLIANEG4DT2NPYVH423GCP/>
