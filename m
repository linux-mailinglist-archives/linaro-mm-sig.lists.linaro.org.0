...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id D42828CF240
	for <lists+linaro-mm-sig@lfdr.de>; Sun, 26 May 2024 01:31:18 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id E47AE447C3
	for <lists+linaro-mm-sig@lfdr.de>; Sat, 25 May 2024 23:31:17 +0000 (UTC)
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
	by lists.linaro.org (Postfix) with ESMTPS id BF142447CD
	for <linaro-mm-sig@lists.linaro.org>; Sat, 25 May 2024 23:29:40 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=mediatek.com header.s=dk header.b="K/Rt7iQG";
...
Message-ID-Hash: HJM7XSSBRVTGZTFOESNCOSASNZ4LFZW4
X-Message-ID-Hash: HJM7XSSBRVTGZTFOESNCOSASNZ4LFZW4
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v6 3/7] drm/mediatek: Add secure buffer control flow to mtk_drm_gem
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/HJM7XSSBRVTGZTFOESNCOSASNZ4LFZW4/>
