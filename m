...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AD0FCA84D1
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 05 Dec 2025 17:02:57 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id DABA83F9A4
	for <lists+linaro-mm-sig@lfdr.de>; Fri,  5 Dec 2025 16:02:54 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.11])
	by lists.linaro.org (Postfix) with ESMTPS id E519F3F990
	for <linaro-mm-sig@lists.linaro.org>; Fri,  5 Dec 2025 16:01:54 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=IZAQbfYh;
	spf=pass (lists.linaro.org: domain of michael.j.ruhl@intel.com designates 192.198.163.11 as permitted sender) smtp.mailfrom=michael.j.ruhl@intel.com;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=IZAQbfYhNfvkZMtcZhNFbhdJn/jc8IlTlxM2bn//lX0DliDxhnICvuEM
   ...
   lzFRcEiSrvd/0RBSDx90yY2ADb8i4SwahCp9ZQiCRB3GpICcB6J7BDd6M
   w==;
X-CSE-ConnectionGUID: ywxUVwh3SjShStgzd41Y9A==
X-CSE-MsgGUID: J7hlvzCCTZiSdvS8UlYdFg==
X-IronPort-AV: E=McAfee;i="6800,10657,11633"; a="77604818"
X-IronPort-AV: E=Sophos;i="6.20,252,1758610800";
   d="scan'208";a="77604818"
...
X-Spamd-Result: default: False [-7.90 / 15.00];
	...
	MISSING_XM_UA(0.00)[];
	TO_DN_SOME(0.00)[];
	BLOCKLISTDE_FAIL(0.00)[192.198.163.11:server fail,2603:10b6:208:3aa::18:server fail];
	RSPAMD_EMAILBL_FAIL(0.00)[michael.j.ruhl@intel.com:query timed out];
	RCPT_COUNT_FIVE(0.00)[6];
	FROM_EQ_ENVFROM(0.00)[];
	FROM_HAS_DN(0.00)[];
	FREEMAIL_TO(0.00)[gmail.com,intel.com,vger.kernel.org,lists.freedesktop.org,lists.linaro.org,ffwll.ch];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	URIBL_BLOCKED(0.00)[ffwll.ch:email,intel.com:dkim,intel.com:from_smtp,intel.com:from_mime,intel.com:email];
	RCVD_TLS_LAST(0.00)[];
	NEURAL_HAM(-0.00)[-1.000];
	RCVD_COUNT_SEVEN(0.00)[7]
X-Rspamd-Server: lists.linaro.org
X-Rspamd-Queue-Id: E519F3F990
X-Spamd-Bar: -------
Message-ID-Hash: F7OTD3BB2GFVK2MIHV7COOGHGJQBFKT3
X-Message-ID-Hash: F7OTD3BB2GFVK2MIHV7COOGHGJQBFKT3
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/F7OTD3BB2GFVK2MIHV7COOGHGJQBFKT3/>
...
Cj4gCWlmIChkbWFfYnVmX3Bpbl9vbl9tYXAoYXR0YWNoKSkNCj4tLQ0KPjIuNDMuMA0KDQpfX19f
