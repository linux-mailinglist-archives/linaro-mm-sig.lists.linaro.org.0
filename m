...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id WJbDJUQGlWmmKAIAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 01:22:28 +0100
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id DC2D31523AC
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 01:22:27 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id E6CF240494
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 00:22:26 +0000 (UTC)
Received: from CH5PR02CU005.outbound.protection.outlook.com (mail-northcentralusazon11012033.outbound.protection.outlook.com [40.107.200.33])
	by lists.linaro.org (Postfix) with ESMTPS id 5C6F1401E1
	for <linaro-mm-sig@lists.linaro.org>; Wed, 18 Feb 2026 00:21:48 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=mkTp93mt;
...
X-Spamd-Bar: ---
Message-ID-Hash: INHMQLGKCSLL5HZJPF7G2VYYQ6SIJRJG
X-Message-ID-Hash: INHMQLGKCSLL5HZJPF7G2VYYQ6SIJRJG
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH RFC 13/26] dma-buf: Update dma_buf_phys_vec_to_sgt() to use the SGT mapping type
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/INHMQLGKCSLL5HZJPF7G2VYYQ6SIJRJG/>
