...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 60B506AC0C3
	for <lists+linaro-mm-sig@lfdr.de>; Mon,  6 Mar 2023 14:24:54 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 69C503F06E
	for <lists+linaro-mm-sig@lfdr.de>; Mon,  6 Mar 2023 13:24:53 +0000 (UTC)
Received: from gnuweeb.org (gnuweeb.org [51.81.211.47])
	by lists.linaro.org (Postfix) with ESMTPS id DA7E63EE32
	for <linaro-mm-sig@lists.linaro.org>; Thu,  2 Mar 2023 20:47:08 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=gnuweeb.org header.s=default header.b=SI3F76mC;
...
Message-ID-Hash: 6VDWX2ZNTBE35C3V5F5FR6MI44BTAOCK
X-Message-ID-Hash: 6VDWX2ZNTBE35C3V5F5FR6MI44BTAOCK
X-Mailman-Approved-At: Mon, 06 Mar 2023 13:24:33 +0000
CC: Jani Nikula <jani.nikula@linux.intel.com>, Joonas Lahtinen <joonas.lahtinen@linux.intel.com>, Rodrigo Vivi <rodrigo.vivi@intel.com>, Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>, =?UTF-8?B?VmlsbGUgU3lyasOkbMOk?= <ville.syrjala@linux.intel.com>, Stanislav Lisovskiy <stanislav.lisovskiy@intel.com>, Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>, Manasi Navare <manasi.d.navare@intel.com>, Daniel Vetter <daniel@ffwll.ch>, Sumit Semwal <sumit.semwal@linaro.org>, =?UTF-8?Q?Christian_K=c3=b6nig?= <christian.koenig@amd.com>, Thomas Zimmermann <tzimmermann@suse.de>, dri-devel@lists.freedesktop.org, linux-kernel@vger.kernel.org, linux-media@vger.kernel.org, linaro-mm-sig@lists.linaro.org
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Linux 6.2.1 hits a display driver bug (list_del corruption, ffff88811b4af298->next is NULL)
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/6VDWX2ZNTBE35C3V5F5FR6MI44BTAOCK/>
