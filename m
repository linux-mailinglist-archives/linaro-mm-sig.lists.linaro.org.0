...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id EB75764490F
	for <lists+linaro-mm-sig@lfdr.de>; Tue,  6 Dec 2022 17:20:19 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 9EB143F0C9
	for <lists+linaro-mm-sig@lfdr.de>; Tue,  6 Dec 2022 16:20:18 +0000 (UTC)
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
	by lists.linaro.org (Postfix) with ESMTPS id B6F163E894
	for <linaro-mm-sig@lists.linaro.org>; Tue,  6 Dec 2022 16:20:08 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=bEjPlGpL;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=bEjPlGpL9rLzo7ns0Ki4jRfZb8xFlHIIol9t++fdjtMDRxENL7kH8gQR
   ...
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10553"; a="300081381"
X-IronPort-AV: E=Sophos;i="5.96,222,1665471600";
   d="scan'208";a="300081381"
...
X-Spamd-Result: default: False [-9.90 / 15.00];
	...
	RCVD_IN_DNSWL_NONE(0.00)[104.47.73.168:received];
	TO_DN_SOME(0.00)[];
	NEURAL_HAM(-0.00)[-1.000];
	MIME_TRACE(0.00)[0:+];
	TAGGED_RCPT(0.00)[];
	URIBL_BLOCKED(0.00)[mga18.intel.com:rdns,mga18.intel.com:helo];
...
Message-ID-Hash: S3WMPOX4MVODHBFQW5CBTKDBDB2JUK3A
X-Message-ID-Hash: S3WMPOX4MVODHBFQW5CBTKDBDB2JUK3A
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/S3WMPOX4MVODHBFQW5CBTKDBDB2JUK3A/>
...
IAlyZXR1cm4gRVJSX1BUUihyZXQpOw0KPi0tDQo+Mi4zNC4xDQoNCl9fX19fX19fX19fX19fX19f
