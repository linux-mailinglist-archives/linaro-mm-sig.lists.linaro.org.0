...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id C6FEA593EA0
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 15 Aug 2022 23:14:58 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 08D6D3F5D3
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 15 Aug 2022 21:14:58 +0000 (UTC)
Received: from mail-pg1-f179.google.com (mail-pg1-f179.google.com [209.85.215.179])
	by lists.linaro.org (Postfix) with ESMTPS id B36703F5D4
	for <linaro-mm-sig@lists.linaro.org>; Mon, 15 Aug 2022 21:14:52 +0000 (UTC)
Received: by mail-pg1-f179.google.com with SMTP id q16so7532630pgq.6
        for <linaro-mm-sig@lists.linaro.org>; Mon, 15 Aug 2022 14:14:52 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=2kiyz2f68H5F0GVQfsRhPhFfzHVyxEWsBeZz0K3ifLI=;
        b=
X-Gm-Message-State: ACgBeo3Rvd6UYJLrKil7eT0Z1EfylA/YS++pcfpdKM6JsHmY4UcHJAKu
	EH6ck685JRDtSw6MvVXef2s=
...
MIME-Version: 1.0
Message-ID-Hash: IMBAY44U2LE3E2WQWWIQCJAUJ4NCPE5X
X-Message-ID-Hash: IMBAY44U2LE3E2WQWWIQCJAUJ4NCPE5X
X-MailFrom: robdclark@gmail.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
CC: freedreno@lists.freedesktop.org, Daniel Vetter <daniel@ffwll.ch>, =?UTF-8?q?Christian=20K=C3=B6nig?= <christian.koenig@amd.com>, Rob Clark <robdclark@chromium.org>, Sumit Semwal <sumit.semwal@linaro.org>, =?UTF-8?q?J=C3=A9r=C3=B4me=20Pouiller?= <jerome.pouiller@silabs.com>, "open list:DMA BUFFER SHARING FRAMEWORK" <linux-media@vger.kernel.org>, "moderated list:DMA BUFFER SHARING FRAMEWORK" <linaro-mm-sig@lists.linaro.org>, open list <linux-kernel@vger.kernel.org>
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v2 1/3] dma-buf: Add ioctl to query mmap coherency/cache info
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/IMBAY44U2LE3E2WQWWIQCJAUJ4NCPE5X/>
