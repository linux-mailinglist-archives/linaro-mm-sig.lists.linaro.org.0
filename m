...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 678ADA8A057
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 15 Apr 2025 15:57:44 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 79542459BF
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 15 Apr 2025 13:57:43 +0000 (UTC)
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (mail-mw2nam12on2075.outbound.protection.outlook.com [40.107.244.75])
	by lists.linaro.org (Postfix) with ESMTPS id ED32043B8C
	for <linaro-mm-sig@lists.linaro.org>; Tue, 15 Apr 2025 13:57:27 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=x4Ft8lDL;
...
X-Microsoft-Antispam: 
	BCL:0;ARA:13230040|376014|1800799024|7416014|366016|8096899003;
X-Microsoft-Antispam-Message-Info: 
	=?utf-8?B?T2VyWGxnamd1Q2VZNE01QUtGUXZjeWJlRzdjTElTSmYwUm8wdWd2dDVjcm9U?=
...
X-Forefront-Antispam-Report: 
	CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:PH7PR12MB5685.namprd12.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230040)(376014)(1800799024)(7416014)(366016)(8096899003);DIR:OUT;SFP:1101;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: 
	=?utf-8?B?bUFRc3FYNko0U0ZqTitrVHQ5bHoxVno4T0duK1VrZGExOHFzZ3BwM0MvVko0?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 15 Apr 2025 13:57:23.8392
 (UTC)
...
X-Rspamd-Queue-Id: ED32043B8C
X-Spamd-Bar: ---
X-Spamd-Result: default: False [-3.24 / 15.00];
	BAYES_HAM(-1.24)[89.58%];
	...
	TO_DN_SOME(0.00)[];
	RBL_SENDERSCORE_REPUT_8(0.00)[40.107.244.75:from];
	...
	FROM_HAS_DN(0.00)[];
	FREEMAIL_CC(0.00)[suse.de,ffwll.ch,gmail.com,redhat.com,163.com,kernel.org,linux.intel.com,lists.freedesktop.org,linaro.org,vger.kernel.org,lists.linaro.org];
	RCVD_IN_DNSWL_NONE(0.00)[40.107.244.75:from];
	RCVD_COUNT_TWO(0.00)[2];
	RCVD_TLS_LAST(0.00)[];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	URIBL_BLOCKED(0.00)[NAM12-MW2-obe.outbound.protection.outlook.com:helo];
	DKIM_TRACE(0.00)[amd.com:+]
X-Rspamd-Action: no action
X-Rspamd-Server: lists.linaro.org
Message-ID-Hash: 4JVVUDIG5EDQYEORJBBMMA6YLNN76AAC
X-Message-ID-Hash: 4JVVUDIG5EDQYEORJBBMMA6YLNN76AAC
X-MailFrom: Christian.Koenig@amd.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
CC: Thomas Zimmermann <tzimmermann@suse.de>, simona@ffwll.ch, asrivats@redhat.com, andyshrk@163.com, mripard@kernel.org, maarten.lankhorst@linux.intel.com, dri-devel@lists.freedesktop.org, Sumit Semwal <sumit.semwal@linaro.org>, linux-media@vger.kernel.org, linaro-mm-sig@lists.linaro.org
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH] drm/gem: Internally test import_attach for imported objects
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/4JVVUDIG5EDQYEORJBBMMA6YLNN76AAC/>
...
Content-Type: multipart/mixed; boundary="===============6812539879404232036=="
