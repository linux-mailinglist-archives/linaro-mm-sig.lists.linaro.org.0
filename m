...
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 64150D20B68
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 14 Jan 2026 19:01:56 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 6A69C402B6
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 14 Jan 2026 18:01:55 +0000 (UTC)
Received: from BL2PR02CU003.outbound.protection.outlook.com (mail-eastusazhn15011021.outbound.protection.outlook.com [52.102.137.21])
	by lists.linaro.org (Postfix) with ESMTPS id 744863F782
	for <linaro-mm-sig@lists.linaro.org>; Wed, 14 Jan 2026 18:01:49 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=ti.com header.s=selector1 header.b=waolrKMs;
	spf=pass (lists.linaro.org: domain of afd@ti.com designates 52.102.137.21 as permitted sender) smtp.mailfrom=afd@ti.com;
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	RWL_MAILSPIKE_POSSIBLE(0.00)[52.102.137.21:from];
	TO_DN_SOME(0.00)[];
	...
	RCVD_IN_DNSWL_NONE(0.00)[52.102.137.21:from];
	FROM_EQ_ENVFROM(0.00)[];
	FROM_HAS_DN(0.00)[];
	MID_RHS_MATCH_FROM(0.00)[];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	DNSWL_BLOCKED(0.00)[2603:10b6:a03:80:cafe::e4:received,2603:10b6:a03:80::28:received,157.170.170.90:received];
	DKIM_TRACE(0.00)[ti.com:+]
X-Rspamd-Action: no action
X-Rspamd-Server: lists.linaro.org
Message-ID-Hash: SIHV5JKS7Z56QXGZA2SJ4VEYTZSWYCF6
X-Message-ID-Hash: SIHV5JKS7Z56QXGZA2SJ4VEYTZSWYCF6
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/SIHV5JKS7Z56QXGZA2SJ4VEYTZSWYCF6/>
