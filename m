...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B7FF79A8BD
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 11 Sep 2023 16:41:51 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 19DE13F52A
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 11 Sep 2023 14:41:50 +0000 (UTC)
Received: from mail-yb1-f201.google.com (mail-yb1-f201.google.com [209.85.219.201])
	by lists.linaro.org (Postfix) with ESMTPS id 785D93EBCF
	for <linaro-mm-sig@lists.linaro.org>; Mon, 10 Jul 2023 22:33:49 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=google.com header.s=20221208 header.b=PmjrhD36;
	spf=pass (lists.linaro.org: domain of 3TYesZAsKDToWhiWonuiejWckkcha.YkihejWnk-ii-oecheopo.hejWnk.knc@flex--almasrymina.bounces.google.com designates 209.85.219.201 as permitted sender) smtp.mailfrom=3TYesZAsKDToWhiWonuiejWckkcha.YkihejWnk-ii-oecheopo.hejWnk.knc@flex--almasrymina.bounces.google.com;
	dmarc=pass (policy=reject) header.from=google.com
Received: by mail-yb1-f201.google.com with SMTP id 3f1490d57ef6-c83284edf0eso1866174276.3
        for <linaro-mm-sig@lists.linaro.org>; Mon, 10 Jul 2023 15:33:49 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=K10CMsALExOmOcR/YTwAYoH6sOUce0sACyLlyAd3oCA=;
        b=
X-Gm-Message-State: ABy/qLaLT4+6D3FFl+FH2Uc8pTafe5R3DFr/SwzNjBWT3L0j/24Cesaj
	Pro+Y/yOZRRti2Jek8ymRQJbrtRvk+2j3vWErg==
...
X-Spamd-Result: default: False [-0.70 / 15.00];
	...
	FORGED_SENDER(0.30)[almasrymina@google.com,3TYesZAsKDToWhiWonuiejWckkcha.YkihejWnk-ii-oecheopo.hejWnk.knc@flex--almasrymina.bounces.google.com];
	...
	FROM_HAS_DN(0.00)[];
	FROM_NEQ_ENVFROM(0.00)[almasrymina@google.com,3TYesZAsKDToWhiWonuiejWckkcha.YkihejWnk-ii-oecheopo.hejWnk.knc@flex--almasrymina.bounces.google.com];
...
X-Rspamd-Queue-Id: 785D93EBCF
X-Spamd-Bar: /
X-MailFrom: 3TYesZAsKDToWhiWonuiejWckkcha.YkihejWnk-ii-oecheopo.hejWnk.knc@flex--almasrymina.bounces.google.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
Message-ID-Hash: PH65L4V7HUTSK5I2FMEDCGQZ7H32ADRC
X-Message-ID-Hash: PH65L4V7HUTSK5I2FMEDCGQZ7H32ADRC
...
Precedence: list
Subject: [Linaro-mm-sig] [RFC PATCH 02/10] dma-buf: add support for NET_RX pages
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/PH65L4V7HUTSK5I2FMEDCGQZ7H32ADRC/>
