...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FA8F5F93D3
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 10 Oct 2022 01:50:21 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 5C3513F572
	for <lists+linaro-mm-sig@lfdr.de>; Sun,  9 Oct 2022 23:50:20 +0000 (UTC)
Received: from ams.source.kernel.org (ams.source.kernel.org [145.40.68.75])
	by lists.linaro.org (Postfix) with ESMTPS id 05F0F3F58B
	for <linaro-mm-sig@lists.linaro.org>; Sun,  9 Oct 2022 23:49:58 +0000 (UTC)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.source.kernel.org (Postfix) with ESMTPS id 0C238B80DE2;
...
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=kernel.org header.s=k20201202 header.b=tRBRL8N5;
...
Message-ID-Hash: 4NXSIOWAWBEKK4KG3NTVC2C7HYZWA4YW
X-Message-ID-Hash: 4NXSIOWAWBEKK4KG3NTVC2C7HYZWA4YW
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH AUTOSEL 6.0 09/44] udmabuf: Set ubuf->sg = NULL if the creation of sg table fails
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/4NXSIOWAWBEKK4KG3NTVC2C7HYZWA4YW/>
