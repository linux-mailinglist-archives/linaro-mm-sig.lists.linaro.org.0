...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id F11FAC5D2AB
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 14 Nov 2025 13:48:36 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 24C333F807
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 14 Nov 2025 12:48:05 +0000 (UTC)
Received: from CY3PR05CU001.outbound.protection.outlook.com (mail-westcentralusazon11013025.outbound.protection.outlook.com [40.93.201.25])
	by lists.linaro.org (Postfix) with ESMTPS id 0439F3F7F5
	for <linaro-mm-sig@lists.linaro.org>; Fri, 14 Nov 2025 12:47:52 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=DeNuNc8R;
	dmarc=pass (policy=quarantine) header.from=amd.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of Christian.Koenig@amd.com designates 40.93.201.25 as permitted sender) smtp.mailfrom=Christian.Koenig@amd.com
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.93.201.25:from];
...
Message-ID-Hash: EZWILQPKXIFWQRRLXN4GOMVMFLASETHY
X-Message-ID-Hash: EZWILQPKXIFWQRRLXN4GOMVMFLASETHY
X-MailFrom: Christian.Koenig@amd.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
CC: amd-gfx@lists.freedesktop.org, dri-devel@lists.freedesktop.org, linux-kernel@vger.kernel.org, "open list:DMA BUFFER SHARING FRAMEWORK:Keyword:bdma_(?:buf|fence|resv)b" <linux-media@vger.kernel.org>, linaro-mm-sig@lists.linaro.org
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH v2 02/20] drm/ttm: rework pipelined eviction fence handling
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/EZWILQPKXIFWQRRLXN4GOMVMFLASETHY/>
