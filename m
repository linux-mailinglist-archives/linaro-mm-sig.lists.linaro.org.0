...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 06054C40EDA
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 07 Nov 2025 17:50:12 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id D6D383F7E9
	for <lists+linaro-mm-sig@lfdr.de>; Fri,  7 Nov 2025 16:50:10 +0000 (UTC)
Received: from CH5PR02CU005.outbound.protection.outlook.com (mail-northcentralusazon11012033.outbound.protection.outlook.com [40.107.200.33])
	by lists.linaro.org (Postfix) with ESMTPS id 6814B3F7D4
	for <linaro-mm-sig@lists.linaro.org>; Fri,  7 Nov 2025 16:49:46 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=LWpbzNQA;
...
Message-ID-Hash: 3TVWS5HVSWSZK7UUFF4U5FL4LKW3N7XW
X-Message-ID-Hash: 3TVWS5HVSWSZK7UUFF4U5FL4LKW3N7XW
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH 1/9] vfio/pci: Add vfio_pci_dma_buf_iommufd_map()
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/3TVWS5HVSWSZK7UUFF4U5FL4LKW3N7XW/>
