...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 8ITbMZUGlWmmKAIAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 01:23:49 +0100
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A5681523EC
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 01:23:49 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 09F01404DF
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 00:16:15 +0000 (UTC)
Received: from BN1PR04CU002.outbound.protection.outlook.com (mail-eastus2azon11010006.outbound.protection.outlook.com [52.101.56.6])
	by lists.linaro.org (Postfix) with ESMTPS id A000B402CE
	for <linaro-mm-sig@lists.linaro.org>; Wed, 18 Feb 2026 00:12:10 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=ZSRQBCMc;
...
X-Spamd-Bar: ---
Message-ID-Hash: TH5TTQCFZ3SPQILZCGW5TF7VROOLNDNC
X-Message-ID-Hash: TH5TTQCFZ3SPQILZCGW5TF7VROOLNDNC
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH RFC 23/26] iommufd: Use the PAL mapping type instead of a vfio function
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/TH5TTQCFZ3SPQILZCGW5TF7VROOLNDNC/>
