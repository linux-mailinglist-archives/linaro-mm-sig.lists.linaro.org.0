...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 9844BC7A243
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 21 Nov 2025 15:27:38 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id A4DCD3F914
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 21 Nov 2025 14:27:37 +0000 (UTC)
Received: from BL2PR02CU003.outbound.protection.outlook.com (mail-eastusazon11011020.outbound.protection.outlook.com [52.101.52.20])
	by lists.linaro.org (Postfix) with ESMTPS id DFD7C3F853
	for <linaro-mm-sig@lists.linaro.org>; Fri, 21 Nov 2025 14:27:20 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=ZevgBPxL;
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 52.101.52.20 as permitted sender) smtp.mailfrom=jgg@nvidia.com;
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	RWL_MAILSPIKE_POSSIBLE(0.00)[52.101.52.20:from];
	...
	URIBL_BLOCKED(0.00)[Nvidia.com:dkim,nvidia.com:from_mime,nvidia.com:mid,nvidia.com:from_smtp,nvidia.com:email,BL2PR02CU003.outbound.protection.outlook.com:helo,mail-eastusazon11011020.outbound.protection.outlook.com:rdns];
	DKIM_TRACE(0.00)[Nvidia.com:+]
X-Rspamd-Server: lists.linaro.org
X-Rspamd-Queue-Id: DFD7C3F853
X-Spamd-Bar: ----
Message-ID-Hash: NKHNYLIMNPGYY3XF7DHEQZGOX7EY22BT
X-Message-ID-Hash: NKHNYLIMNPGYY3XF7DHEQZGOX7EY22BT
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/NKHNYLIMNPGYY3XF7DHEQZGOX7EY22BT/>
