...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 73AD96D4EBA
	for <lists+linaro-mm-sig@lfdr.de>; Mon,  3 Apr 2023 19:13:58 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 800523F5AD
	for <lists+linaro-mm-sig@lfdr.de>; Mon,  3 Apr 2023 17:13:57 +0000 (UTC)
Received: from loongson.cn (mail.loongson.cn [114.242.206.163])
	by lists.linaro.org (Postfix) with ESMTP id B78F03F5F0
	for <linaro-mm-sig@lists.linaro.org>; Mon,  3 Apr 2023 17:13:10 +0000 (UTC)
...
Received: from loongson.cn (unknown [10.20.42.133])
	by gateway (Coremail) with SMTP id _____8AxYeUlCStk4iUWAA--.34352S3;
...
X-Coremail-Antispam: 1Uk129KBjvtXoWDur4xXw1DXFWkKryUWFWDtwb_yoW8GF1fJw
	...
	JFyDG34vkryIyF1IgjkaLaAFLSUrUUUUnb8apTn2vfkv8UJUUUU8wcxFpf9Il3svdxBIda
...
X-Spamd-Result: default: False [-1.70 / 15.00];
	...
	ARC_NA(0.00)[]
Message-ID-Hash: GJR3TWCVRWGOHARM7VRX3VLKFYEKMH2V
X-Message-ID-Hash: GJR3TWCVRWGOHARM7VRX3VLKFYEKMH2V
X-MailFrom: suijingfeng@loongson.cn
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
CC: nathan@kernel.org, linux-kernel@vger.kernel.org, dri-devel@lists.freedesktop.org, linux-media@vger.kernel.org, linaro-mm-sig@lists.linaro.org, Li Yi <liyi@loongson.cn>
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v10 2/2] drm: add kms driver for loongson display controller
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/GJR3TWCVRWGOHARM7VRX3VLKFYEKMH2V/>
