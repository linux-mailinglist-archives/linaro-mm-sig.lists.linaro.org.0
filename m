...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 47B08C4CCFD
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 11 Nov 2025 10:58:31 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 6F0E73F77E
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 11 Nov 2025 09:58:30 +0000 (UTC)
Received: from tor.source.kernel.org (tor.source.kernel.org [172.105.4.254])
	by lists.linaro.org (Postfix) with ESMTPS id D37853F83A
	for <linaro-mm-sig@lists.linaro.org>; Tue, 11 Nov 2025 09:58:06 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=kernel.org header.s=k20201202 header.b=PpdOFyIy;
	dmarc=pass (policy=quarantine) header.from=kernel.org;
	spf=pass (lists.linaro.org: domain of leon@kernel.org designates 172.105.4.254 as permitted sender) smtp.mailfrom=leon@kernel.org
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by tor.source.kernel.org (Postfix) with ESMTP id 8E5ED61907;
...
X-Spamd-Result: default: False [-4.00 / 15.00];
	...
	URIBL_BLOCKED(0.00)[fb.com:email];
	RCVD_COUNT_TWO(0.00)[2];
	DKIM_TRACE(0.00)[kernel.org:+]
X-Rspamd-Action: no action
Message-ID-Hash: 4TUSPXJBWPE6RD7ZOPZUFK4I3U4IC6TH
X-Message-ID-Hash: 4TUSPXJBWPE6RD7ZOPZUFK4I3U4IC6TH
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v8 02/11] PCI/P2PDMA: Simplify bus address mapping API
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/4TUSPXJBWPE6RD7ZOPZUFK4I3U4IC6TH/>
