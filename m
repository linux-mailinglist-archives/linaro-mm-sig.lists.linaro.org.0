...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mMqMOMMf4Wl0pQAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 19:43:31 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 28F1B413203
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 19:43:31 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 2902B45CE8
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:43:30 +0000 (UTC)
Received: from outgoing.mit.edu (outgoing-auth-1.mit.edu [18.9.28.11])
	by lists.linaro.org (Postfix) with ESMTPS id 87C523F786
	for <linaro-mm-sig@lists.linaro.org>; Tue,  3 Mar 2026 15:19:09 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=mit.edu header.s=outgoing header.b="S/7CtiLz";
	dmarc=pass (policy=none) header.from=mit.edu;
	spf=pass (lists.linaro.org: domain of tytso@mit.edu designates 18.9.28.11 as permitted sender) smtp.mailfrom=tytso@mit.edu
...
Message-ID-Hash: NZZJWVEAMRERRZMBJO7BZRXKCWH4EMX4
X-Message-ID-Hash: NZZJWVEAMRERRZMBJO7BZRXKCWH4EMX4
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/NZZJWVEAMRERRZMBJO7BZRXKCWH4EMX4/>
...
X-Spamd-Result: default: False [3.09 / 15.00];
	...
	FROM_NEQ_ENVFROM(0.00)[tytso@mit.edu,linaro-mm-sig-bounces@lists.linaro.org];
 ...
 lists.linaro.org];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[lists.linaro.org:helo,lists.linaro.org:rdns,linaro.org:email,macsyma-wired.lan:mid]
X-Rspamd-Queue-Id: 28F1B413203
