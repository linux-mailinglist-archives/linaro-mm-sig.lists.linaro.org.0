...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 2NgEIjcGlWmmKAIAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 01:22:15 +0100
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 3D4031523A4
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 01:22:15 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 521A24044B
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 00:22:14 +0000 (UTC)
Received: from CH5PR02CU005.outbound.protection.outlook.com (mail-northcentralusazon11012033.outbound.protection.outlook.com [40.107.200.33])
	by lists.linaro.org (Postfix) with ESMTPS id DF5C7401D7
	for <linaro-mm-sig@lists.linaro.org>; Wed, 18 Feb 2026 00:21:47 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=NWi2Kvv6;
...
X-Spamd-Bar: ---
Message-ID-Hash: NZA5OLCJVZNFQJKDWNIGT2NRTU5AXUEZ
X-Message-ID-Hash: NZA5OLCJVZNFQJKDWNIGT2NRTU5AXUEZ
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH RFC 06/26] drm: Check the SGT ops for drm_gem_map_dma_buf()
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/NZA5OLCJVZNFQJKDWNIGT2NRTU5AXUEZ/>
