...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 081ABC40F30
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 07 Nov 2025 17:51:45 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 226203F7EE
	for <lists+linaro-mm-sig@lfdr.de>; Fri,  7 Nov 2025 16:51:44 +0000 (UTC)
Received: from CH5PR02CU005.outbound.protection.outlook.com (mail-northcentralusazon11012036.outbound.protection.outlook.com [40.107.200.36])
	by lists.linaro.org (Postfix) with ESMTPS id 1339E3F7FB
	for <linaro-mm-sig@lists.linaro.org>; Fri,  7 Nov 2025 16:49:51 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=RBmIzOPF;
...
Message-ID-Hash: NDMZA44HLVXDOBXH2BM3YKEIR4TIQD2R
X-Message-ID-Hash: NDMZA44HLVXDOBXH2BM3YKEIR4TIQD2R
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH 7/9] iommufd: Have iopt_map_file_pages convert the fd to a file
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/NDMZA44HLVXDOBXH2BM3YKEIR4TIQD2R/>
