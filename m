...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id C62AAC6F6C8
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 19 Nov 2025 15:50:31 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 85A8C3F832
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 19 Nov 2025 14:50:30 +0000 (UTC)
Received: from tor.source.kernel.org (tor.source.kernel.org [172.105.4.254])
	by lists.linaro.org (Postfix) with ESMTPS id C5B053F788
	for <linaro-mm-sig@lists.linaro.org>; Wed, 19 Nov 2025 14:50:14 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=kernel.org header.s=k20201202 header.b="LcrsNEP/";
	spf=pass (lists.linaro.org: domain of leon@kernel.org designates 172.105.4.254 as permitted sender) smtp.mailfrom=leon@kernel.org;
	dmarc=pass (policy=quarantine) header.from=kernel.org
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by tor.source.kernel.org (Postfix) with ESMTP id 62CD860172;
...
X-Rspamd-Queue-Id: C5B053F788
X-Spamd-Bar: ---
Message-ID-Hash: YJYHRTLZM6ZAGTD5GHEHZO7GM7EZSRTT
X-Message-ID-Hash: YJYHRTLZM6ZAGTD5GHEHZO7GM7EZSRTT
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/YJYHRTLZM6ZAGTD5GHEHZO7GM7EZSRTT/>
...
> >>>    This happens when the IOMMU is enabled and the ACS flags are forci=
ng
...
> >>> =20
> >>> +static struct scatterlist *fill_sg_entry(struct scatterlist *sgl, si=
ze_t length,
> >>> +					 dma_addr_t addr)
> >>> +{
...
> > This function performs DMA mapping, so what name do you suggest instead=
 of dma_buf_map()?
>=20
> Something like dma_buf_phys_vec_to_sg_table(). I'm not good at naming eit=
her.

Can I call it simply dma_buf_mapping() as I plan to put that function in dm=
a_buf_mapping.c
file per-your request.

Regarding SG, the long term plan is to remove SG table completely, so at
least external users of DMABUF shouldn't be exposed to internal implementat=
ion
details (SG table).
