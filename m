...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CLB/BGi0fGm7OQIAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 30 Jan 2026 14:38:48 +0100
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 8705DBB343
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 30 Jan 2026 14:38:47 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 9B17E3F820
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 30 Jan 2026 13:38:46 +0000 (UTC)
Received: from tor.source.kernel.org (tor.source.kernel.org [172.105.4.254])
	by lists.linaro.org (Postfix) with ESMTPS id E4401401E3
	for <linaro-mm-sig@lists.linaro.org>; Fri, 30 Jan 2026 13:37:49 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=kernel.org header.s=k20201202 header.b=lakFUAKF;
	spf=pass (lists.linaro.org: domain of leon@kernel.org designates 172.105.4.254 as permitted sender) smtp.mailfrom=leon@kernel.org;
	dmarc=pass (policy=quarantine) header.from=kernel.org
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by tor.source.kernel.org (Postfix) with ESMTP id A05006001A;
...
X-Spamd-Bar: ----
Message-ID-Hash: 4MDEBWNLCHYU2UUQWC5UCKQUUVXPMS2C
X-Message-ID-Hash: 4MDEBWNLCHYU2UUQWC5UCKQUUVXPMS2C
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v6 1/8] dma-buf: Rename .move_notify() callback to a clearer identifier
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/4MDEBWNLCHYU2UUQWC5UCKQUUVXPMS2C/>
