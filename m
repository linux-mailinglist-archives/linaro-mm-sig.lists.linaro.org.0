...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 00F18944AF0
	for <lists+linaro-mm-sig@lfdr.de>; Thu,  1 Aug 2024 14:07:34 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 14D9940F65
	for <lists+linaro-mm-sig@lfdr.de>; Thu,  1 Aug 2024 12:07:33 +0000 (UTC)
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
	by lists.linaro.org (Postfix) with ESMTPS id BFC1B44127
	for <linaro-mm-sig@lists.linaro.org>; Thu,  1 Aug 2024 12:05:55 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=kernel.org header.s=k20201202 header.b=mkFqLKbM;
...
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by dfw.source.kernel.org (Postfix) with ESMTP id 5BC3262767;
...
X-Spamd-Result: default: False [-2.50 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	TO_DN_SOME(0.00)[];
	URIBL_BLOCKED(0.00)[dfw.source.kernel.org:helo,dfw.source.kernel.org:rdns,nvidia.com:email];
	DKIM_TRACE(0.00)[kernel.org:+]
X-Rspamd-Action: no action
Message-ID-Hash: GRJLERK4IZ52OQHXAECKF7VST7DFQVXF
X-Message-ID-Hash: GRJLERK4IZ52OQHXAECKF7VST7DFQVXF
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH rdma-next 7/8] RDMA/mlx5: Add support for DMABUF MR registrations with Data-direct
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/GRJLERK4IZ52OQHXAECKF7VST7DFQVXF/>
