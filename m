...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F881A6863A
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 19 Mar 2025 08:55:41 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 1AD90444D1
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 19 Mar 2025 07:55:40 +0000 (UTC)
Received: from NAM12-BN8-obe.outbound.protection.outlook.com (mail-bn8nam12on2072.outbound.protection.outlook.com [40.107.237.72])
	by lists.linaro.org (Postfix) with ESMTPS id 94FFF3F67B
	for <linaro-mm-sig@lists.linaro.org>; Wed, 19 Mar 2025 07:55:21 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=KLb4BHv2;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of Christian.Koenig@amd.com designates 40.107.237.72 as permitted sender) smtp.mailfrom=Christian.Koenig@amd.com;
...
X-Spamd-Result: default: False [-3.50 / 15.00];
	...
	TAGGED_RCPT(0.00)[];
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.237.72:from];
	...
	RBL_SENDERSCORE_REPUT_BLOCKED(0.00)[40.107.237.72:from];
...
Message-ID-Hash: 3NUWXFQT26SZMITNIBBYMDMXLHAQYTB3
X-Message-ID-Hash: 3NUWXFQT26SZMITNIBBYMDMXLHAQYTB3
...
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH 2/7] drm/gem-shmem: Export VM ops functions
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/3NUWXFQT26SZMITNIBBYMDMXLHAQYTB3/>
