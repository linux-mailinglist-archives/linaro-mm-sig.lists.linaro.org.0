...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mHPTOSsf4WlbpQAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 19:40:59 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 692BF4130A4
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 19:40:59 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 7175645C9F
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:40:58 +0000 (UTC)
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.223.131])
	by lists.linaro.org (Postfix) with ESMTPS id 5D28D3F727
	for <linaro-mm-sig@lists.linaro.org>; Tue,  3 Mar 2026 11:36:31 +0000 (UTC)
...
Message-ID-Hash: 4L4H2GFHDG6BIEGJ5UVUA4YG2TZGNVU7
X-Message-ID-Hash: 4L4H2GFHDG6BIEGJ5UVUA4YG2TZGNVU7
X-Mailman-Approved-At: Thu, 16 Apr 2026 17:00:17 +0000
...
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH v2 098/110] udf: replace PRIino with %llu/%llx format strings
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/4L4H2GFHDG6BIEGJ5UVUA4YG2TZGNVU7/>
...
X-Spamd-Result: default: False [3.49 / 15.00];
 ...
 ,lists.linaro.org];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[lists.linaro.org:helo,lists.linaro.org:rdns,linaro.org:email,suse.com:email,suse.cz:email]
X-Rspamd-Queue-Id: 692BF4130A4
