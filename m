...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id EC50E82BCF5
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 12 Jan 2024 10:23:12 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 07A9C43F1E
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 12 Jan 2024 09:23:12 +0000 (UTC)
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
	by lists.linaro.org (Postfix) with ESMTPS id B497244034
	for <linaro-mm-sig@lists.linaro.org>; Fri, 12 Jan 2024 09:21:49 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=mediatek.com header.s=dk header.b=qLUDLykH;
...
X-Rspamd-Queue-Id: B497244034
X-Spamd-Bar: --
Message-ID-Hash: TRNJADY7R2P2QIWQZADVVI4ITZQQYDAR
X-Message-ID-Hash: TRNJADY7R2P2QIWQZADVVI4ITZQQYDAR
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v4 7/7] dma_buf: heaps: restricted_heap_mtk: Add a new CMA heap
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/TRNJADY7R2P2QIWQZADVVI4ITZQQYDAR/>
