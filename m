...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id aPQEKzb/4Gk7oQAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:24:38 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 3AD7D410A95
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:24:37 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 0585140A01
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 15:24:37 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.11])
	by lists.linaro.org (Postfix) with ESMTPS id 904003F90C
	for <linaro-mm-sig@lists.linaro.org>; Thu, 20 Nov 2025 16:18:07 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=aXVOdG3I;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  t=1763655488; x=1795191488;
  h=date:from:to:cc:subject:message-id:references:
   content-transfer-encoding:in-reply-to:mime-version;
  bh=TbM9efMM+/5wKvRriWbxpJfesIVvPcfBfgUwoAIeqW8=;
  b=aXVOdG3ICFt1MGq6sHCgjvlGHD6J77/RzTVnbT2AHa6+VDz1PUBi7/tc
   /VOu2ZvxQfYePpDtZiksEN6ARbD/OcVowjdvoCHLtGiu+pXy0dh2KmPm9
   kEW8KP1HHrJoZMx0RZgx7udULERgj7E+CiTRZcxRGO6PW3rpYnFC93lXW
   vCJAtx8rUc5jlsksCFks+Z0G/LeOsje0/LlSFjx/oVeuBeDmb669HTFUW
   fCxYogFH6ndy3fkf2JAyhCRe5k4DT9k0FBwiR29VYG5T4hKI4BBqojRvc
   BRUNXCCT/nUzEFlkvQ51tETN5evMibUPS8tDBafd5UkB0Y0w53zryl7FN
   w==;
X-CSE-ConnectionGUID: Qc8MWm51TISNjFJLEOT6RQ==
X-CSE-MsgGUID: fQoPVpWNRmSrb6iWl4UnlA==
X-IronPort-AV: E=McAfee;i="6800,10657,11619"; a="76343743"
X-IronPort-AV: E=Sophos;i="6.20,213,1758610800";
   d="scan'208";a="76343743"
...
Message-ID-Hash: N5YX25WZSUB7ZHRTPZYCICBD3CIQ6YE5
X-Message-ID-Hash: N5YX25WZSUB7ZHRTPZYCICBD3CIQ6YE5
X-Mailman-Approved-At: Thu, 16 Apr 2026 15:01:07 +0000
CC: intel-xe@lists.freedesktop.org, Stuart Summers <stuart.summers@intel.com>, Lucas De Marchi <lucas.demarchi@intel.com>, Thomas =?iso-8859-1?Q?Hellstr=F6m?= <thomas.hellstrom@linux.intel.com>, Rodrigo Vivi <rodrigo.vivi@intel.com>, Sumit Semwal <sumit.semwal@linaro.org>, Christian =?iso-8859-1?Q?K=F6nig?= <christian.koenig@amd.com>, linux-media@vger.kernel.org, dri-devel@lists.freedesktop.org, linaro-mm-sig@lists.linaro.org
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH] drm/xe: Fix memory leak when handling pagefault vma
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/N5YX25WZSUB7ZHRTPZYCICBD3CIQ6YE5/>
...
X-Spamd-Result: default: False [2.59 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[linaro.org:email,intel.com:email,amd.com:email,lists.freedesktop.org:email,lists.linaro.org:helo,lists.linaro.org:rdns];
...
> drm_exec_init() was added to the VMA path. This call is unnecessary becau=
se
> xe_validation_ctx_init() already performs a drm_exec_init(), resulting in=
 a
...
>=20
> diff --git a/drivers/gpu/drm/xe/xe_pagefault.c b/drivers/gpu/drm/xe/xe_pa=
gefault.c
> index fe3e40145012..afb06598b6e1 100644
> --- a/drivers/gpu/drm/xe/xe_pagefault.c
> +++ b/drivers/gpu/drm/xe/xe_pagefault.c
> @@ -102,7 +102,6 @@ static int xe_pagefault_handle_vma(struct xe_gt *gt, =
struct xe_vma *vma,
> =20
...
>  		err =3D xe_pagefault_begin(&exec, vma, tile->mem.vram,
>  					 needs_vram =3D=3D 1);
> --=20
> 2.43.0
>=20
