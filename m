...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 84C939449CE
	for <lists+linaro-mm-sig@lfdr.de>; Thu,  1 Aug 2024 12:55:57 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 960964473F
	for <lists+linaro-mm-sig@lfdr.de>; Thu,  1 Aug 2024 10:55:56 +0000 (UTC)
Received: from NAM02-BN1-obe.outbound.protection.outlook.com (mail-bn1nam02on2043.outbound.protection.outlook.com [40.107.212.43])
	by lists.linaro.org (Postfix) with ESMTPS id 4329340F65
	for <linaro-mm-sig@lists.linaro.org>; Thu,  1 Aug 2024 10:55:36 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=248Sduol;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of Christian.Koenig@amd.com designates 40.107.212.43 as permitted sender) smtp.mailfrom=Christian.Koenig@amd.com;
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.212.43:from];
	RCPT_COUNT_SEVEN(0.00)[8];
	ASN(0.00)[asn:8075, ipnet:40.104.0.0/14, country:US];
	MID_RHS_MATCH_FROM(0.00)[];
	NEURAL_HAM(-0.00)[-0.998];
	URIBL_BLOCKED(0.00)[amd.com:dkim,amd.com:mid,NAM02-BN1-obe.outbound.protection.outlook.com:helo,vivo.com:email,mail-bn1nam02on2043.outbound.protection.outlook.com:rdns];
...
Message-ID-Hash: ATV27QNWMQ4LCDUFKLGSZE7U7H4PTYQF
X-Message-ID-Hash: ATV27QNWMQ4LCDUFKLGSZE7U7H4PTYQF
X-MailFrom: Christian.Koenig@amd.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
CC: opensource.kernel@vivo.com
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH 3/5] udmabuf: fix vmap_udmabuf error page set
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/ATV27QNWMQ4LCDUFKLGSZE7U7H4PTYQF/>
