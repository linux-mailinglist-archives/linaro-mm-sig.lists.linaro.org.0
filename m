...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id B686D910405
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 20 Jun 2024 14:28:48 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id BEC5544C85
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 20 Jun 2024 12:28:47 +0000 (UTC)
Received: from aposti.net (aposti.net [89.234.176.197])
	by lists.linaro.org (Postfix) with ESMTPS id 1DA9343E4E
	for <linaro-mm-sig@lists.linaro.org>; Thu, 20 Jun 2024 12:28:03 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=crapouillou.net header.s=mail header.b=NrdX+KZu;
...
Message-ID-Hash: BZV4PE5HJTT7QW3QCRDK6R5MGDZ2MPSQ
X-Message-ID-Hash: BZV4PE5HJTT7QW3QCRDK6R5MGDZ2MPSQ
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v12 3/7] iio: core: Add new DMABUF interface infrastructure
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/BZV4PE5HJTT7QW3QCRDK6R5MGDZ2MPSQ/>
