...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 64D256D9511
	for <lists+linaro-mm-sig@lfdr.de>; Thu,  6 Apr 2023 13:27:15 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 725FA3EA49
	for <lists+linaro-mm-sig@lfdr.de>; Thu,  6 Apr 2023 11:27:14 +0000 (UTC)
Received: from mail-ed1-f52.google.com (mail-ed1-f52.google.com [209.85.208.52])
	by lists.linaro.org (Postfix) with ESMTPS id B20CB3EA49
	for <linaro-mm-sig@lists.linaro.org>; Thu,  6 Apr 2023 11:27:03 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=ffwll.ch header.s=google header.b=fHznqF7e;
	...
	dmarc=none
Received: by mail-ed1-f52.google.com with SMTP id 4fb4d7f45d1cf-502aa0f24daso126880a12.1
        for <linaro-mm-sig@lists.linaro.org>; Thu, 06 Apr 2023 04:27:03 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=kAw/L7Dpu+b4V/xTQbdmukEYxphyameFjwcA8l9wSDg=;
        b=
X-Gm-Message-State: AAQBX9cN2JbSwFl6WH+ETKPsfDoqPWHJmq/wRxidJQSRrDxAUkdEXIKi
	3q2T4xrL0Buf9+5r0XWiQcERfg==
...
X-Spamd-Result: default: False [-7.30 / 15.00];
	...
	RCVD_IN_DNSWL_HI(-0.50)[212.51.149.33:received];
	...
	FREEMAIL_CC(0.00)[ffwll.ch,linux.intel.com,kernel.org,suse.de,gmail.com,garyguo.net,protonmail.com,linaro.org,amd.com,rosenzweig.io,redhat.com,iglunix.org,collabora.com,mary.zone,vger.kernel.org,lists.freedesktop.org,lists.linaro.org,lists.linux.dev];
	...
	FROM_HAS_DN(0.00)[];
	ARC_NA(0.00)[];
	RCVD_IN_DNSWL_FAIL(0.00)[209.85.208.52:server fail];
...
Message-ID-Hash: HCNM3CWE2X53REQ2TAYX2J3O73JRNN5N
X-Message-ID-Hash: HCNM3CWE2X53REQ2TAYX2J3O73JRNN5N
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/HCNM3CWE2X53REQ2TAYX2J3O73JRNN5N/>
