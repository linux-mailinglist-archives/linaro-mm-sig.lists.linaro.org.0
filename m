...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 2525B644FEF
	for <lists+linaro-mm-sig@lfdr.de>; Wed,  7 Dec 2022 01:02:42 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 084C03F47D
	for <lists+linaro-mm-sig@lfdr.de>; Wed,  7 Dec 2022 00:02:41 +0000 (UTC)
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
	by lists.linaro.org (Postfix) with ESMTPS id A48623EC78
	for <linaro-mm-sig@lists.linaro.org>; Wed,  7 Dec 2022 00:02:30 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=A7thA3sl;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  t=1670371350; x=1701907350;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=7gFpP9zCF2JxzPrY/WMe4o1beyb6vNxP2/+6K9vmE1g=;
  b=A7thA3slL9uAYYrXHvqqeaN97q0Iefc18ir6ZKEe0AiHKJtZRt9NwwoP
   M4CYi2jssAu67qWxNKu1LQUW73MTUjpOXFd6pGGvhsn6tHtqO3jSOPB2J
   tmzkckbUxmk73ejbYMuEhaEO+UIVD4tn++EGLImHEpBPQrqGBn3zRlkVG
   wfhLX06t9GoWHkDsi6/2Xrgh3CUiPOPEqY6JYLeYJY6sYLnHwCzmMsqcl
   SkHChRP1uAye1d9ZUtfAUYTOzipTVcAwPXvHIpaJGrhE87nACT2N5RAx0
   uI+9OeaR2gbnuqK/xRgkcIbeCtOKeCa39yT8vwkfpNjeGEt05CVAarM3Y
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10553"; a="403036071"
X-IronPort-AV: E=Sophos;i="5.96,223,1665471600";
   d="scan'208";a="403036071"
...
X-Spamd-Result: default: False [-8.00 / 15.00];
	...
	FREEMAIL_TO(0.00)[gmail.com,quicinc.com,huawei.com,google.com,linaro.org];
	FROM_HAS_DN(0.00)[];
	MIME_TRACE(0.00)[0:+,1:+,2:+];
	RCVD_TLS_LAST(0.00)[];
	FROM_EQ_ENVFROM(0.00)[];
	ASN(0.00)[asn:4983, ipnet:192.55.52.0/24, country:US];
	DBL_BLOCKED_OPENRESOLVER(0.00)[intel.com:email,intel.com:dkim,git-scm.com:url,mga05.intel.com:rdns,mga05.intel.com:helo,01.org:url];
...
Message-ID-Hash: ZI3UX35YOA6KLDWPUWNPTXGBX7KC6X2O
X-Message-ID-Hash: ZI3UX35YOA6KLDWPUWNPTXGBX7KC6X2O
X-MailFrom: lkp@intel.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
CC: llvm@lists.linux.dev, oe-kbuild-all@lists.linux.dev, linaro-mm-sig@lists.linaro.org, dri-devel@lists.freedesktop.org, linux-media@vger.kernel.org
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH] dma-buf: fix dma_buf_export init order
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/ZI3UX35YOA6KLDWPUWNPTXGBX7KC6X2O/>
