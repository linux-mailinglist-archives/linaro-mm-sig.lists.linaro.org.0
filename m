...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id AA5BFBFBABD
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 22 Oct 2025 13:39:13 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id A6EF13F7B8
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 22 Oct 2025 11:39:12 +0000 (UTC)
Received: from PH0PR06CU001.outbound.protection.outlook.com (mail-westus3azon11011026.outbound.protection.outlook.com [40.107.208.26])
	by lists.linaro.org (Postfix) with ESMTPS id 81F123F78D
	for <linaro-mm-sig@lists.linaro.org>; Wed, 22 Oct 2025 11:39:04 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=OCWFBLFF;
	dmarc=pass (policy=reject) header.from=nvidia.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 40.107.208.26 as permitted sender) smtp.mailfrom=jgg@nvidia.com
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.208.26:from];
...
Message-ID-Hash: UWHZENITZPW5XBPDUNPFYIXSE5UQYE64
X-Message-ID-Hash: UWHZENITZPW5XBPDUNPFYIXSE5UQYE64
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/UWHZENITZPW5XBPDUNPFYIXSE5UQYE64/>
