...
Received: from lists.linaro.org (lists.linaro.org [107.22.173.205])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C702392BBB
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 27 May 2021 12:25:51 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 0BF2F60EC3
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 27 May 2021 10:25:48 +0000 (UTC)
Received: by lists.linaro.org (Postfix, from userid 109)
	id 6EF0460CFC; Thu, 27 May 2021 10:25:46 +0000 (UTC)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id DDA5D60A85;
	Thu, 27 May 2021 10:25:43 +0000 (UTC)
X-Original-To: linaro-mm-sig@lists.linaro.org
Delivered-To: linaro-mm-sig@lists.linaro.org
Received: from lists.linaro.org (localhost [127.0.0.1])
 by lists.linaro.org (Postfix) with ESMTP id C84B1608ED
 for <linaro-mm-sig@lists.linaro.org>; Thu, 27 May 2021 10:25:41 +0000 (UTC)
Received: by lists.linaro.org (Postfix, from userid 109)
 id C5C5060A85; Thu, 27 May 2021 10:25:41 +0000 (UTC)
Received: from mail-ed1-f47.google.com (mail-ed1-f47.google.com
 [209.85.208.47])
 by lists.linaro.org (Postfix) with ESMTPS id 9C584608ED
 for <linaro-mm-sig@lists.linaro.org>; Thu, 27 May 2021 10:25:39 +0000 (UTC)
Received: by mail-ed1-f47.google.com with SMTP id y7so264231eda.2
 for <linaro-mm-sig@lists.linaro.org>; Thu, 27 May 2021 03:25:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=date:from:to:cc:subject:message-id:mail-followup-to:references
 :mime-version:content-disposition:content-transfer-encoding
 :in-reply-to; bh=1/l80g/zEdujZkrTFKqo5BC5Hoqj8OHgMT6EdryZ3wE=;
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 b=
X-Gm-Message-State: AOAM531zP2FdDTmn6Jfnxj/mON44BZ2gw0AlreVMfkqdSid6Um7ZeQH2
 F44gPGAytKoYVAHJLhFJtmX2CA==
...
X-Received: by 2002:a05:6402:8c7:: with SMTP id
 d7mr3358143edz.298.1622111138311; 
...
> > > > information about DMA-BUF fds. However, the existing procfs interfa=
ces
...
> > > > The sysfs interface also exposes attachment statistics for each buf=
fer.
> > > >
...
%2F%2Flore.kernel.org%2Fpatchwork%2Fpatch%2F1088791%2F&amp;data=3D04%7C01%7=
Cchristian.koenig%40amd.com%7C72394dc653194a3fd3fd08d91fac2fb9%7C3dd8961fe4=
884e608e11a82d994e183d%7C0%7C0%7C637575646676575967%7CUnknown%7CTWFpbGZsb3d=
8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C1000&=
amp;sdata=3DEJ8KluQVn8FTOYRBAYpxAaG7rua46eQpmGwI%2FxIMthQ%3D&amp;reserved=
=3D0
> > > > [2]: https://nam11.safelinks.protection.outlook.com/?url=3Dhttps%3A=
%2F%2Fandroid-review.googlesource.com%2Fq%2Ftopic%3A%2522dmabuf-sysfs%2522&=
amp;data=3D04%7C01%7Cchristian.koenig%40amd.com%7C72394dc653194a3fd3fd08d91=
fac2fb9%7C3dd8961fe4884e608e11a82d994e183d%7C0%7C0%7C637575646676575967%7CU=
nknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLC=
JXVCI6Mn0%3D%7C1000&amp;sdata=3D4sAAqK%2F6mtSr5MWpcu2EbwOvL93UA6kMwQ2uk4fMP=
1g%3D&amp;reserved=3D0+(status:open%20OR%20status:merged)
> > > > [3]: https://nam11.safelinks.protection.outlook.com/?url=3Dhttps%3A=
%2F%2Fandroid-review.googlesource.com%2Fc%2Fplatform%2Fsystem%2Fmemory%2Fli=
bmeminfo%2F%2B%2F1549734&amp;data=3D04%7C01%7Cchristian.koenig%40amd.com%7C=
72394dc653194a3fd3fd08d91fac2fb9%7C3dd8961fe4884e608e11a82d994e183d%7C0%7C0=
%7C637575646676575967%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV=
2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C1000&amp;sdata=3Dhs40%2FMAnJaZQA4pk=
YucGqeCOGk2A9dUU%2Fj9ajqAoyFk%3D&amp;reserved=3D0
> > > >
...
> > > > Hi Daniel,
> > > >
> > > > I am sending the latest version of the DMA-BUF sysfs statistics pat=
ch to
> > > > the list again as per your suggestion to restart the discussion on =
it :)
> > > > Please do take a look and let me know your thoughts, thank you!
> > >
> > > Daniel and Sumit might correct me, but I think in the previous discus=
sion we
> > > came pretty much to the conclusion that this is not the right approac=
h.
> =
...
> > >
> > > DMA-buf is just the transport vehicle for driver allocations and as D=
aniel
> > > outlined it doesn't really make sense to account on a DMA-buf level e=
xcept
> > > for debugging.
> > >
> > > So while this patch is technically correct it will only add another h=
alve
> > > backed uAPI. So question is rather what the alternative should look l=
ike?
> >
> > So I chatted a bit with Android folks in a quick meeting, and the rough
> > conclusions we've had was
> >
> > - for per-process stats we'll look into cgroups for tracking this (beca=
use
> >   Android will add matching cgroup for each app the want to track)
> >
> > - same for the tracking for OOM killer
> >
> > - that does leave them with a gap for shared processes, for which I agr=
eed
> >   that just exposing the per dma-buf info is reasonable. It's not going=
 to
> >   be super useful on desktop linux because the dma-buf tends to not sti=
ck
...
> > commit message explains nicely what's being added (which really should =
be
...
> > abstract sense ie. high level semantics, not the specific implementatio=
n)
...
> >
> > Yeah I think since Android keeps the dma-buf fd around anyway (by desig=
n),
...
> > > >
> > > > Changes in v4:
> > > > -Suppress uevents from kset creation to avoid waking up uevent list=
eners on
...
> > > > +Description:       The /sys/kernel/dmabuf/buffers directory contai=
ns a
...
> > > > +KernelVersion:     v5.13
> > > > +Contact:   Hridya Valsaraju <hridya@google.com>
> > > > +Description:       This file is read-only and contains the name of=
 the exporter of
> > > > +           the DMA-BUF.
> > > > +
...
> > > > +KernelVersion:     v5.13
> > > > +Contact:   Hridya Valsaraju <hridya@google.com>
> > > > +Description:       This file is read-only and specifies the size o=
f the DMA-BUF in
> > > > +           bytes.
> > > > +
...
> > > > +KernelVersion:     v5.13
> > > > +Contact:   Hridya Valsaraju <hridya@google.com>
> > > > +Description:       This directory will contain subdirectories repr=
esenting every
...
> > > > +KernelVersion:     v5.13
> > > > +Contact:   Hridya Valsaraju <hridya@google.com>
> > > > +Description:       This directory will contain information on the =
attaching device
...
> > > > +KernelVersion:     v5.13
> > > > +Contact:   Hridya Valsaraju <hridya@google.com>
> > > > +Description:       This file is read-only and is a symlink to the =
attaching devices's
> > > > +           sysfs entry.
> > > > +
> > > > +What:              /sys/kernel/dmabuf/buffers/<inode_number>/attac=
...
> > > > +KernelVersion:     v5.13
> > > > +Contact:   Hridya Valsaraju <hridya@google.com>
> > > > +Description:       This file is read-only and contains a map_count=
er indicating the
...
> > > > +};
> > > > +#define to_dma_buf_stats_attr(x) container_of(x, struct dma_buf_st=
ats_attribute, attr)
> > > > +
...
> > > > +static struct dma_buf_stats_attribute size_attribute =3D __ATTR_RO=
(size);
> > > > +
...
> > > > +};
> > > > +
> > > > +#define to_dma_buf_attach_entry_from_kobj(x) container_of(x, struc=
t dma_buf_attach_sysfs_entry, kobj)
> > > > +
...
ar *buf);
> > > > +};
> > > > +#define to_dma_buf_attach_stats_attr(x) container_of(x, struct dma=
_buf_attach_stats_attribute, attr)
> > > > +
> > > > +static ssize_t dma_buf_attach_stats_attribute_show(struct kobject =
*kobj,
> > > > +                                              struct attribute *at=
tr,
> > > > +                                              char *buf)
...
> > > > +};
> > > > +
> > > > +static ssize_t map_counter_show(struct dma_buf_attach_sysfs_entry =
*sysfs_entry,
> > > > +                           struct dma_buf_attach_stats_attribute *=
attr,
> > > > +                           char *buf)
...
> > > > +};
> > > > +
> > > > +void dma_buf_attach_stats_teardown(struct dma_buf_attachment *atta=
ch)
> > > > +{
> > > > +   struct dma_buf_attach_sysfs_entry *sysfs_entry;
> > > > +
...
> > > > +   return ret;
> > > > +}
> > > > diff --git a/drivers/dma-buf/dma-buf-sysfs-stats.h b/drivers/dma-bu=
f/dma-buf-sysfs-stats.h
> > > > new file mode 100644
...
> > > > +int dma_buf_attach_stats_setup(struct dma_buf_attachment *attach,
> > > > +                          unsigned int uid);
> > > > +static inline void dma_buf_update_attachment_map_count(struct dma_=
...
> > > > +void dma_buf_attach_stats_teardown(struct dma_buf_attachment *atta=
ch);
> > > > +static inline unsigned int dma_buf_update_attach_uid(struct dma_bu=
f *dmabuf)
> > > > +{
...
> > > > +   return 0;
> > > > +}
> > > > +static inline int dma_buf_attach_stats_setup(struct dma_buf_attach=
ment *attach,
> > > > +                                        unsigned int uid)
> > > > +{
> > > > +   return 0;
...
{}
> > > > +static inline void dma_buf_attach_stats_teardown(struct dma_buf_at=
tachment *attach) {}
> > > > +static inline void dma_buf_update_attachment_map_count(struct dma_=
buf_attachment *attach,
> > > > +                                                  int delta) {}
...
> > > >     kfree(dmabuf->name);
> > > >     kfree(dmabuf);
> > > > @@ -580,6 +583,10 @@ struct dma_buf *dma_buf_export(const struct dm=
...
> > > > @@ -589,6 +596,14 @@ struct dma_buf *dma_buf_export(const struct dm=
a_buf_export_info *exp_info)
> > > >     return dmabuf;
> > > > +err_sysfs:
> > > > +   /*
...
> > > > @@ -748,8 +764,13 @@ dma_buf_dynamic_attach(struct dma_buf *dmabuf,=
 struct device *dev,
> > > >     }
...
> > > >     return ERR_PTR(ret);
> > > >   }
> > > > @@ -841,6 +864,7 @@ void dma_buf_detach(struct dma_buf *dmabuf, str=
uct dma_buf_attachment *attach)
...
> > > > @@ -854,6 +878,7 @@ void dma_buf_detach(struct dma_buf *dmabuf, str=
uct dma_buf_attachment *attach)
...
> > > > @@ -993,6 +1018,9 @@ struct sg_table *dma_buf_map_attachment(struct=
...
> > > > @@ -1030,6 +1058,8 @@ void dma_buf_unmap_attachment(struct dma_buf_=
attachment *attach,
> > > >     if (dma_buf_is_dynamic(attach->dmabuf) &&
...
> > > > @@ -1480,6 +1510,12 @@ static inline void dma_buf_uninit_debugfs(vo=
id)
...
> > > > + * @sysfs_entry: for exposing information about this buffer in sys=
fs.
> > > > + * The attachment_uid member of @sysfs_entry is protected by dma_r=
esv lock
> > > > + * and is incremented on each attach.
> > > >    *
> > > >    * This represents a shared buffer, created by calling dma_buf_ex=
port(). The
> > > >    * userspace representation is a normal file descriptor, which ca=
n be created by
...
> > > >    * @importer_ops: importer operations for this attachment, if pro=
vided
> > > >    * dma_buf_map/unmap_attachment() must be called with the dma_res=
v lock held.
> > > >    * @importer_priv: importer specific attachment data.
> > > > + * @sysfs_entry: For exposing information about this attachment in=
 sysfs.
> > > >    *
> > > >    * This structure holds the attachment information between the dm=
a_buf buffer
> > > >    * and its user device(s). The list contains one attachment struc=
t per device
