...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C7AC6B7006
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 13 Mar 2023 08:19:56 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 4D5973F4FB
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 13 Mar 2023 07:19:55 +0000 (UTC)
Received: from NAM12-DM6-obe.outbound.protection.outlook.com (mail-dm6nam12on2056.outbound.protection.outlook.com [40.107.243.56])
	by lists.linaro.org (Postfix) with ESMTPS id 3E2443E95E
	for <linaro-mm-sig@lists.linaro.org>; Mon, 13 Mar 2023 07:19:36 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=jl2pyBtG;
	spf=pass (lists.linaro.org: domain of Christian.Koenig@amd.com designates 40.107.243.56 as permitted sender) smtp.mailfrom=Christian.Koenig@amd.com;
...
X-MS-Exchange-AntiSpam-MessageData-0: 
	=?utf-8?B?WkdBTTVPV2pnenhVQmRoSHRVYk1LWXU5OXFlUjhJSW9TcHptNWFxa1d5Tmh1?=
...
X-Spamd-Result: default: False [-5.00 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	FREEMAIL_CC(0.00)[vger.kernel.org,lists.freedesktop.org,chromium.org,quicinc.com,linaro.org,poorly.run,gmail.com,ffwll.ch,lists.linaro.org];
	DBL_BLOCKED_OPENRESOLVER(0.00)[patchwork.freedesktop.org:url,mail-dm6nam12on2056.outbound.protection.outlook.com:rdns];
	RCPT_COUNT_TWELVE(0.00)[15];
	DKIM_TRACE(0.00)[amd.com:+];
	TO_DN_SOME(0.00)[];
	FROM_HAS_DN(0.00)[];
	MID_RHS_MATCH_FROM(0.00)[];
	URIBL_BLOCKED(0.00)[chromium.org:email,amd.com:dkim,NAM12-DM6-obe.outbound.protection.outlook.com:helo,mail-dm6nam12on2056.outbound.protection.outlook.com:rdns];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	RCVD_COUNT_THREE(0.00)[3];
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.243.56:from]
Message-ID-Hash: BKWQ6JG3N4URRKMYDWYL3IOJOQEQSWRE
X-Message-ID-Hash: BKWQ6JG3N4URRKMYDWYL3IOJOQEQSWRE
X-MailFrom: Christian.Koenig@amd.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
CC: linux-arm-msm@vger.kernel.org, freedreno@lists.freedesktop.org, Rob Clark <robdclark@chromium.org>, Abhinav Kumar <quic_abhinavk@quicinc.com>, Dmitry Baryshkov <dmitry.baryshkov@linaro.org>, Sean Paul <sean@poorly.run>, Daniel Vetter <daniel@ffwll.ch>, Sumit Semwal <sumit.semwal@linaro.org>, open list <linux-kernel@vger.kernel.org>, "open list:DMA BUFFER SHARING FRAMEWORK" <linux-media@vger.kernel.org>, "moderated list:DMA BUFFER SHARING FRAMEWORK" <linaro-mm-sig@lists.linaro.org>
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH 2/2] drm/msm: Embed the hw_fence in msm_gem_submit
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/BKWQ6JG3N4URRKMYDWYL3IOJOQEQSWRE/>
