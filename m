...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 8FnaIX+UfWnQSgIAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Sat, 31 Jan 2026 06:34:55 +0100
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 33A7BC0C9D
	for <lists+linaro-mm-sig@lfdr.de>; Sat, 31 Jan 2026 06:34:55 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 59207401CE
	for <lists+linaro-mm-sig@lfdr.de>; Sat, 31 Jan 2026 05:34:54 +0000 (UTC)
Received: from tor.source.kernel.org (tor.source.kernel.org [172.105.4.254])
	by lists.linaro.org (Postfix) with ESMTPS id A9C0B401D9
	for <linaro-mm-sig@lists.linaro.org>; Sat, 31 Jan 2026 05:34:36 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=kernel.org header.s=k20201202 header.b=iZK6B99q;
	spf=pass (lists.linaro.org: domain of leon@kernel.org designates 172.105.4.254 as permitted sender) smtp.mailfrom=leon@kernel.org;
	dmarc=pass (policy=quarantine) header.from=kernel.org
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by tor.source.kernel.org (Postfix) with ESMTP id 64E346001A;
...
X-Spamd-Bar: ----
Message-ID-Hash: XFILMVYLBUO36PRV7HOHNJVNRQKSMGMB
X-Message-ID-Hash: XFILMVYLBUO36PRV7HOHNJVNRQKSMGMB
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v7 1/8] dma-buf: Rename .move_notify() callback to a clearer identifier
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/XFILMVYLBUO36PRV7HOHNJVNRQKSMGMB/>
...
X-Spamd-Result: default: False [2.09 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[amd.com:email,nvidia.com:mid,nvidia.com:email,linaro.org:email]
X-Rspamd-Queue-Id: 33A7BC0C9D
