...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 02DE4625F11
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 11 Nov 2022 17:03:41 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 0D0563F603
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 11 Nov 2022 16:03:40 +0000 (UTC)
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
	by lists.linaro.org (Postfix) with ESMTPS id 5B1343F5D2
	for <linaro-mm-sig@lists.linaro.org>; Fri, 11 Nov 2022 16:03:17 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=XZnFkQIp;
	spf=pass (lists.linaro.org: domain of lkp@intel.com designates 192.55.52.115 as permitted sender) smtp.mailfrom=lkp@intel.com;
	dmarc=pass (policy=none) header.from=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1668182597; x=1699718597;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=ASueCoec7jKC+4qV8bdQQD8E3RuDzVCD0Iej+JHEZRw=;
  b=XZnFkQIpOVs1twtt6qdPRca9rWhGnl1RuV4vMi5EoZHSKvbwT4ZXNf28
   qVnV1y2T79j+HM4t0lJrTkkiyCEjoc4vchxj5f2/hAi6iil/HBYKgyBO8
   aTOPu9SnBwtTyPsUpfwpgRu12pBFQp/t56Kw3YoTdc+58dWBDWAWChbRh
   l73daWqviZPch7Vn4VFZRRgPZ6TQ4/Y/dtQG8L72nAKXs18JmwANAoPPz
   g1kYg8l3PG8OeehUzCHR0sh6Dc8hSiSf/P2w5F2T9yosVoGd4oyejR2OU
   qTc3jjewVCV/oYtyCiCqvxYtpvScmFqQd9ookzQJirB7IQ2cw4tiB3MT4
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10528"; a="311626430"
X-IronPort-AV: E=Sophos;i="5.96,156,1665471600";
   d="scan'208";a="311626430"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Nov 2022 08:03:15 -0800
X-ExtLoop1: 1
...
X-Spamd-Result: default: False [-6.00 / 15.00];
	...
	RCVD_IN_DNSWL_HI(-0.50)[192.55.52.115:from];
	R_DKIM_ALLOW(-0.20)[intel.com:s=Intel];
	R_SPF_ALLOW(-0.20)[+ip4:192.55.52.115/32];
	MIME_GOOD(-0.10)[multipart/mixed,text/plain];
	FROM_HAS_DN(0.00)[];
	NEURAL_HAM(-0.00)[-0.994];
	TAGGED_RCPT(0.00)[];
	FREEMAIL_CC(0.00)[lists.linux.dev,gmail.com,linaro.org,amd.com,lists.freedesktop.org,vger.kernel.org,lists.linaro.org];
	...
	TO_DN_SOME(0.00)[]
Message-ID-Hash: KTBSZHWHNFS3RTH6GXSA2N52ID6Q5H6F
X-Message-ID-Hash: KTBSZHWHNFS3RTH6GXSA2N52ID6Q5H6F
X-MailFrom: lkp@intel.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
CC: oe-kbuild-all@lists.linux.dev, Lukasz Wiecaszek <lukasz.wiecaszek@gmail.com>, Sumit Semwal <sumit.semwal@linaro.org>, Christian =?iso-8859-1?Q?K=F6nig?= <christian.koenig@amd.com>, dri-devel@lists.freedesktop.org, linux-media@vger.kernel.org, linaro-mm-sig@lists.linaro.org, linux-kernel@vger.kernel.org
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH] udmabuf: add vmap method to udmabuf_ops
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/KTBSZHWHNFS3RTH6GXSA2N52ID6Q5H6F/>
