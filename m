...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id WFhpE/b64GlloAAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:06:30 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 9EA93410312
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:06:29 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id ABA4E40515
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 15:06:28 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
	by lists.linaro.org (Postfix) with ESMTPS id 8BB943F833
	for <linaro-mm-sig@lists.linaro.org>; Tue, 11 Nov 2025 12:28:06 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=nBiPjkkX;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=nBiPjkkX6KgEUybLeuWyKA4tD8E4HH4bOL+S8h/NLW2kIAh2ke8zlYkQ
   ...
   g==;
X-CSE-ConnectionGUID: Vnm3XpcoRpe55FSNtct1WA==
X-CSE-MsgGUID: bcdIBzcVRj29ihZJLYQvpA==
X-IronPort-AV: E=McAfee;i="6800,10657,11609"; a="82553099"
X-IronPort-AV: E=Sophos;i="6.19,296,1754982000";
   d="scan'208";a="82553099"
...
Message-ID-Hash: HMYJ7ZALL2BY7BHOAFFC446GY2IRDMRC
X-Message-ID-Hash: HMYJ7ZALL2BY7BHOAFFC446GY2IRDMRC
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v2 10/21] igb: Switch to use %ptSp
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/HMYJ7ZALL2BY7BHOAFFC446GY2IRDMRC/>
...
X-Spamd-Result: default: False [4.09 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[ptp_overflow_work.work:url,linaro.org:email,lists.linaro.org:helo,lists.linaro.org:rdns,intel.com:email,linux.intel.com:mid]
X-Rspamd-Queue-Id: 9EA93410312
