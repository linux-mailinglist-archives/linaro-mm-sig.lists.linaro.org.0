...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 91EADC0FAD8
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 27 Oct 2025 18:33:46 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id A8AFF3F77E
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 27 Oct 2025 17:33:45 +0000 (UTC)
Received: from CY3PR05CU001.outbound.protection.outlook.com (mail-westcentralusazon11013029.outbound.protection.outlook.com [40.93.201.29])
	by lists.linaro.org (Postfix) with ESMTPS id 10FD23F77E
	for <linaro-mm-sig@lists.linaro.org>; Mon, 27 Oct 2025 17:33:33 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b="cQR2TLZ/";
	dmarc=pass (policy=reject) header.from=nvidia.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 40.93.201.29 as permitted sender) smtp.mailfrom=jgg@nvidia.com
...
X-Spamd-Result: default: False [-4.50 / 15.00];
	...
	MISSING_XM_UA(0.00)[];
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.93.201.29:from];
	...
	DNSWL_BLOCKED(0.00)[2603:10b6:208:c1::17:received,40.93.201.29:from];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	DKIM_TRACE(0.00)[Nvidia.com:+]
X-Rspamd-Action: no action
Message-ID-Hash: IS6QOSB56ZR7RJIBJ25ZQIWCTFBE67MR
X-Message-ID-Hash: IS6QOSB56ZR7RJIBJ25ZQIWCTFBE67MR
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH 6/8] iommufd: Have iopt_map_file_pages convert the fd to a file
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/IS6QOSB56ZR7RJIBJ25ZQIWCTFBE67MR/>
