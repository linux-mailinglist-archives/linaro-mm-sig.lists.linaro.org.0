...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id WMDHOJYGlWnHKAIAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 01:23:50 +0100
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id A99D915240B
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 01:23:50 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 26327404E0
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 00:13:54 +0000 (UTC)
Received: from MW6PR02CU001.outbound.protection.outlook.com (mail-westus2azon11012022.outbound.protection.outlook.com [52.101.48.22])
	by lists.linaro.org (Postfix) with ESMTPS id 70ECF401DA
	for <linaro-mm-sig@lists.linaro.org>; Wed, 18 Feb 2026 00:12:06 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=e2cNllIf;
...
X-Spamd-Bar: ---
Message-ID-Hash: NCMVSQOYAQFIZMJ426QXRTQ4QAQADOVQ
X-Message-ID-Hash: NCMVSQOYAQFIZMJ426QXRTQ4QAQADOVQ
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH RFC 19/26] treewide: Rename dma_buf_attach() to dma_buf_sgt_attach()
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/NCMVSQOYAQFIZMJ426QXRTQ4QAQADOVQ/>
