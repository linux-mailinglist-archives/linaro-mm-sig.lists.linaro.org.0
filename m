...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 0BD02533F12
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 25 May 2022 16:25:53 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 3B7FF3EE21
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 25 May 2022 14:25:52 +0000 (UTC)
Received: from mail-wm1-f51.google.com (mail-wm1-f51.google.com [209.85.128.51])
	by lists.linaro.org (Postfix) with ESMTPS id AC4033EBFA
	for <linaro-mm-sig@lists.linaro.org>; Wed, 25 May 2022 14:25:47 +0000 (UTC)
Received: by mail-wm1-f51.google.com with SMTP id p5-20020a1c2905000000b003970dd5404dso3474148wmp.0
        for <linaro-mm-sig@lists.linaro.org>; Wed, 25 May 2022 07:25:47 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:date:from:to:cc:subject:message-id:references
         ...
         :in-reply-to;
        bh=ITLg2C3yVq6vK1lTGkzxJdHftN9s6BMjvm6n2OeNpGs=;
        b=
X-Gm-Message-State: AOAM531Rm/j09uddaBF1CaIPGG6lAT8Uf1FuAgz8fUst1GIgs6H5tMk3
	MxjuNsCWdDTLkeFOqqv05dTl6Q==
...
Message-ID-Hash: NM2CITMSDPCE6BHRAIX45OR4IIPNGDMW
X-Message-ID-Hash: NM2CITMSDPCE6BHRAIX45OR4IIPNGDMW
X-MailFrom: daniel@ffwll.ch
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
CC: Daniel Stone <daniel@fooishbar.org>, Simon Ser <contact@emersion.fr>, Daniel Vetter <daniel@ffwll.ch>, tvrtko.ursulin@linux.intel.com, daniels@collabora.com, Michel =?iso-8859-1?Q?D=E4nzer?= <michel.daenzer@mailbox.org>, gustavo@padovan.org, Felix.Kuehling@amd.com, linux-media@vger.kernel.org, dri-devel@lists.freedesktop.org, linaro-mm-sig@lists.linaro.org, sergemetral@google.com, tzimmermann@suse.de, alexander.deucher@amd.com, skhawaja@google.com, sumit.semwal@linaro.org, jason@jlekstrand.net, maad.aldabagh@amd.com
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: Tackling the indefinite/user DMA fence problem
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/NM2CITMSDPCE6BHRAIX45OR4IIPNGDMW/>
...
On Wed, May 25, 2022 at 04:22:48PM +0200, Christian K=F6nig wrote:
> Am 25.05.22 um 16:15 schrieb Daniel Stone:
> > Hi,
> >=20
> > On Wed, 25 May 2022 at 15:07, Simon Ser <contact@emersion.fr> wrote:
> > > On Wednesday, May 25th, 2022 at 15:51, Daniel Vetter <daniel@ffwll.ch=
> wrote:
> > > > > You can add that to the list of reasons why compositors need to s=
top
> > > > > using buffers with unsignaled fences. There's plenty of other rea=
sons
> > > > > there already (the big one being that otherwise slow clients can =
slow
> > > > > down the compositor, even if the compositor uses a high priority =
context
> > > > > and the HW supports preemption).
> > > >=20
> > > > Yeah that's tbh another reason why I think we shouldn't do umf as a
> > > > transparent thing - compositors need to get better anyway, so we mi=
ght as
