...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F9246D4EAF
	for <lists+linaro-mm-sig@lfdr.de>; Mon,  3 Apr 2023 19:13:19 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 2D74C3F5F0
	for <lists+linaro-mm-sig@lfdr.de>; Mon,  3 Apr 2023 17:13:18 +0000 (UTC)
Received: from loongson.cn (mail.loongson.cn [114.242.206.163])
	by lists.linaro.org (Postfix) with ESMTP id 7FF363ED6B
...
Received: from loongson.cn (unknown [10.20.42.133])
	by gateway (Coremail) with SMTP id _____8AxUU8iCStk0iUWAA--.22626S3;
...
X-Coremail-Antispam: 1Uk129KBjvdXoW7GFyxCr4fXF17JF13JF48tFb_yoW3Zrc_Ca
	...
	tayrGr1SkFs3WjkaLaAFLSUrUUUUnb8apTn2vfkv8UJUUUU8wcxFpf9Il3svdxBIdaVrn0
	...
	daVFxhVjvjDU0xZFpf9x07jz5lbUUUUU=
X-Rspamd-Action: no action
X-Rspamd-Server: lists.linaro.org
X-Rspamd-Queue-Id: 7FF363ED6B
X-Spamd-Bar: -
X-Spamd-Result: default: False [-1.70 / 15.00];
	...
	ARC_NA(0.00)[]
Message-ID-Hash: JNYVG6W3IFOQGGWOOOUCX7DEQG3O6I63
X-Message-ID-Hash: JNYVG6W3IFOQGGWOOOUCX7DEQG3O6I63
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v10 1/2] MAINTAINERS: add maintainers for DRM LOONGSON driver
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/JNYVG6W3IFOQGGWOOOUCX7DEQG3O6I63/>
