...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id D8E948BD240
	for <lists+linaro-mm-sig@lfdr.de>; Mon,  6 May 2024 18:15:34 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id E9703411C5
	for <lists+linaro-mm-sig@lfdr.de>; Mon,  6 May 2024 16:15:33 +0000 (UTC)
Received: from NAM11-BN8-obe.outbound.protection.outlook.com (mail-bn8nam11on2042.outbound.protection.outlook.com [40.107.236.42])
	by lists.linaro.org (Postfix) with ESMTPS id DCB313F346
	for <linaro-mm-sig@lists.linaro.org>; Mon,  6 May 2024 16:15:18 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=fdHtJo46;
...
X-Spamd-Result: default: False [-7.49 / 15.00];
	...
	FREEMAIL_CC(0.00)[kernel.org,chromium.org,kernel.dk,lists.freedesktop.org,vger.kernel.org,suse.cz,labbott.name,lists.linaro.org,gmail.com,linaro.org,syzkaller.appspotmail.com,googlegroups.com];
	URIBL_BLOCKED(0.00)[NAM11-BN8-obe.outbound.protection.outlook.com:helo,amd.com:dkim,mail-bn8nam11on2042.outbound.protection.outlook.com:rdns,linux.org.uk:email];
	MIME_TRACE(0.00)[0:+];
	RCVD_TLS_LAST(0.00)[];
	FROM_HAS_DN(0.00)[];
	...
	DNSWL_BLOCKED(0.00)[40.107.236.42:from];
...
Message-ID-Hash: UQGXIL3SH2RQEAFKMHD2QFLN2K6DC3CC
X-Message-ID-Hash: UQGXIL3SH2RQEAFKMHD2QFLN2K6DC3CC
X-MailFrom: Christian.Koenig@amd.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
CC: Christian Brauner <brauner@kernel.org>, keescook@chromium.org, axboe@kernel.dk, dri-devel@lists.freedesktop.org, io-uring@vger.kernel.org, jack@suse.cz, laura@labbott.name, linaro-mm-sig@lists.linaro.org, linux-fsdevel@vger.kernel.org, linux-kernel@vger.kernel.org, linux-media@vger.kernel.org, minhquangbui99@gmail.com, sumit.semwal@linaro.org, syzbot+045b454ab35fd82a35fb@syzkaller.appspotmail.com, syzkaller-bugs@googlegroups.com
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH] epoll: try to be a _bit_ better about file lifetimes
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/UQGXIL3SH2RQEAFKMHD2QFLN2K6DC3CC/>
