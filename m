...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id BC94B63ABDC
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 28 Nov 2022 16:02:14 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id C704E3EE14
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 28 Nov 2022 15:02:13 +0000 (UTC)
Received: from wnew1-smtp.messagingengine.com (wnew1-smtp.messagingengine.com [64.147.123.26])
	by lists.linaro.org (Postfix) with ESMTPS id 892A93EF52
	for <linaro-mm-sig@lists.linaro.org>; Mon, 28 Nov 2022 14:58:09 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=cerno.tech header.s=fm2 header.b="O SGvH5k";
	dkim=pass header.d=messagingengine.com header.s=fm1 header.b="p bRdb7B";
...
X-Spamd-Result: default: False [-8.00 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[wnew1-smtp.messagingengine.com:rdns,wnew1-smtp.messagingengine.com:helo,messagingengine.com:dkim,cerno.tech:email,cerno.tech:dkim,encoder.base:url];
...
Message-ID-Hash: UT3YGSWE4KWY6TYEPNKGZ6FSWX4TWY2X
X-Message-ID-Hash: UT3YGSWE4KWY6TYEPNKGZ6FSWX4TWY2X
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v2 15/17] drm/vc4: tests: Introduce a mocking infrastructure
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/UT3YGSWE4KWY6TYEPNKGZ6FSWX4TWY2X/>
