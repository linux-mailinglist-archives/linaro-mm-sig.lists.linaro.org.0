...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id YDl+JDngcGnCaQAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 21 Jan 2026 15:18:33 +0100
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 18862584BD
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 21 Jan 2026 15:18:33 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 27FDF401B1
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 21 Jan 2026 14:18:32 +0000 (UTC)
Received: from DM5PR21CU001.outbound.protection.outlook.com (mail-centralusazon11011049.outbound.protection.outlook.com [52.101.62.49])
	by lists.linaro.org (Postfix) with ESMTPS id 1462B3F70E
	for <linaro-mm-sig@lists.linaro.org>; Wed, 21 Jan 2026 14:18:26 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=POdsB++1;
	spf=pass (lists.linaro.org: domain of Christian.Koenig@amd.com designates 52.101.62.49 as permitted sender) smtp.mailfrom=Christian.Koenig@amd.com;
...
X-Spamd-Result: default: False [2.99 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[lists.linaro.org:rdns,lists.linaro.org:helo,amd.com:mid,nvidia.com:email,linaro.org:email];
	RCPT_COUNT_TWELVE(0.00)[33];
	FREEMAIL_CC(0.00)[linaro.org,amd.com,ffwll.ch,redhat.com,collabora.com,chromium.org,gmail.com,linux.intel.com,kernel.org,suse.de,intel.com,8bytes.org,arm.com,shazbot.org,nvidia.com,vger.kernel.org,lists.freedesktop.org,lists.linaro.org,lists.fr,lists.linux.dev];
	TO_DN_SOME(0.00)[];
