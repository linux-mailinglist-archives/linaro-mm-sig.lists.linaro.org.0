...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B6C8C4CD15
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 11 Nov 2025 10:58:43 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 7A4003F7E4
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 11 Nov 2025 09:58:42 +0000 (UTC)
Received: from sea.source.kernel.org (sea.source.kernel.org [172.234.252.31])
	by lists.linaro.org (Postfix) with ESMTPS id 100923F785
	for <linaro-mm-sig@lists.linaro.org>; Tue, 11 Nov 2025 09:58:11 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=kernel.org header.s=k20201202 header.b=PmgEhAdi;
	dmarc=pass (policy=quarantine) header.from=kernel.org;
	spf=pass (lists.linaro.org: domain of leon@kernel.org designates 172.234.252.31 as permitted sender) smtp.mailfrom=leon@kernel.org
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by sea.source.kernel.org (Postfix) with ESMTP id 360984474D;
...
X-Spamd-Result: default: False [-4.00 / 15.00];
	...
	URIBL_BLOCKED(0.00)[nvidia.com:email,nvidia.com:mid,fb.com:email,p2pmem_group.name:url,sea.source.kernel.org:rdns,sea.source.kernel.org:helo];
	RCVD_COUNT_TWO(0.00)[2];
	DKIM_TRACE(0.00)[kernel.org:+]
X-Rspamd-Action: no action
Message-ID-Hash: SQ4TMUG6C2ODEEJSV5R5ODWQUOG5Q3YB
X-Message-ID-Hash: SQ4TMUG6C2ODEEJSV5R5ODWQUOG5Q3YB
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v8 01/11] PCI/P2PDMA: Separate the mmap() support from the core logic
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/SQ4TMUG6C2ODEEJSV5R5ODWQUOG5Q3YB/>
