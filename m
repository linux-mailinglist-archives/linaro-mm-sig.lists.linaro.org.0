...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CGEGCe794GnzoAAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:19:10 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id D9129410806
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:19:09 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id EC203409BD
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 15:19:08 +0000 (UTC)
Received: from SN4PR2101CU001.outbound.protection.outlook.com (mail-southcentralusazon11012040.outbound.protection.outlook.com [40.93.195.40])
	by lists.linaro.org (Postfix) with ESMTPS id B55183F812
	for <linaro-mm-sig@lists.linaro.org>; Tue, 18 Nov 2025 13:55:59 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=ti.com header.s=selector1 header.b=mjRiTdqP;
	spf=pass (lists.linaro.org: domain of m-malladi@ti.com designates 40.93.195.40 as permitted sender) smtp.mailfrom=m-malladi@ti.com;
...
Message-ID-Hash: AXMG244SWSRC4RNYKRF2C6XNZPRX2EJF
X-Message-ID-Hash: AXMG244SWSRC4RNYKRF2C6XNZPRX2EJF
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH net-next v6 0/6] Add AF_XDP zero copy support
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/AXMG244SWSRC4RNYKRF2C6XNZPRX2EJF/>
