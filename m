...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E66DC40F3D
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 07 Nov 2025 17:51:57 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 0A7113F7FB
	for <lists+linaro-mm-sig@lfdr.de>; Fri,  7 Nov 2025 16:51:56 +0000 (UTC)
Received: from CY7PR03CU001.outbound.protection.outlook.com (mail-westcentralusazon11010050.outbound.protection.outlook.com [40.93.198.50])
	by lists.linaro.org (Postfix) with ESMTPS id AFA153F80E
	for <linaro-mm-sig@lists.linaro.org>; Fri,  7 Nov 2025 16:49:50 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b="L/xuHZRi";
	dmarc=pass (policy=reject) header.from=nvidia.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 40.93.198.50 as permitted sender) smtp.mailfrom=jgg@nvidia.com
...
X-Spamd-Result: default: False [-3.50 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	MISSING_XM_UA(0.00)[];
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.93.198.50:from];
	RCPT_COUNT_TWELVE(0.00)[22];
	ASN(0.00)[asn:8075, ipnet:40.80.0.0/12, country:US];
	NEURAL_HAM(-0.00)[-1.000];
	RCVD_IN_DNSWL_NONE(0.00)[40.93.198.50:from];
	...
	URIBL_BLOCKED(0.00)[nvidia.com:mid,Nvidia.com:dkim,mail-westcentralusazon11010050.outbound.protection.outlook.com:rdns,CY7PR03CU001.outbound.protection.outlook.com:helo];
	DKIM_TRACE(0.00)[Nvidia.com:+]
X-Rspamd-Action: no action
Message-ID-Hash: 5YQMVDPYXD2RDELJUZIGRTXKCVTSEO2O
X-Message-ID-Hash: 5YQMVDPYXD2RDELJUZIGRTXKCVTSEO2O
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH 0/9] Initial DMABUF support for iommufd
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/5YQMVDPYXD2RDELJUZIGRTXKCVTSEO2O/>
