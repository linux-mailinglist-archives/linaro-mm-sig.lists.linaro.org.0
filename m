...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id CE62BC6B774
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 18 Nov 2025 20:38:39 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id D5C813F90A
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 18 Nov 2025 19:38:38 +0000 (UTC)
Received: from DM5PR21CU001.outbound.protection.outlook.com (mail-centralusazon11011020.outbound.protection.outlook.com [52.101.62.20])
	by lists.linaro.org (Postfix) with ESMTPS id 417873F90A
	for <linaro-mm-sig@lists.linaro.org>; Tue, 18 Nov 2025 19:38:22 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=BaOm1z6f;
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 52.101.62.20 as permitted sender) smtp.mailfrom=jgg@nvidia.com;
...
X-Spamd-Result: default: False [-4.96 / 15.00];
	...
	MISSING_XM_UA(0.00)[];
	MIME_TRACE(0.00)[0:+];
	RWL_MAILSPIKE_POSSIBLE(0.00)[52.101.62.20:from];
	ASN(0.00)[asn:8075, ipnet:52.96.0.0/12, country:US];
	RCPT_COUNT_TWELVE(0.00)[22];
	MID_RHS_MATCH_FROM(0.00)[];
	NEURAL_HAM(-0.00)[-1.000];
	URIBL_BLOCKED(0.00)[Nvidia.com:dkim,nvidia.com:from_smtp,nvidia.com:mid,nvidia.com:from_mime,mail-centralusazon11011020.outbound.protection.outlook.com:rdns,DM5PR21CU001.outbound.protection.outlook.com:helo];
	FROM_EQ_ENVFROM(0.00)[];
	FROM_HAS_DN(0.00)[];
	TO_DN_SOME(0.00)[];
	RCVD_COUNT_TWO(0.00)[2];
	DNSWL_BLOCKED(0.00)[52.101.62.20:from,2603:10b6:208:c1::17:received];
	TO_MATCH_ENVRCPT_SOME(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	DKIM_TRACE(0.00)[Nvidia.com:+]
X-Rspamd-Server: lists.linaro.org
X-Rspamd-Queue-Id: 417873F90A
X-Spamd-Bar: ----
Message-ID-Hash: VGCAULABKM3VQFUZU2JMUHB3V7BAPLJT
X-Message-ID-Hash: VGCAULABKM3VQFUZU2JMUHB3V7BAPLJT
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/VGCAULABKM3VQFUZU2JMUHB3V7BAPLJT/>
