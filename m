...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id BA2F46A8FDA
	for <lists+linaro-mm-sig@lfdr.de>; Fri,  3 Mar 2023 04:21:45 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 922E63F546
	for <lists+linaro-mm-sig@lfdr.de>; Fri,  3 Mar 2023 03:21:44 +0000 (UTC)
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
	by lists.linaro.org (Postfix) with ESMTPS id 992FB3E920
	for <linaro-mm-sig@lists.linaro.org>; Fri,  3 Mar 2023 03:21:24 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b="Wis/ZnOV";
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  t=1677813684; x=1709349684;
  h=date:from:to:cc:subject:message-id:references:
   in-reply-to:mime-version;
  bh=yGAVmQFLftsBVjoGRZ731DoB6VglmhE2iMIWUwlXq/c=;
  b=Wis/ZnOVhgPYVJly/TbRXfJwB9OYI80/jJ8x2ZQmtYKKVEwYopyt8LA0
   LDUlKTlhFQ+JfScLeU56XTUxw0M8Zx3DZ2WuySlR7RH7BnthZtW12M+tj
   yXuDuEkYI4wPmbMvp2C0TSlqiUQIGCrrHtmOr06CyInj+PS6tdQ+QWTQS
   bufxRlxXv3T+6IGUfom6e9NQNDR1jfXHYv3Iwy2W2jrxbz1NIR4KSTwnK
   8uD49UmXcXntftZV5LdWaznhVTrdHJSWjQfFbVn3iPlY1rmdWKnFspNYr
   H5AtuJde8p6jkX4wIZppVx7CfvY4JiI5pFPWYYtgQge7cN5Ao/MxwdeTY
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10637"; a="323236512"
X-IronPort-AV: E=Sophos;i="5.98,229,1673942400";
   d="scan'208";a="323236512"
...
Message-ID-Hash: TYIKAFNNUQWNUFS4P4E4VGQRZHESS7JF
X-Message-ID-Hash: TYIKAFNNUQWNUFS4P4E4VGQRZHESS7JF
X-MailFrom: rodrigo.vivi@intel.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
CC: dri-devel@lists.freedesktop.org, freedreno@lists.freedesktop.org, Daniel Vetter <daniel@ffwll.ch>, Michel =?iso-8859-1?Q?D=E4nzer?= <michel@daenzer.net>, Tvrtko Ursulin <tvrtko.ursulin@intel.com>, Alex Deucher <alexander.deucher@amd.com>, Pekka Paalanen <ppaalanen@gmail.com>, Simon Ser <contact@emersion.fr>, Luben Tuikov <luben.tuikov@amd.com>, Rob Clark <robdclark@chromium.org>, Jani Nikula <jani.nikula@linux.intel.com>, Joonas Lahtinen <joonas.lahtinen@linux.intel.com>, Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>, Sumit Semwal <sumit.semwal@linaro.org>, Christian =?iso-8859-1?Q?K=F6nig?= <christian.koenig@amd.com>, intel-gfx@lists.freedesktop.org, open list <linux-kernel@vger.kernel.org>, "open list:DMA BUFFER SHARING FRAMEWORK" <linux-media@vger.kernel.org>, "moderated list:DMA BUFFER SHARING FRAMEWORK" <linaro-mm-sig@lists.linaro.org>
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH v9 15/15] drm/i915: Add deadline based boost support
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/TYIKAFNNUQWNUFS4P4E4VGQRZHESS7JF/>
