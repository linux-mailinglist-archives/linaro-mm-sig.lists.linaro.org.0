...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D3A669CB1E
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 20 Feb 2023 13:36:44 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 3AAB73F2F5
	for <lists+linaro-mm-sig@lfdr.de>; Mon, 20 Feb 2023 12:36:43 +0000 (UTC)
Received: from mail-oa1-f52.google.com (mail-oa1-f52.google.com [209.85.160.52])
	by lists.linaro.org (Postfix) with ESMTPS id 0CAC93EC67
	for <linaro-mm-sig@lists.linaro.org>; Sat, 18 Feb 2023 06:44:13 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=gmail.com header.s=20210112 header.b=HpTbn7Qq;
	spf=pass (lists.linaro.org: domain of mail.dipanjan.das@gmail.com designates 209.85.160.52 as permitted sender) smtp.mailfrom=mail.dipanjan.das@gmail.com;
	dmarc=pass (policy=none) header.from=gmail.com
Received: by mail-oa1-f52.google.com with SMTP id 586e51a60fabf-17188373183so3670703fac.4
        for <linaro-mm-sig@lists.linaro.org>; Fri, 17 Feb 2023 22:44:13 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=NB3pQSuONgFS77gcKDututtFmRG8oCAgBcmXE6iuXOA=;
        b=
X-Gm-Message-State: AO0yUKUB29ZLknYTxBeo2LT+kTJm4NWW9ZJYPC2ARlixY6rqgI8iPsqe
	C4gmJAyb11xsD0Y/H39dyqXDymsRXPpX8UO7MWA=
...
X-Spamd-Result: default: False [0.10 / 15.00];
	...
	URIBL_BLOCKED(0.00)[mail-oa1-f52.google.com:rdns,mail-oa1-f52.google.com:helo];
	RCPT_COUNT_TWELVE(0.00)[13];
	TAGGED_FROM(0.00)[];
	FREEMAIL_CC(0.00)[googlegroups.com,googlemail.com,gmail.com];
	...
	TO_DN_SOME(0.00)[]
X-MailFrom: mail.dipanjan.das@gmail.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
Message-ID-Hash: USW6G4BVHVZM6MA5DD2P3AJKX63OC22I
X-Message-ID-Hash: USW6G4BVHVZM6MA5DD2P3AJKX63OC22I
X-Mailman-Approved-At: Mon, 20 Feb 2023 12:36:24 +0000
CC: syzkaller <syzkaller@googlegroups.com>, Marius Fleischer <fleischermarius@googlemail.com>, Priyanka Bose <its.priyanka.bose@gmail.com>
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [Linaro-mm-sig] KMSAN: uninit-value in __dma_map_sg_attrs
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/USW6G4BVHVZM6MA5DD2P3AJKX63OC22I/>
