...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id qFM8J8P94GnzoAAAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:18:27 +0200
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 37A2A4107C3
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 17:18:26 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id E76F0404F3
	for <lists+linaro-mm-sig@lfdr.de>; Thu, 16 Apr 2026 15:18:25 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
	by lists.linaro.org (Postfix) with ESMTPS id 8683C3F7EF
	for <linaro-mm-sig@lists.linaro.org>; Tue, 18 Nov 2025 07:11:09 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=byT2o3Ph;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=byT2o3PhD2lLax+uIQImtdj1OV2I9ghDIXL1jCWNAVwyXHUZ7qxoQCAx
   ...
   A==;
X-CSE-ConnectionGUID: uCxXb9r0QJ6DLeXDnndGqg==
X-CSE-MsgGUID: 59yRaYOpTLuF6PEVvsZ/+Q==
X-IronPort-AV: E=McAfee;i="6800,10657,11616"; a="88113977"
X-IronPort-AV: E=Sophos;i="6.19,314,1754982000";
   d="scan'208";a="88113977"
...
Message-ID-Hash: HH4EO7QIZ5U4RYQ27OT4L22TOYER5SLD
X-Message-ID-Hash: HH4EO7QIZ5U4RYQ27OT4L22TOYER5SLD
...
Precedence: list
Subject: [Linaro-mm-sig] Re: [PATCH v8 07/11] vfio: Export vfio device get and put registration helpers
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/HH4EO7QIZ5U4RYQ27OT4L22TOYER5SLD/>
...
X-Spamd-Result: default: False [2.59 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[intel.com:email,nvidia.com:email,lists.linaro.org:helo,lists.linaro.org:rdns,linaro.org:email,BN9PR11MB5276.namprd11.prod.outlook.com:mid,fb.com:email];
