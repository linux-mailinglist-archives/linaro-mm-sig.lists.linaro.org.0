...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D7796D9D4C
	for <lists+linaro-mm-sig@lfdr.de>; Thu,  6 Apr 2023 18:13:17 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 7189C40430
	for <lists+linaro-mm-sig@lfdr.de>; Thu,  6 Apr 2023 16:13:16 +0000 (UTC)
Received: from mail-ej1-f51.google.com (mail-ej1-f51.google.com [209.85.218.51])
	by lists.linaro.org (Postfix) with ESMTPS id 3AFC03F045
	for <linaro-mm-sig@lists.linaro.org>; Thu,  6 Apr 2023 16:13:05 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=ffwll.ch header.s=google header.b=FGVsLGnG;
	...
	dmarc=none
Received: by mail-ej1-f51.google.com with SMTP id a640c23a62f3a-93abb185e13so18420566b.0
        for <linaro-mm-sig@lists.linaro.org>; Thu, 06 Apr 2023 09:13:05 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Vfjx4v5k+l/m+k+I01SkgtQu9JSM6Qas7cJAMSy1WKg=;
        b=
X-Gm-Message-State: AAQBX9eNYvJtQKEqBLJpQu0iwrT6DZTxCuMvmTWGeNA83fhzJkmQ3hn2
	kC6R93RUW1z5plCvoNiEBTXZNg==
...
X-Spamd-Result: default: False [-5.90 / 15.00];
	...
	RCVD_IN_DNSWL_FAIL(0.00)[209.85.218.51:server fail];
	ARC_NA(0.00)[];
...
Message-ID-Hash: BFC5KDZDFPZFZYL4P3STAC2JCUYX3GCQ
X-Message-ID-Hash: BFC5KDZDFPZFZYL4P3STAC2JCUYX3GCQ
...
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/BFC5KDZDFPZFZYL4P3STAC2JCUYX3GCQ/>
