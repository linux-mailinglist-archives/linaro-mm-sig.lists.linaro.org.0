...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 89725C40F0A
	for <lists+linaro-mm-sig@lfdr.de>; Fri, 07 Nov 2025 17:50:52 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 7480F3F7D4
	for <lists+linaro-mm-sig@lfdr.de>; Fri,  7 Nov 2025 16:50:51 +0000 (UTC)
Received: from CH5PR02CU005.outbound.protection.outlook.com (mail-northcentralusazon11012020.outbound.protection.outlook.com [40.107.200.20])
	by lists.linaro.org (Postfix) with ESMTPS id DE8473F7EC
	for <linaro-mm-sig@lists.linaro.org>; Fri,  7 Nov 2025 16:49:47 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=ebQxq928;
	dmarc=pass (policy=reject) header.from=nvidia.com;
	arc=pass ("microsoft.com:s=arcselector10001:i=1");
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 40.107.200.20 as permitted sender) smtp.mailfrom=jgg@nvidia.com
...
X-Spamd-Result: default: False [-3.50 / 15.00];
	...
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.200.20:from];
	FROM_EQ_ENVFROM(0.00)[];
	DWL_DNSWL_BLOCKED(0.00)[Nvidia.com:dkim];
	RCVD_TLS_LAST(0.00)[];
	DNSWL_BLOCKED(0.00)[2603:10b6:208:c1::17:received,40.107.200.20:from];
	RCVD_COUNT_TWO(0.00)[2];
	URIBL_BLOCKED(0.00)[Nvidia.com:dkim,nvidia.com:email,nvidia.com:mid,mail-northcentralusazon11012020.outbound.protection.outlook.com:rdns];
	NEURAL_HAM(-0.00)[-1.000];
	TO_DN_SOME(0.00)[];
	DKIM_TRACE(0.00)[Nvidia.com:+]
X-Rspamd-Action: no action
Message-ID-Hash: KSRA6PMPFAON3LLSJ3764DGIWYJWJZGE
X-Message-ID-Hash: KSRA6PMPFAON3LLSJ3764DGIWYJWJZGE
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH 6/9] iommufd: Have pfn_reader process DMABUF iopt_pages
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/KSRA6PMPFAON3LLSJ3764DGIWYJWJZGE/>
