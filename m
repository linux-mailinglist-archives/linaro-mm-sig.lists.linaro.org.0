...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id wIuLLZUGlWmmKAIAu9opvQ
	(envelope-from <linaro-mm-sig-bounces+lists+linaro-mm-sig=lfdr.de@lists.linaro.org>)
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 01:23:49 +0100
X-Original-To: lists+linaro-mm-sig@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id 52C501523E9
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 01:23:49 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 0DCAC409B7
	for <lists+linaro-mm-sig@lfdr.de>; Wed, 18 Feb 2026 00:14:37 +0000 (UTC)
Received: from BN1PR04CU002.outbound.protection.outlook.com (mail-eastus2azon11010067.outbound.protection.outlook.com [52.101.56.67])
	by lists.linaro.org (Postfix) with ESMTPS id BEDD2401EA
	for <linaro-mm-sig@lists.linaro.org>; Wed, 18 Feb 2026 00:12:07 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=rF70vhjd;
	spf=pass (lists.linaro.org: domain of jgg@nvidia.com designates 52.101.56.67 as permitted sender) smtp.mailfrom=jgg@nvidia.com;
...
X-Spamd-Bar: ---
Message-ID-Hash: 5GXBX3RCF7MAGUICOQXSK7HFABYKQPZL
X-Message-ID-Hash: 5GXBX3RCF7MAGUICOQXSK7HFABYKQPZL
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH RFC 12/26] vfio/pci: Change the DMA-buf exporter to use mapping_type
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/5GXBX3RCF7MAGUICOQXSK7HFABYKQPZL/>
