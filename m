...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 899624B6F97
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 15 Feb 2022 16:16:31 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id C0FE63EEC6
	for <lists+linaro-mm-sig@lfdr.de>; Tue, 15 Feb 2022 15:16:30 +0000 (UTC)
Received: from aposti.net (aposti.net [89.234.176.197])
	by lists.linaro.org (Postfix) with ESMTPS id C540F3EE63
	for <linaro-mm-sig@lists.linaro.org>; Mon,  7 Feb 2022 13:00:12 +0000 (UTC)
...
Message-ID-Hash: QJYVUZTAX7NPN7JQFH5ZT5UXIYOOYAC7
X-Message-ID-Hash: QJYVUZTAX7NPN7JQFH5ZT5UXIYOOYAC7
X-Mailman-Approved-At: Tue, 15 Feb 2022 15:15:50 +0000
...
Precedence: list
Subject: [Linaro-mm-sig] [PATCH v2 05/12] iio: core: Add new DMABUF interface infrastructure
List-Id: "Unified memory management interest group." <linaro-mm-sig.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/linaro-mm-sig@lists.linaro.org/message/QJYVUZTAX7NPN7JQFH5ZT5UXIYOOYAC7/>
